...
function findWasmBinary() {
  return locateFile('raylib_firefighting_command_2026.wasm');
}
...
var ASM_CONSTS = {
  97536: () => { if (document.fullscreenElement) return 1; },  
 97582: () => { return document.getElementById('canvas').width; },  
 97634: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97702: () => { document.exitFullscreen(); },  
 97729: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97802: () => { if (document.fullscreenElement) return 1; },  
 97848: () => { return document.getElementById('canvas').width; },  
 97900: () => { return screen.width; },  
 97925: () => { document.exitFullscreen(); },  
 97952: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98085: () => { return window.innerWidth; },  
 98111: () => { return window.innerHeight; },  
 98138: () => { if (document.fullscreenElement) return 1; },  
 98184: () => { return document.getElementById('canvas').width; },  
 98236: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98304: () => { if (document.fullscreenElement) return 1; },  
 98350: () => { return document.getElementById('canvas').width; },  
 98402: () => { return screen.width; },  
 98427: () => { return window.innerWidth; },  
 98453: () => { return window.innerHeight; },  
 98480: () => { if (document.fullscreenElement) return 1; },  
 98526: () => { return document.getElementById('canvas').width; },  
 98578: () => { return screen.width; },  
 98603: () => { document.exitFullscreen(); },  
 98630: () => { if (document.fullscreenElement) return 1; },  
 98676: () => { return document.getElementById('canvas').width; },  
 98728: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98796: () => { document.exitFullscreen(); },  
 98823: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98881: () => { return screen.width; },  
 98906: () => { return screen.height; },  
 98932: () => { return window.screenX; },  
 98959: () => { return window.screenY; },  
 98986: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99039: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99110: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99167: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99423: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99494: () => { if (document.fullscreenElement) return 1; },  
 99540: () => { return window.innerWidth; },  
 99566: () => { return window.innerHeight; },  
 99593: () => { if (document.pointerLockElement) return 1; }
};
