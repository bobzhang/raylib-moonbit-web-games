...
function findWasmBinary() {
  return locateFile('raylib_metal_slug_1996_lite.wasm');
}
...
var ASM_CONSTS = {
  146272: () => { if (document.fullscreenElement) return 1; },  
 146318: () => { return document.getElementById('canvas').width; },  
 146370: () => { return parseInt(document.getElementById('canvas').style.width); },  
 146438: () => { document.exitFullscreen(); },  
 146465: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 146538: () => { if (document.fullscreenElement) return 1; },  
 146584: () => { return document.getElementById('canvas').width; },  
 146636: () => { return screen.width; },  
 146661: () => { document.exitFullscreen(); },  
 146688: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 146821: () => { return window.innerWidth; },  
 146847: () => { return window.innerHeight; },  
 146874: () => { if (document.fullscreenElement) return 1; },  
 146920: () => { return document.getElementById('canvas').width; },  
 146972: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 147163: () => { return window.innerWidth; },  
 147189: () => { return window.innerHeight; },  
 147216: () => { if (document.fullscreenElement) return 1; },  
 147262: () => { return document.getElementById('canvas').width; },  
 147314: () => { return screen.width; },  
 147339: () => { document.exitFullscreen(); },  
 147366: () => { if (document.fullscreenElement) return 1; },  
 147412: () => { return document.getElementById('canvas').width; },  
 147464: () => { return parseInt(document.getElementById('canvas').style.width); },  
 147532: () => { document.exitFullscreen(); },  
 147559: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 147617: () => { return screen.width; },  
 147642: () => { return screen.height; },  
 147668: () => { return window.screenX; },  
 147695: () => { return window.screenY; },  
 147722: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 147775: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 147846: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 147903: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 148159: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 148230: () => { if (document.fullscreenElement) return 1; },  
 148276: () => { return window.innerWidth; },  
 148302: () => { return window.innerHeight; },  
 148329: () => { if (document.pointerLockElement) return 1; }
};
