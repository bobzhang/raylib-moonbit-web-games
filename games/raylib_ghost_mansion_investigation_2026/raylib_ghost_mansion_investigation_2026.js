...
function findWasmBinary() {
  return locateFile('raylib_ghost_mansion_investigation_2026.wasm');
}
...
var ASM_CONSTS = {
  97760: () => { if (document.fullscreenElement) return 1; },  
 97806: () => { return document.getElementById('canvas').width; },  
 97858: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97926: () => { document.exitFullscreen(); },  
 97953: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98026: () => { if (document.fullscreenElement) return 1; },  
 98072: () => { return document.getElementById('canvas').width; },  
 98124: () => { return screen.width; },  
 98149: () => { document.exitFullscreen(); },  
 98176: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98309: () => { return window.innerWidth; },  
 98335: () => { return window.innerHeight; },  
 98362: () => { if (document.fullscreenElement) return 1; },  
 98408: () => { return document.getElementById('canvas').width; },  
 98460: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98528: () => { if (document.fullscreenElement) return 1; },  
 98574: () => { return document.getElementById('canvas').width; },  
 98626: () => { return screen.width; },  
 98651: () => { return window.innerWidth; },  
 98677: () => { return window.innerHeight; },  
 98704: () => { if (document.fullscreenElement) return 1; },  
 98750: () => { return document.getElementById('canvas').width; },  
 98802: () => { return screen.width; },  
 98827: () => { document.exitFullscreen(); },  
 98854: () => { if (document.fullscreenElement) return 1; },  
 98900: () => { return document.getElementById('canvas').width; },  
 98952: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99020: () => { document.exitFullscreen(); },  
 99047: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99105: () => { return screen.width; },  
 99130: () => { return screen.height; },  
 99156: () => { return window.screenX; },  
 99183: () => { return window.screenY; },  
 99210: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99263: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99334: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99391: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99647: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99718: () => { if (document.fullscreenElement) return 1; },  
 99764: () => { return window.innerWidth; },  
 99790: () => { return window.innerHeight; },  
 99817: () => { if (document.pointerLockElement) return 1; }
};
