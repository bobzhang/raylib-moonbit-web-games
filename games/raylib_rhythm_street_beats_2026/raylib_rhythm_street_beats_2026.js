...
var ASM_CONSTS = {
  97856: () => { if (document.fullscreenElement) return 1; },  
 97902: () => { return document.getElementById('canvas').width; },  
 97954: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98022: () => { document.exitFullscreen(); },  
 98049: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98122: () => { if (document.fullscreenElement) return 1; },  
 98168: () => { return document.getElementById('canvas').width; },  
 98220: () => { return screen.width; },  
 98245: () => { document.exitFullscreen(); },  
 98272: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98405: () => { return window.innerWidth; },  
 98431: () => { return window.innerHeight; },  
 98458: () => { if (document.fullscreenElement) return 1; },  
 98504: () => { return document.getElementById('canvas').width; },  
 98556: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98624: () => { if (document.fullscreenElement) return 1; },  
 98670: () => { return document.getElementById('canvas').width; },  
 98722: () => { return screen.width; },  
 98747: () => { return window.innerWidth; },  
 98773: () => { return window.innerHeight; },  
 98800: () => { if (document.fullscreenElement) return 1; },  
 98846: () => { return document.getElementById('canvas').width; },  
 98898: () => { return screen.width; },  
 98923: () => { document.exitFullscreen(); },  
 98950: () => { if (document.fullscreenElement) return 1; },  
 98996: () => { return document.getElementById('canvas').width; },  
 99048: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99116: () => { document.exitFullscreen(); },  
 99143: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99201: () => { return screen.width; },  
 99226: () => { return screen.height; },  
 99252: () => { return window.screenX; },  
 99279: () => { return window.screenY; },  
 99306: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99359: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99430: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99487: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99743: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99814: () => { if (document.fullscreenElement) return 1; },  
 99860: () => { return window.innerWidth; },  
 99886: () => { return window.innerHeight; },  
 99913: () => { if (document.pointerLockElement) return 1; }
};
