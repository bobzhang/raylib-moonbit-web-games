...
var ASM_CONSTS = {
  107240: () => { if (document.fullscreenElement) return 1; },  
 107286: () => { return document.getElementById('canvas').width; },  
 107338: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107406: () => { document.exitFullscreen(); },  
 107433: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107506: () => { if (document.fullscreenElement) return 1; },  
 107552: () => { return document.getElementById('canvas').width; },  
 107604: () => { return screen.width; },  
 107629: () => { document.exitFullscreen(); },  
 107656: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107789: () => { return window.innerWidth; },  
 107815: () => { return window.innerHeight; },  
 107842: () => { if (document.fullscreenElement) return 1; },  
 107888: () => { return document.getElementById('canvas').width; },  
 107940: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108008: () => { if (document.fullscreenElement) return 1; },  
 108054: () => { return document.getElementById('canvas').width; },  
 108106: () => { return screen.width; },  
 108131: () => { return window.innerWidth; },  
 108157: () => { return window.innerHeight; },  
