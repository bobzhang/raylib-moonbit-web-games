...
function findWasmBinary() {
  return locateFile('raylib_neon_heist_extraction_2026.wasm');
}
...
var ASM_CONSTS = {
  98928: () => { if (document.fullscreenElement) return 1; },  
 98974: () => { return document.getElementById('canvas').width; },  
 99026: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99094: () => { document.exitFullscreen(); },  
 99121: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99194: () => { if (document.fullscreenElement) return 1; },  
 99240: () => { return document.getElementById('canvas').width; },  
 99292: () => { return screen.width; },  
 99317: () => { document.exitFullscreen(); },  
 99344: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99477: () => { return window.innerWidth; },  
 99503: () => { return window.innerHeight; },  
 99530: () => { if (document.fullscreenElement) return 1; },  
 99576: () => { return document.getElementById('canvas').width; },  
 99628: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99696: () => { if (document.fullscreenElement) return 1; },  
 99742: () => { return document.getElementById('canvas').width; },  
 99794: () => { return screen.width; },  
 99819: () => { return window.innerWidth; },  
 99845: () => { return window.innerHeight; },  
 99872: () => { if (document.fullscreenElement) return 1; },  
 99918: () => { return document.getElementById('canvas').width; },  
 99970: () => { return screen.width; },  
 99995: () => { document.exitFullscreen(); },  
 100022: () => { if (document.fullscreenElement) return 1; },  
 100068: () => { return document.getElementById('canvas').width; },  
 100120: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100188: () => { document.exitFullscreen(); },  
 100215: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100273: () => { return screen.width; },  
 100298: () => { return screen.height; },  
 100324: () => { return window.screenX; },  
 100351: () => { return window.screenY; },  
 100378: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100431: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100502: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100559: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100815: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100886: () => { if (document.fullscreenElement) return 1; },  
 100932: () => { return window.innerWidth; },  
 100958: () => { return window.innerHeight; },  
 100985: () => { if (document.pointerLockElement) return 1; }
};
