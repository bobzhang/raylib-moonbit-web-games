...
var ASM_CONSTS = {
  97568: () => { if (document.fullscreenElement) return 1; },  
 97614: () => { return document.getElementById('canvas').width; },  
 97666: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97734: () => { document.exitFullscreen(); },  
 97761: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97834: () => { if (document.fullscreenElement) return 1; },  
 97880: () => { return document.getElementById('canvas').width; },  
 97932: () => { return screen.width; },  
 97957: () => { document.exitFullscreen(); },  
 97984: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98117: () => { return window.innerWidth; },  
 98143: () => { return window.innerHeight; },  
 98170: () => { if (document.fullscreenElement) return 1; },  
 98216: () => { return document.getElementById('canvas').width; },  
 98268: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98336: () => { if (document.fullscreenElement) return 1; },  
 98382: () => { return document.getElementById('canvas').width; },  
 98434: () => { return screen.width; },  
 98459: () => { return window.innerWidth; },  
 98485: () => { return window.innerHeight; },  
 98512: () => { if (document.fullscreenElement) return 1; },  
 98558: () => { return document.getElementById('canvas').width; },  
 98610: () => { return screen.width; },  
 98635: () => { document.exitFullscreen(); },  
 98662: () => { if (document.fullscreenElement) return 1; },  
 98708: () => { return document.getElementById('canvas').width; },  
 98760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98828: () => { document.exitFullscreen(); },  
 98855: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98913: () => { return screen.width; },  
 98938: () => { return screen.height; },  
 98964: () => { return window.screenX; },  
 98991: () => { return window.screenY; },  
 99018: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99071: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99142: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99199: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99455: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99526: () => { if (document.fullscreenElement) return 1; },  
 99572: () => { return window.innerWidth; },  
 99598: () => { return window.innerHeight; },  
 99625: () => { if (document.pointerLockElement) return 1; }
};
