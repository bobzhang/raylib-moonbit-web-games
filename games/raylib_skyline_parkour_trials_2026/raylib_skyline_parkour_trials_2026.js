...
var ASM_CONSTS = {
  98400: () => { if (document.fullscreenElement) return 1; },  
 98446: () => { return document.getElementById('canvas').width; },  
 98498: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98566: () => { document.exitFullscreen(); },  
 98593: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98666: () => { if (document.fullscreenElement) return 1; },  
 98712: () => { return document.getElementById('canvas').width; },  
 98764: () => { return screen.width; },  
 98789: () => { document.exitFullscreen(); },  
 98816: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98949: () => { return window.innerWidth; },  
 98975: () => { return window.innerHeight; },  
 99002: () => { if (document.fullscreenElement) return 1; },  
 99048: () => { return document.getElementById('canvas').width; },  
 99100: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99168: () => { if (document.fullscreenElement) return 1; },  
 99214: () => { return document.getElementById('canvas').width; },  
 99266: () => { return screen.width; },  
 99291: () => { return window.innerWidth; },  
 99317: () => { return window.innerHeight; },  
 99344: () => { if (document.fullscreenElement) return 1; },  
 99390: () => { return document.getElementById('canvas').width; },  
 99442: () => { return screen.width; },  
 99467: () => { document.exitFullscreen(); },  
 99494: () => { if (document.fullscreenElement) return 1; },  
 99540: () => { return document.getElementById('canvas').width; },  
 99592: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99660: () => { document.exitFullscreen(); },  
 99687: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99745: () => { return screen.width; },  
 99770: () => { return screen.height; },  
 99796: () => { return window.screenX; },  
 99823: () => { return window.screenY; },  
 99850: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99903: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99974: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100031: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100287: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100358: () => { if (document.fullscreenElement) return 1; },  
 100404: () => { return window.innerWidth; },  
 100430: () => { return window.innerHeight; },  
 100457: () => { if (document.pointerLockElement) return 1; }
};
