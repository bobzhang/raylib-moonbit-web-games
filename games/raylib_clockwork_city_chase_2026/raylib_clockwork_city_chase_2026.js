...
var ASM_CONSTS = {
  106840: () => { if (document.fullscreenElement) return 1; },  
 106886: () => { return document.getElementById('canvas').width; },  
 106938: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107006: () => { document.exitFullscreen(); },  
 107033: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107106: () => { if (document.fullscreenElement) return 1; },  
 107152: () => { return document.getElementById('canvas').width; },  
 107204: () => { return screen.width; },  
 107229: () => { document.exitFullscreen(); },  
 107256: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107389: () => { return window.innerWidth; },  
 107415: () => { return window.innerHeight; },  
 107442: () => { if (document.fullscreenElement) return 1; },  
 107488: () => { return document.getElementById('canvas').width; },  
 107540: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107608: () => { if (document.fullscreenElement) return 1; },  
 107654: () => { return document.getElementById('canvas').width; },  
 107706: () => { return screen.width; },  
 107731: () => { return window.innerWidth; },  
 107757: () => { return window.innerHeight; },  
