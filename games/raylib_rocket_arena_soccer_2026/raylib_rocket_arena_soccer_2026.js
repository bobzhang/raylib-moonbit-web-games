...
var ASM_CONSTS = {
  98032: () => { if (document.fullscreenElement) return 1; },  
 98078: () => { return document.getElementById('canvas').width; },  
 98130: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98198: () => { document.exitFullscreen(); },  
 98225: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98298: () => { if (document.fullscreenElement) return 1; },  
 98344: () => { return document.getElementById('canvas').width; },  
 98396: () => { return screen.width; },  
 98421: () => { document.exitFullscreen(); },  
 98448: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98581: () => { return window.innerWidth; },  
 98607: () => { return window.innerHeight; },  
 98634: () => { if (document.fullscreenElement) return 1; },  
 98680: () => { return document.getElementById('canvas').width; },  
 98732: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98800: () => { if (document.fullscreenElement) return 1; },  
 98846: () => { return document.getElementById('canvas').width; },  
 98898: () => { return screen.width; },  
 98923: () => { return window.innerWidth; },  
 98949: () => { return window.innerHeight; },  
 98976: () => { if (document.fullscreenElement) return 1; },  
 99022: () => { return document.getElementById('canvas').width; },  
 99074: () => { return screen.width; },  
 99099: () => { document.exitFullscreen(); },  
 99126: () => { if (document.fullscreenElement) return 1; },  
 99172: () => { return document.getElementById('canvas').width; },  
 99224: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99292: () => { document.exitFullscreen(); },  
 99319: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99377: () => { return screen.width; },  
 99402: () => { return screen.height; },  
 99428: () => { return window.screenX; },  
 99455: () => { return window.screenY; },  
 99482: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99535: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99606: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99663: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99919: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99990: () => { if (document.fullscreenElement) return 1; },  
 100036: () => { return window.innerWidth; },  
 100062: () => { return window.innerHeight; },  
 100089: () => { if (document.pointerLockElement) return 1; }
};
