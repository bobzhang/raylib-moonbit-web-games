...
function findWasmBinary() {
  return locateFile('raylib_rocket_arena_soccer_2026.wasm');
}
...
var ASM_CONSTS = {
 ...
 98306: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98374: () => { document.exitFullscreen(); },  
 98401: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98474: () => { if (document.fullscreenElement) return 1; },  
 98520: () => { return document.getElementById('canvas').width; },  
 98572: () => { return screen.width; },  
 98597: () => { document.exitFullscreen(); },  
 98624: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98757: () => { return window.innerWidth; },  
 98783: () => { return window.innerHeight; },  
 98810: () => { if (document.fullscreenElement) return 1; },  
 98856: () => { return document.getElementById('canvas').width; },  
 98908: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98976: () => { if (document.fullscreenElement) return 1; },  
 99022: () => { return document.getElementById('canvas').width; },  
 99074: () => { return screen.width; },  
 99099: () => { return window.innerWidth; },  
 99125: () => { return window.innerHeight; },  
 99152: () => { if (document.fullscreenElement) return 1; },  
 99198: () => { return document.getElementById('canvas').width; },  
 99250: () => { return screen.width; },  
 99275: () => { document.exitFullscreen(); },  
 99302: () => { if (document.fullscreenElement) return 1; },  
 99348: () => { return document.getElementById('canvas').width; },  
 99400: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99468: () => { document.exitFullscreen(); },  
 99495: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99553: () => { return screen.width; },  
 99578: () => { return screen.height; },  
 99604: () => { return window.screenX; },  
 99631: () => { return window.screenY; },  
 99658: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99711: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99782: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99839: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100095: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100166: () => { if (document.fullscreenElement) return 1; },  
 100212: () => { return window.innerWidth; },  
 100238: () => { return window.innerHeight; },  
 100265: () => { if (document.pointerLockElement) return 1; }
};
