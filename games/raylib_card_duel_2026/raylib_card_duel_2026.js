...
var ASM_CONSTS = {
 ...
 98322: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98390: () => { document.exitFullscreen(); },  
 98417: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98490: () => { if (document.fullscreenElement) return 1; },  
 98536: () => { return document.getElementById('canvas').width; },  
 98588: () => { return screen.width; },  
 98613: () => { document.exitFullscreen(); },  
 98640: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98773: () => { return window.innerWidth; },  
 98799: () => { return window.innerHeight; },  
 98826: () => { if (document.fullscreenElement) return 1; },  
 98872: () => { return document.getElementById('canvas').width; },  
 98924: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98992: () => { if (document.fullscreenElement) return 1; },  
 99038: () => { return document.getElementById('canvas').width; },  
 99090: () => { return screen.width; },  
 99115: () => { return window.innerWidth; },  
 99141: () => { return window.innerHeight; },  
 99168: () => { if (document.fullscreenElement) return 1; },  
 99214: () => { return document.getElementById('canvas').width; },  
 99266: () => { return screen.width; },  
 99291: () => { document.exitFullscreen(); },  
 99318: () => { if (document.fullscreenElement) return 1; },  
 99364: () => { return document.getElementById('canvas').width; },  
 99416: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99484: () => { document.exitFullscreen(); },  
 99511: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99569: () => { return screen.width; },  
 99594: () => { return screen.height; },  
 99620: () => { return window.screenX; },  
 99647: () => { return window.screenY; },  
 99674: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99727: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99798: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99855: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100111: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100182: () => { if (document.fullscreenElement) return 1; },  
 100228: () => { return window.innerWidth; },  
 100254: () => { return window.innerHeight; },  
 100281: () => { if (document.pointerLockElement) return 1; }
};
