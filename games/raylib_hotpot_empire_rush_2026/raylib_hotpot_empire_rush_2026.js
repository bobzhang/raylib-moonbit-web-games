...
var ASM_CONSTS = {
 ...
 104322: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104390: () => { document.exitFullscreen(); },  
 104417: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 104490: () => { if (document.fullscreenElement) return 1; },  
 104536: () => { return document.getElementById('canvas').width; },  
 104588: () => { return screen.width; },  
 104613: () => { document.exitFullscreen(); },  
 104640: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 104773: () => { return window.innerWidth; },  
 104799: () => { return window.innerHeight; },  
 104826: () => { if (document.fullscreenElement) return 1; },  
 104872: () => { return document.getElementById('canvas').width; },  
 104924: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104992: () => { if (document.fullscreenElement) return 1; },  
 105038: () => { return document.getElementById('canvas').width; },  
 105090: () => { return screen.width; },  
 105115: () => { return window.innerWidth; },  
 105141: () => { return window.innerHeight; },  
 105168: () => { if (document.fullscreenElement) return 1; },  
 105214: () => { return document.getElementById('canvas').width; },  
 105266: () => { return screen.width; },  
 105291: () => { document.exitFullscreen(); },  
 105318: () => { if (document.fullscreenElement) return 1; },  
 105364: () => { return document.getElementById('canvas').width; },  
 105416: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105484: () => { document.exitFullscreen(); },  
 105511: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 105569: () => { return screen.width; },  
 105594: () => { return screen.height; },  
 105620: () => { return window.screenX; },  
 105647: () => { return window.screenY; },  
 105674: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 105727: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 105798: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 105855: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 106111: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 106182: () => { if (document.fullscreenElement) return 1; },  
 106228: () => { return window.innerWidth; },  
 106254: () => { return window.innerHeight; },  
 106281: () => { if (document.pointerLockElement) return 1; }
};
