...
function findWasmBinary() {
  return locateFile('raylib_hotpot_empire_rush_2026.wasm');
}
...
var ASM_CONSTS = {
  104384: () => { if (document.fullscreenElement) return 1; },  
 104430: () => { return document.getElementById('canvas').width; },  
 104482: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104550: () => { document.exitFullscreen(); },  
 104577: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 104650: () => { if (document.fullscreenElement) return 1; },  
 104696: () => { return document.getElementById('canvas').width; },  
 104748: () => { return screen.width; },  
 104773: () => { document.exitFullscreen(); },  
 104800: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 104933: () => { return window.innerWidth; },  
 104959: () => { return window.innerHeight; },  
 104986: () => { if (document.fullscreenElement) return 1; },  
 105032: () => { return document.getElementById('canvas').width; },  
 105084: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105152: () => { if (document.fullscreenElement) return 1; },  
 105198: () => { return document.getElementById('canvas').width; },  
 105250: () => { return screen.width; },  
 105275: () => { return window.innerWidth; },  
 105301: () => { return window.innerHeight; },  
 105328: () => { if (document.fullscreenElement) return 1; },  
 105374: () => { return document.getElementById('canvas').width; },  
 105426: () => { return screen.width; },  
 105451: () => { document.exitFullscreen(); },  
 105478: () => { if (document.fullscreenElement) return 1; },  
 105524: () => { return document.getElementById('canvas').width; },  
 105576: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105644: () => { document.exitFullscreen(); },  
 105671: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 105729: () => { return screen.width; },  
 105754: () => { return screen.height; },  
 105780: () => { return window.screenX; },  
 105807: () => { return window.screenY; },  
 105834: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 105887: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 105958: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 106015: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 106271: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 106342: () => { if (document.fullscreenElement) return 1; },  
 106388: () => { return window.innerWidth; },  
 106414: () => { return window.innerHeight; },  
 106441: () => { if (document.pointerLockElement) return 1; }
};
