...
var ASM_CONSTS = {
 ...
 99186: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99254: () => { document.exitFullscreen(); },  
 99281: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99354: () => { if (document.fullscreenElement) return 1; },  
 99400: () => { return document.getElementById('canvas').width; },  
 99452: () => { return screen.width; },  
 99477: () => { document.exitFullscreen(); },  
 99504: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99637: () => { return window.innerWidth; },  
 99663: () => { return window.innerHeight; },  
 99690: () => { if (document.fullscreenElement) return 1; },  
 99736: () => { return document.getElementById('canvas').width; },  
 99788: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99856: () => { if (document.fullscreenElement) return 1; },  
 99902: () => { return document.getElementById('canvas').width; },  
 99954: () => { return screen.width; },  
 99979: () => { return window.innerWidth; },  
 100005: () => { return window.innerHeight; },  
 ...
 100155: () => { document.exitFullscreen(); },  
 100182: () => { if (document.fullscreenElement) return 1; },  
 100228: () => { return document.getElementById('canvas').width; },  
 100280: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100348: () => { document.exitFullscreen(); },  
 100375: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100433: () => { return screen.width; },  
 100458: () => { return screen.height; },  
 100484: () => { return window.screenX; },  
 100511: () => { return window.screenY; },  
 100538: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100591: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100662: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100719: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100975: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101046: () => { if (document.fullscreenElement) return 1; },  
 101092: () => { return window.innerWidth; },  
 101118: () => { return window.innerHeight; },  
 101145: () => { if (document.pointerLockElement) return 1; }
};
