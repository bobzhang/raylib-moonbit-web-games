...
function findWasmBinary() {
  return locateFile('raylib_castle_siege_artillery_2026.wasm');
}
...
var ASM_CONSTS = {
  97888: () => { if (document.fullscreenElement) return 1; },  
 97934: () => { return document.getElementById('canvas').width; },  
 97986: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98054: () => { document.exitFullscreen(); },  
 98081: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98154: () => { if (document.fullscreenElement) return 1; },  
 98200: () => { return document.getElementById('canvas').width; },  
 98252: () => { return screen.width; },  
 98277: () => { document.exitFullscreen(); },  
 98304: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98437: () => { return window.innerWidth; },  
 98463: () => { return window.innerHeight; },  
 98490: () => { if (document.fullscreenElement) return 1; },  
 98536: () => { return document.getElementById('canvas').width; },  
 98588: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98656: () => { if (document.fullscreenElement) return 1; },  
 98702: () => { return document.getElementById('canvas').width; },  
 98754: () => { return screen.width; },  
 98779: () => { return window.innerWidth; },  
 98805: () => { return window.innerHeight; },  
 98832: () => { if (document.fullscreenElement) return 1; },  
 98878: () => { return document.getElementById('canvas').width; },  
 98930: () => { return screen.width; },  
 98955: () => { document.exitFullscreen(); },  
 98982: () => { if (document.fullscreenElement) return 1; },  
 99028: () => { return document.getElementById('canvas').width; },  
 99080: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99148: () => { document.exitFullscreen(); },  
 99175: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99233: () => { return screen.width; },  
 99258: () => { return screen.height; },  
 99284: () => { return window.screenX; },  
 99311: () => { return window.screenY; },  
 99338: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99391: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99462: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99519: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99775: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99846: () => { if (document.fullscreenElement) return 1; },  
 99892: () => { return window.innerWidth; },  
 99918: () => { return window.innerHeight; },  
 99945: () => { if (document.pointerLockElement) return 1; }
};
