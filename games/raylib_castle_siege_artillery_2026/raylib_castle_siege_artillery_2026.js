...
var ASM_CONSTS = {
  97728: () => { if (document.fullscreenElement) return 1; },  
 97774: () => { return document.getElementById('canvas').width; },  
 97826: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97894: () => { document.exitFullscreen(); },  
 97921: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97994: () => { if (document.fullscreenElement) return 1; },  
 98040: () => { return document.getElementById('canvas').width; },  
 98092: () => { return screen.width; },  
 98117: () => { document.exitFullscreen(); },  
 98144: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98277: () => { return window.innerWidth; },  
 98303: () => { return window.innerHeight; },  
 98330: () => { if (document.fullscreenElement) return 1; },  
 98376: () => { return document.getElementById('canvas').width; },  
 98428: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98496: () => { if (document.fullscreenElement) return 1; },  
 98542: () => { return document.getElementById('canvas').width; },  
 98594: () => { return screen.width; },  
 98619: () => { return window.innerWidth; },  
 98645: () => { return window.innerHeight; },  
 98672: () => { if (document.fullscreenElement) return 1; },  
 98718: () => { return document.getElementById('canvas').width; },  
 98770: () => { return screen.width; },  
 98795: () => { document.exitFullscreen(); },  
 98822: () => { if (document.fullscreenElement) return 1; },  
 98868: () => { return document.getElementById('canvas').width; },  
 98920: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98988: () => { document.exitFullscreen(); },  
 99015: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99073: () => { return screen.width; },  
 99098: () => { return screen.height; },  
 99124: () => { return window.screenX; },  
 99151: () => { return window.screenY; },  
 99178: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99231: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99302: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99359: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99615: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99686: () => { if (document.fullscreenElement) return 1; },  
 99732: () => { return window.innerWidth; },  
 99758: () => { return window.innerHeight; },  
 99785: () => { if (document.pointerLockElement) return 1; }
};
