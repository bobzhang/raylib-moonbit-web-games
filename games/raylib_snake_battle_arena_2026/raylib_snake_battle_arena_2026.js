...
var ASM_CONSTS = {
  106792: () => { if (document.fullscreenElement) return 1; },  
 106838: () => { return document.getElementById('canvas').width; },  
 106890: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106958: () => { document.exitFullscreen(); },  
 106985: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107058: () => { if (document.fullscreenElement) return 1; },  
 107104: () => { return document.getElementById('canvas').width; },  
 107156: () => { return screen.width; },  
 107181: () => { document.exitFullscreen(); },  
 107208: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107341: () => { return window.innerWidth; },  
 107367: () => { return window.innerHeight; },  
 107394: () => { if (document.fullscreenElement) return 1; },  
 107440: () => { return document.getElementById('canvas').width; },  
 107492: () => { return parseInt(document.getElementById('canvas').style.width); },  
