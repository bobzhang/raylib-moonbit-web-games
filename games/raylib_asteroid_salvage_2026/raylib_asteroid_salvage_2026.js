...
var ASM_CONSTS = {
  97216: () => { if (document.fullscreenElement) return 1; },  
 97262: () => { return document.getElementById('canvas').width; },  
 97314: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97382: () => { document.exitFullscreen(); },  
 97409: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97482: () => { if (document.fullscreenElement) return 1; },  
 97528: () => { return document.getElementById('canvas').width; },  
 97580: () => { return screen.width; },  
 97605: () => { document.exitFullscreen(); },  
 97632: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97765: () => { return window.innerWidth; },  
 97791: () => { return window.innerHeight; },  
 97818: () => { if (document.fullscreenElement) return 1; },  
 97864: () => { return document.getElementById('canvas').width; },  
 97916: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97984: () => { if (document.fullscreenElement) return 1; },  
 98030: () => { return document.getElementById('canvas').width; },  
 98082: () => { return screen.width; },  
 98107: () => { return window.innerWidth; },  
 98133: () => { return window.innerHeight; },  
 98160: () => { if (document.fullscreenElement) return 1; },  
 98206: () => { return document.getElementById('canvas').width; },  
 98258: () => { return screen.width; },  
 98283: () => { document.exitFullscreen(); },  
 98310: () => { if (document.fullscreenElement) return 1; },  
 98356: () => { return document.getElementById('canvas').width; },  
 98408: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98476: () => { document.exitFullscreen(); },  
 98503: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98561: () => { return screen.width; },  
 98586: () => { return screen.height; },  
 98612: () => { return window.screenX; },  
 98639: () => { return window.screenY; },  
 98666: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98719: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98790: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98847: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99103: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99174: () => { if (document.fullscreenElement) return 1; },  
 99220: () => { return window.innerWidth; },  
 99246: () => { return window.innerHeight; },  
 99273: () => { if (document.pointerLockElement) return 1; }
};
