...
var ASM_CONSTS = {
 ...
 97102: () => { return document.getElementById('canvas').width; },  
 97154: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97222: () => { document.exitFullscreen(); },  
 97249: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97322: () => { if (document.fullscreenElement) return 1; },  
 97368: () => { return document.getElementById('canvas').width; },  
 97420: () => { return screen.width; },  
 97445: () => { document.exitFullscreen(); },  
 97472: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97605: () => { return window.innerWidth; },  
 97631: () => { return window.innerHeight; },  
 97658: () => { if (document.fullscreenElement) return 1; },  
 97704: () => { return document.getElementById('canvas').width; },  
 97756: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97824: () => { if (document.fullscreenElement) return 1; },  
 97870: () => { return document.getElementById('canvas').width; },  
 97922: () => { return screen.width; },  
 97947: () => { return window.innerWidth; },  
 97973: () => { return window.innerHeight; },  
 98000: () => { if (document.fullscreenElement) return 1; },  
 98046: () => { return document.getElementById('canvas').width; },  
 98098: () => { return screen.width; },  
 98123: () => { document.exitFullscreen(); },  
 98150: () => { if (document.fullscreenElement) return 1; },  
 98196: () => { return document.getElementById('canvas').width; },  
 98248: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98316: () => { document.exitFullscreen(); },  
 98343: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98401: () => { return screen.width; },  
 98426: () => { return screen.height; },  
 98452: () => { return window.screenX; },  
 98479: () => { return window.screenY; },  
 98506: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98559: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98630: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98687: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98943: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99014: () => { if (document.fullscreenElement) return 1; },  
 99060: () => { return window.innerWidth; },  
 99086: () => { return window.innerHeight; },  
 99113: () => { if (document.pointerLockElement) return 1; }
};
