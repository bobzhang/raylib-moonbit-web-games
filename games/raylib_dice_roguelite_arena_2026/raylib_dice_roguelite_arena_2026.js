...
function findWasmBinary() {
  return locateFile('raylib_dice_roguelite_arena_2026.wasm');
}
...
var ASM_CONSTS = {
  100912: () => { if (document.fullscreenElement) return 1; },  
 100958: () => { return document.getElementById('canvas').width; },  
 101010: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101078: () => { document.exitFullscreen(); },  
 101105: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101178: () => { if (document.fullscreenElement) return 1; },  
 101224: () => { return document.getElementById('canvas').width; },  
 101276: () => { return screen.width; },  
 101301: () => { document.exitFullscreen(); },  
 101328: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101461: () => { return window.innerWidth; },  
 101487: () => { return window.innerHeight; },  
 101514: () => { if (document.fullscreenElement) return 1; },  
 101560: () => { return document.getElementById('canvas').width; },  
 101612: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101680: () => { if (document.fullscreenElement) return 1; },  
 101726: () => { return document.getElementById('canvas').width; },  
 101778: () => { return screen.width; },  
 101803: () => { return window.innerWidth; },  
 101829: () => { return window.innerHeight; },  
 101856: () => { if (document.fullscreenElement) return 1; },  
 101902: () => { return document.getElementById('canvas').width; },  
 101954: () => { return screen.width; },  
 101979: () => { document.exitFullscreen(); },  
 102006: () => { if (document.fullscreenElement) return 1; },  
 102052: () => { return document.getElementById('canvas').width; },  
 102104: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102172: () => { document.exitFullscreen(); },  
 102199: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 102257: () => { return screen.width; },  
 102282: () => { return screen.height; },  
 102308: () => { return window.screenX; },  
 102335: () => { return window.screenY; },  
 102362: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102415: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102486: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102543: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102799: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102870: () => { if (document.fullscreenElement) return 1; },  
 102916: () => { return window.innerWidth; },  
 102942: () => { return window.innerHeight; },  
 102969: () => { if (document.pointerLockElement) return 1; }
};
