...
var ASM_CONSTS = {
 ...
 100834: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100902: () => { document.exitFullscreen(); },  
 100929: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101002: () => { if (document.fullscreenElement) return 1; },  
 101048: () => { return document.getElementById('canvas').width; },  
 101100: () => { return screen.width; },  
 101125: () => { document.exitFullscreen(); },  
 101152: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101285: () => { return window.innerWidth; },  
 101311: () => { return window.innerHeight; },  
 101338: () => { if (document.fullscreenElement) return 1; },  
 101384: () => { return document.getElementById('canvas').width; },  
 101436: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101504: () => { if (document.fullscreenElement) return 1; },  
 101550: () => { return document.getElementById('canvas').width; },  
 101602: () => { return screen.width; },  
 101627: () => { return window.innerWidth; },  
 101653: () => { return window.innerHeight; },  
 ...
 101803: () => { document.exitFullscreen(); },  
 101830: () => { if (document.fullscreenElement) return 1; },  
 101876: () => { return document.getElementById('canvas').width; },  
 101928: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101996: () => { document.exitFullscreen(); },  
 102023: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 102081: () => { return screen.width; },  
 102106: () => { return screen.height; },  
 102132: () => { return window.screenX; },  
 102159: () => { return window.screenY; },  
 102186: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102239: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102310: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102367: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102623: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102694: () => { if (document.fullscreenElement) return 1; },  
 102740: () => { return window.innerWidth; },  
 102766: () => { return window.innerHeight; },  
 102793: () => { if (document.pointerLockElement) return 1; }
};
