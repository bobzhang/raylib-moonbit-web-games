...
var ASM_CONSTS = {
 ...
 100994: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101062: () => { document.exitFullscreen(); },  
 101089: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101162: () => { if (document.fullscreenElement) return 1; },  
 101208: () => { return document.getElementById('canvas').width; },  
 101260: () => { return screen.width; },  
 101285: () => { document.exitFullscreen(); },  
 101312: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101445: () => { return window.innerWidth; },  
 101471: () => { return window.innerHeight; },  
 101498: () => { if (document.fullscreenElement) return 1; },  
 101544: () => { return document.getElementById('canvas').width; },  
 101596: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101664: () => { if (document.fullscreenElement) return 1; },  
 101710: () => { return document.getElementById('canvas').width; },  
 101762: () => { return screen.width; },  
 101787: () => { return window.innerWidth; },  
 101813: () => { return window.innerHeight; },  
 101840: () => { if (document.fullscreenElement) return 1; },  
 101886: () => { return document.getElementById('canvas').width; },  
 101938: () => { return screen.width; },  
 101963: () => { document.exitFullscreen(); },  
 101990: () => { if (document.fullscreenElement) return 1; },  
 102036: () => { return document.getElementById('canvas').width; },  
 102088: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102156: () => { document.exitFullscreen(); },  
 102183: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 102241: () => { return screen.width; },  
 102266: () => { return screen.height; },  
 102292: () => { return window.screenX; },  
 102319: () => { return window.screenY; },  
 102346: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102399: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102470: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102527: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102783: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102854: () => { if (document.fullscreenElement) return 1; },  
 102900: () => { return window.innerWidth; },  
 102926: () => { return window.innerHeight; },  
 102953: () => { if (document.pointerLockElement) return 1; }
};
