...
function findWasmBinary() {
  return locateFile('raylib_archery_tournament_2026.wasm');
}
...
var ASM_CONSTS = {
  97616: () => { if (document.fullscreenElement) return 1; },  
 97662: () => { return document.getElementById('canvas').width; },  
 97714: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97782: () => { document.exitFullscreen(); },  
 97809: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97882: () => { if (document.fullscreenElement) return 1; },  
 97928: () => { return document.getElementById('canvas').width; },  
 97980: () => { return screen.width; },  
 98005: () => { document.exitFullscreen(); },  
 98032: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98165: () => { return window.innerWidth; },  
 98191: () => { return window.innerHeight; },  
 98218: () => { if (document.fullscreenElement) return 1; },  
 98264: () => { return document.getElementById('canvas').width; },  
 98316: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98384: () => { if (document.fullscreenElement) return 1; },  
 98430: () => { return document.getElementById('canvas').width; },  
 98482: () => { return screen.width; },  
 98507: () => { return window.innerWidth; },  
 98533: () => { return window.innerHeight; },  
 98560: () => { if (document.fullscreenElement) return 1; },  
 98606: () => { return document.getElementById('canvas').width; },  
 98658: () => { return screen.width; },  
 98683: () => { document.exitFullscreen(); },  
 98710: () => { if (document.fullscreenElement) return 1; },  
 98756: () => { return document.getElementById('canvas').width; },  
 98808: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98876: () => { document.exitFullscreen(); },  
 98903: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98961: () => { return screen.width; },  
 98986: () => { return screen.height; },  
 99012: () => { return window.screenX; },  
 99039: () => { return window.screenY; },  
 99066: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99119: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99190: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99247: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99503: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99574: () => { if (document.fullscreenElement) return 1; },  
 99620: () => { return window.innerWidth; },  
 99646: () => { return window.innerHeight; },  
 99673: () => { if (document.pointerLockElement) return 1; }
};
