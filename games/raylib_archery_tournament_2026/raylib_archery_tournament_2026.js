...
var ASM_CONSTS = {
  97440: () => { if (document.fullscreenElement) return 1; },  
 97486: () => { return document.getElementById('canvas').width; },  
 97538: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97606: () => { document.exitFullscreen(); },  
 97633: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97706: () => { if (document.fullscreenElement) return 1; },  
 97752: () => { return document.getElementById('canvas').width; },  
 97804: () => { return screen.width; },  
 97829: () => { document.exitFullscreen(); },  
 97856: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97989: () => { return window.innerWidth; },  
 98015: () => { return window.innerHeight; },  
 98042: () => { if (document.fullscreenElement) return 1; },  
 98088: () => { return document.getElementById('canvas').width; },  
 98140: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98208: () => { if (document.fullscreenElement) return 1; },  
 98254: () => { return document.getElementById('canvas').width; },  
 98306: () => { return screen.width; },  
 98331: () => { return window.innerWidth; },  
 98357: () => { return window.innerHeight; },  
 98384: () => { if (document.fullscreenElement) return 1; },  
 98430: () => { return document.getElementById('canvas').width; },  
 98482: () => { return screen.width; },  
 98507: () => { document.exitFullscreen(); },  
 98534: () => { if (document.fullscreenElement) return 1; },  
 98580: () => { return document.getElementById('canvas').width; },  
 98632: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98700: () => { document.exitFullscreen(); },  
 98727: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98785: () => { return screen.width; },  
 98810: () => { return screen.height; },  
 98836: () => { return window.screenX; },  
 98863: () => { return window.screenY; },  
 98890: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98943: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99014: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99071: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99327: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99398: () => { if (document.fullscreenElement) return 1; },  
 99444: () => { return window.innerWidth; },  
 99470: () => { return window.innerHeight; },  
 99497: () => { if (document.pointerLockElement) return 1; }
};
