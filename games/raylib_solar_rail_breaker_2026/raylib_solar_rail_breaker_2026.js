...
var ASM_CONSTS = {
  106664: () => { if (document.fullscreenElement) return 1; },  
 106710: () => { return document.getElementById('canvas').width; },  
 106762: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106830: () => { document.exitFullscreen(); },  
 106857: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106930: () => { if (document.fullscreenElement) return 1; },  
 106976: () => { return document.getElementById('canvas').width; },  
 107028: () => { return screen.width; },  
 107053: () => { document.exitFullscreen(); },  
 107080: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107213: () => { return window.innerWidth; },  
 107239: () => { return window.innerHeight; },  
 107266: () => { if (document.fullscreenElement) return 1; },  
 107312: () => { return document.getElementById('canvas').width; },  
 107364: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 107555: () => { return window.innerWidth; },  
 107581: () => { return window.innerHeight; },  
 ...
 107731: () => { document.exitFullscreen(); },  
 107758: () => { if (document.fullscreenElement) return 1; },  
 107804: () => { return document.getElementById('canvas').width; },  
 107856: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107924: () => { document.exitFullscreen(); },  
 107951: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 108009: () => { return screen.width; },  
 108034: () => { return screen.height; },  
 108060: () => { return window.screenX; },  
 108087: () => { return window.screenY; },  
 108114: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 108167: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 108238: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 108295: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108551: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108622: () => { if (document.fullscreenElement) return 1; },  
 108668: () => { return window.innerWidth; },  
 108694: () => { return window.innerHeight; },  
 108721: () => { if (document.pointerLockElement) return 1; },  
