...
var ASM_CONSTS = {
  106696: () => { if (document.fullscreenElement) return 1; },  
 106742: () => { return document.getElementById('canvas').width; },  
 106794: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106862: () => { document.exitFullscreen(); },  
 106889: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106962: () => { if (document.fullscreenElement) return 1; },  
 107008: () => { return document.getElementById('canvas').width; },  
 107060: () => { return screen.width; },  
 107085: () => { document.exitFullscreen(); },  
 107112: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107245: () => { return window.innerWidth; },  
 107271: () => { return window.innerHeight; },  
 107298: () => { if (document.fullscreenElement) return 1; },  
 107344: () => { return document.getElementById('canvas').width; },  
 107396: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107464: () => { if (document.fullscreenElement) return 1; },  
 107510: () => { return document.getElementById('canvas').width; },  
 107562: () => { return screen.width; },  
 107587: () => { return window.innerWidth; },  
 107613: () => { return window.innerHeight; },  
