...
var ASM_CONSTS = {
  99424: () => { if (document.fullscreenElement) return 1; },  
 99470: () => { return document.getElementById('canvas').width; },  
 99522: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99590: () => { document.exitFullscreen(); },  
 99617: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99690: () => { if (document.fullscreenElement) return 1; },  
 99736: () => { return document.getElementById('canvas').width; },  
 99788: () => { return screen.width; },  
 99813: () => { document.exitFullscreen(); },  
 99840: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99973: () => { return window.innerWidth; },  
 99999: () => { return window.innerHeight; },  
 100026: () => { if (document.fullscreenElement) return 1; },  
 100072: () => { return document.getElementById('canvas').width; },  
 100124: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100192: () => { if (document.fullscreenElement) return 1; },  
 100238: () => { return document.getElementById('canvas').width; },  
 100290: () => { return screen.width; },  
 100315: () => { return window.innerWidth; },  
 100341: () => { return window.innerHeight; },  
 ...
 100491: () => { document.exitFullscreen(); },  
 100518: () => { if (document.fullscreenElement) return 1; },  
 100564: () => { return document.getElementById('canvas').width; },  
 100616: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100684: () => { document.exitFullscreen(); },  
 100711: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100769: () => { return screen.width; },  
 100794: () => { return screen.height; },  
 100820: () => { return window.screenX; },  
 100847: () => { return window.screenY; },  
 100874: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100927: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100998: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101055: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101311: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101382: () => { if (document.fullscreenElement) return 1; },  
 101428: () => { return window.innerWidth; },  
 101454: () => { return window.innerHeight; },  
 101481: () => { if (document.pointerLockElement) return 1; }
};
