...
var ASM_CONSTS = {
  147616: () => { if (document.fullscreenElement) return 1; },  
 147662: () => { return document.getElementById('canvas').width; },  
 147714: () => { return parseInt(document.getElementById('canvas').style.width); },  
 147782: () => { document.exitFullscreen(); },  
 147809: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 147882: () => { if (document.fullscreenElement) return 1; },  
 147928: () => { return document.getElementById('canvas').width; },  
 147980: () => { return screen.width; },  
 148005: () => { document.exitFullscreen(); },  
 148032: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 148165: () => { return window.innerWidth; },  
 148191: () => { return window.innerHeight; },  
 148218: () => { if (document.fullscreenElement) return 1; },  
 148264: () => { return document.getElementById('canvas').width; },  
 148316: () => { return parseInt(document.getElementById('canvas').style.width); },  
 148384: () => { if (document.fullscreenElement) return 1; },  
 148430: () => { return document.getElementById('canvas').width; },  
 148482: () => { return screen.width; },  
 148507: () => { return window.innerWidth; },  
 148533: () => { return window.innerHeight; },  
 148560: () => { if (document.fullscreenElement) return 1; },  
 148606: () => { return document.getElementById('canvas').width; },  
 148658: () => { return screen.width; },  
 148683: () => { document.exitFullscreen(); },  
 148710: () => { if (document.fullscreenElement) return 1; },  
 148756: () => { return document.getElementById('canvas').width; },  
 148808: () => { return parseInt(document.getElementById('canvas').style.width); },  
 148876: () => { document.exitFullscreen(); },  
 148903: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 148961: () => { return screen.width; },  
 148986: () => { return screen.height; },  
 149012: () => { return window.screenX; },  
 149039: () => { return window.screenY; },  
 149066: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 149119: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 149190: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 149247: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 149503: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 149574: () => { if (document.fullscreenElement) return 1; },  
 149620: () => { return window.innerWidth; },  
 149646: () => { return window.innerHeight; },  
 149673: () => { if (document.pointerLockElement) return 1; }
};
