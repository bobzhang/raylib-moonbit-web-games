...
var ASM_CONSTS = {
 ...
 107050: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107118: () => { document.exitFullscreen(); },  
 107145: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107218: () => { if (document.fullscreenElement) return 1; },  
 107264: () => { return document.getElementById('canvas').width; },  
 107316: () => { return screen.width; },  
 107341: () => { document.exitFullscreen(); },  
 107368: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107501: () => { return window.innerWidth; },  
 107527: () => { return window.innerHeight; },  
 107554: () => { if (document.fullscreenElement) return 1; },  
 107600: () => { return document.getElementById('canvas').width; },  
 107652: () => { return parseInt(document.getElementById('canvas').style.width); },  
