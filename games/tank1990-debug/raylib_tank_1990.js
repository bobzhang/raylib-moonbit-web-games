...
Module.preRun.push(function() {
  if (typeof GLFW !== 'object' || typeof GLFW.createWindow !== 'function') {
    console.error('[preRun] GLFW.createWindow missing');
    return;
  }
  const orig = GLFW.createWindow;
  GLFW.createWindow = function(width, height, title, monitor, share) {
    ...
    let ret;
    try {
      ret = orig.call(GLFW, width, height, title, monitor, share);
    } catch (e) {
      console.error('[glfw-debug] createWindow threw', e && (e.stack || e.message || e));
      throw e;
    }
...
// end include: /tmp/glfw_debug.pre.js
