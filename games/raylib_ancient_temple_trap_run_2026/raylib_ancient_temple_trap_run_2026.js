...
var ASM_CONSTS = {
  100224: () => { if (document.fullscreenElement) return 1; },  
 100270: () => { return document.getElementById('canvas').width; },  
 100322: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100390: () => { document.exitFullscreen(); },  
 100417: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100490: () => { if (document.fullscreenElement) return 1; },  
 100536: () => { return document.getElementById('canvas').width; },  
 100588: () => { return screen.width; },  
 100613: () => { document.exitFullscreen(); },  
 100640: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100773: () => { return window.innerWidth; },  
 100799: () => { return window.innerHeight; },  
 100826: () => { if (document.fullscreenElement) return 1; },  
 100872: () => { return document.getElementById('canvas').width; },  
 100924: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100992: () => { if (document.fullscreenElement) return 1; },  
 101038: () => { return document.getElementById('canvas').width; },  
 101090: () => { return screen.width; },  
 101115: () => { return window.innerWidth; },  
 101141: () => { return window.innerHeight; },  
 101168: () => { if (document.fullscreenElement) return 1; },  
 101214: () => { return document.getElementById('canvas').width; },  
 101266: () => { return screen.width; },  
 101291: () => { document.exitFullscreen(); },  
 101318: () => { if (document.fullscreenElement) return 1; },  
 101364: () => { return document.getElementById('canvas').width; },  
 101416: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101484: () => { document.exitFullscreen(); },  
 101511: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101569: () => { return screen.width; },  
 101594: () => { return screen.height; },  
 101620: () => { return window.screenX; },  
 101647: () => { return window.screenY; },  
 101674: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101727: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101798: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101855: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102111: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102182: () => { if (document.fullscreenElement) return 1; },  
 102228: () => { return window.innerWidth; },  
 102254: () => { return window.innerHeight; },  
 102281: () => { if (document.pointerLockElement) return 1; }
};
