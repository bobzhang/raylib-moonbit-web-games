...
function findWasmBinary() {
  return locateFile('raylib_ancient_temple_trap_run_2026.wasm');
}
...
var ASM_CONSTS = {
  100064: () => { if (document.fullscreenElement) return 1; },  
 100110: () => { return document.getElementById('canvas').width; },  
 100162: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100230: () => { document.exitFullscreen(); },  
 100257: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100330: () => { if (document.fullscreenElement) return 1; },  
 100376: () => { return document.getElementById('canvas').width; },  
 100428: () => { return screen.width; },  
 100453: () => { document.exitFullscreen(); },  
 100480: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100613: () => { return window.innerWidth; },  
 100639: () => { return window.innerHeight; },  
 100666: () => { if (document.fullscreenElement) return 1; },  
 100712: () => { return document.getElementById('canvas').width; },  
 100764: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100832: () => { if (document.fullscreenElement) return 1; },  
 100878: () => { return document.getElementById('canvas').width; },  
 100930: () => { return screen.width; },  
 100955: () => { return window.innerWidth; },  
 100981: () => { return window.innerHeight; },  
 101008: () => { if (document.fullscreenElement) return 1; },  
 101054: () => { return document.getElementById('canvas').width; },  
 101106: () => { return screen.width; },  
 101131: () => { document.exitFullscreen(); },  
 101158: () => { if (document.fullscreenElement) return 1; },  
 101204: () => { return document.getElementById('canvas').width; },  
 101256: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101324: () => { document.exitFullscreen(); },  
 101351: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101409: () => { return screen.width; },  
 101434: () => { return screen.height; },  
 101460: () => { return window.screenX; },  
 101487: () => { return window.screenY; },  
 101514: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101567: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101638: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101695: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101951: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102022: () => { if (document.fullscreenElement) return 1; },  
 102068: () => { return window.innerWidth; },  
 102094: () => { return window.innerHeight; },  
 102121: () => { if (document.pointerLockElement) return 1; }
};
