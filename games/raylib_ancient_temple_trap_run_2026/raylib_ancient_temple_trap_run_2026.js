...
var ASM_CONSTS = {
  100240: () => { if (document.fullscreenElement) return 1; },  
 100286: () => { return document.getElementById('canvas').width; },  
 100338: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100406: () => { document.exitFullscreen(); },  
 100433: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100506: () => { if (document.fullscreenElement) return 1; },  
 100552: () => { return document.getElementById('canvas').width; },  
 100604: () => { return screen.width; },  
 100629: () => { document.exitFullscreen(); },  
 100656: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100789: () => { return window.innerWidth; },  
 100815: () => { return window.innerHeight; },  
 100842: () => { if (document.fullscreenElement) return 1; },  
 100888: () => { return document.getElementById('canvas').width; },  
 100940: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 101131: () => { return window.innerWidth; },  
 101157: () => { return window.innerHeight; },  
 101184: () => { if (document.fullscreenElement) return 1; },  
 101230: () => { return document.getElementById('canvas').width; },  
 101282: () => { return screen.width; },  
 101307: () => { document.exitFullscreen(); },  
 101334: () => { if (document.fullscreenElement) return 1; },  
 101380: () => { return document.getElementById('canvas').width; },  
 101432: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101500: () => { document.exitFullscreen(); },  
 101527: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101585: () => { return screen.width; },  
 101610: () => { return screen.height; },  
 101636: () => { return window.screenX; },  
 101663: () => { return window.screenY; },  
 101690: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101743: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101814: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101871: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102127: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102198: () => { if (document.fullscreenElement) return 1; },  
 102244: () => { return window.innerWidth; },  
 102270: () => { return window.innerHeight; },  
 102297: () => { if (document.pointerLockElement) return 1; }
};
