...
var ASM_CONSTS = {
 ...
 99762: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100028: () => { return screen.width; },  
 100053: () => { document.exitFullscreen(); },  
 100080: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100213: () => { return window.innerWidth; },  
 100239: () => { return window.innerHeight; },  
 100266: () => { if (document.fullscreenElement) return 1; },  
 100312: () => { return document.getElementById('canvas').width; },  
 100364: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100432: () => { if (document.fullscreenElement) return 1; },  
 100478: () => { return document.getElementById('canvas').width; },  
 100530: () => { return screen.width; },  
 100555: () => { return window.innerWidth; },  
 100581: () => { return window.innerHeight; },  
 100608: () => { if (document.fullscreenElement) return 1; },  
 100654: () => { return document.getElementById('canvas').width; },  
 100706: () => { return screen.width; },  
 100731: () => { document.exitFullscreen(); },  
 100758: () => { if (document.fullscreenElement) return 1; },  
 100804: () => { return document.getElementById('canvas').width; },  
 100856: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100924: () => { document.exitFullscreen(); },  
 100951: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101009: () => { return screen.width; },  
 101034: () => { return screen.height; },  
 101060: () => { return window.screenX; },  
 101087: () => { return window.screenY; },  
 101114: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101167: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101238: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101295: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101551: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101622: () => { if (document.fullscreenElement) return 1; },  
 101668: () => { return window.innerWidth; },  
 101694: () => { return window.innerHeight; },  
 101721: () => { if (document.pointerLockElement) return 1; }
};
