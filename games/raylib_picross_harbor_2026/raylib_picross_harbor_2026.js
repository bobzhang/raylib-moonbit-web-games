...
function findWasmBinary() {
  return locateFile('raylib_picross_harbor_2026.wasm');
}
...
var ASM_CONSTS = {
  99680: () => { if (document.fullscreenElement) return 1; },  
 99726: () => { return document.getElementById('canvas').width; },  
 99778: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99846: () => { document.exitFullscreen(); },  
 99873: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99946: () => { if (document.fullscreenElement) return 1; },  
 99992: () => { return document.getElementById('canvas').width; },  
 100044: () => { return screen.width; },  
 100069: () => { document.exitFullscreen(); },  
 100096: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100229: () => { return window.innerWidth; },  
 100255: () => { return window.innerHeight; },  
 100282: () => { if (document.fullscreenElement) return 1; },  
 100328: () => { return document.getElementById('canvas').width; },  
 100380: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100448: () => { if (document.fullscreenElement) return 1; },  
 100494: () => { return document.getElementById('canvas').width; },  
 100546: () => { return screen.width; },  
 100571: () => { return window.innerWidth; },  
 100597: () => { return window.innerHeight; },  
 100624: () => { if (document.fullscreenElement) return 1; },  
 100670: () => { return document.getElementById('canvas').width; },  
 100722: () => { return screen.width; },  
 100747: () => { document.exitFullscreen(); },  
 100774: () => { if (document.fullscreenElement) return 1; },  
 100820: () => { return document.getElementById('canvas').width; },  
 100872: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100940: () => { document.exitFullscreen(); },  
 100967: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101025: () => { return screen.width; },  
 101050: () => { return screen.height; },  
 101076: () => { return window.screenX; },  
 101103: () => { return window.screenY; },  
 101130: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101183: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101254: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101311: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101567: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101638: () => { if (document.fullscreenElement) return 1; },  
 101684: () => { return window.innerWidth; },  
 101710: () => { return window.innerHeight; },  
 101737: () => { if (document.pointerLockElement) return 1; }
};
