...
var ASM_CONSTS = {
  97808: () => { if (document.fullscreenElement) return 1; },  
 97854: () => { return document.getElementById('canvas').width; },  
 97906: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97974: () => { document.exitFullscreen(); },  
 98001: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98074: () => { if (document.fullscreenElement) return 1; },  
 98120: () => { return document.getElementById('canvas').width; },  
 98172: () => { return screen.width; },  
 98197: () => { document.exitFullscreen(); },  
 98224: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98357: () => { return window.innerWidth; },  
 98383: () => { return window.innerHeight; },  
 98410: () => { if (document.fullscreenElement) return 1; },  
 98456: () => { return document.getElementById('canvas').width; },  
 98508: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98576: () => { if (document.fullscreenElement) return 1; },  
 98622: () => { return document.getElementById('canvas').width; },  
 98674: () => { return screen.width; },  
 98699: () => { return window.innerWidth; },  
 98725: () => { return window.innerHeight; },  
 98752: () => { if (document.fullscreenElement) return 1; },  
 98798: () => { return document.getElementById('canvas').width; },  
 98850: () => { return screen.width; },  
 98875: () => { document.exitFullscreen(); },  
 98902: () => { if (document.fullscreenElement) return 1; },  
 98948: () => { return document.getElementById('canvas').width; },  
 99000: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99068: () => { document.exitFullscreen(); },  
 99095: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99153: () => { return screen.width; },  
 99178: () => { return screen.height; },  
 99204: () => { return window.screenX; },  
 99231: () => { return window.screenY; },  
 99258: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99311: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99382: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99439: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99695: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99766: () => { if (document.fullscreenElement) return 1; },  
 99812: () => { return window.innerWidth; },  
 99838: () => { return window.innerHeight; },  
 99865: () => { if (document.pointerLockElement) return 1; }
};
