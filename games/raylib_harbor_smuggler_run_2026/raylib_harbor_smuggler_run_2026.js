...
function findWasmBinary() {
  return locateFile('raylib_harbor_smuggler_run_2026.wasm');
}
...
var ASM_CONSTS = {
  97984: () => { if (document.fullscreenElement) return 1; },  
 98030: () => { return document.getElementById('canvas').width; },  
 98082: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98150: () => { document.exitFullscreen(); },  
 98177: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98250: () => { if (document.fullscreenElement) return 1; },  
 98296: () => { return document.getElementById('canvas').width; },  
 98348: () => { return screen.width; },  
 98373: () => { document.exitFullscreen(); },  
 98400: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98533: () => { return window.innerWidth; },  
 98559: () => { return window.innerHeight; },  
 98586: () => { if (document.fullscreenElement) return 1; },  
 98632: () => { return document.getElementById('canvas').width; },  
 98684: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98752: () => { if (document.fullscreenElement) return 1; },  
 98798: () => { return document.getElementById('canvas').width; },  
 98850: () => { return screen.width; },  
 98875: () => { return window.innerWidth; },  
 98901: () => { return window.innerHeight; },  
 98928: () => { if (document.fullscreenElement) return 1; },  
 98974: () => { return document.getElementById('canvas').width; },  
 99026: () => { return screen.width; },  
 99051: () => { document.exitFullscreen(); },  
 99078: () => { if (document.fullscreenElement) return 1; },  
 99124: () => { return document.getElementById('canvas').width; },  
 99176: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99244: () => { document.exitFullscreen(); },  
 99271: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99329: () => { return screen.width; },  
 99354: () => { return screen.height; },  
 99380: () => { return window.screenX; },  
 99407: () => { return window.screenY; },  
 99434: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99487: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99558: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99615: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99871: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99942: () => { if (document.fullscreenElement) return 1; },  
 99988: () => { return window.innerWidth; },  
 100014: () => { return window.innerHeight; },  
 100041: () => { if (document.pointerLockElement) return 1; }
};
