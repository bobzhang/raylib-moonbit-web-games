...
function findWasmBinary() {
  return locateFile('raylib_magnet_lab_escape_2026.wasm');
}
...
var ASM_CONSTS = {
  98880: () => { if (document.fullscreenElement) return 1; },  
 98926: () => { return document.getElementById('canvas').width; },  
 98978: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99046: () => { document.exitFullscreen(); },  
 99073: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99146: () => { if (document.fullscreenElement) return 1; },  
 99192: () => { return document.getElementById('canvas').width; },  
 99244: () => { return screen.width; },  
 99269: () => { document.exitFullscreen(); },  
 99296: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99429: () => { return window.innerWidth; },  
 99455: () => { return window.innerHeight; },  
 99482: () => { if (document.fullscreenElement) return 1; },  
 99528: () => { return document.getElementById('canvas').width; },  
 99580: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99648: () => { if (document.fullscreenElement) return 1; },  
 99694: () => { return document.getElementById('canvas').width; },  
 99746: () => { return screen.width; },  
 99771: () => { return window.innerWidth; },  
 99797: () => { return window.innerHeight; },  
 99824: () => { if (document.fullscreenElement) return 1; },  
 99870: () => { return document.getElementById('canvas').width; },  
 99922: () => { return screen.width; },  
 99947: () => { document.exitFullscreen(); },  
 99974: () => { if (document.fullscreenElement) return 1; },  
 100020: () => { return document.getElementById('canvas').width; },  
 100072: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100140: () => { document.exitFullscreen(); },  
 100167: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100225: () => { return screen.width; },  
 100250: () => { return screen.height; },  
 100276: () => { return window.screenX; },  
 100303: () => { return window.screenY; },  
 100330: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100383: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100454: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100511: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100767: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100838: () => { if (document.fullscreenElement) return 1; },  
 100884: () => { return window.innerWidth; },  
 100910: () => { return window.innerHeight; },  
 100937: () => { if (document.pointerLockElement) return 1; }
};
