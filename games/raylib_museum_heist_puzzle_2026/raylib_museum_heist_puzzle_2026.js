...
var ASM_CONSTS = {
 ...
 99058: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99126: () => { document.exitFullscreen(); },  
 99153: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99226: () => { if (document.fullscreenElement) return 1; },  
 99272: () => { return document.getElementById('canvas').width; },  
 99324: () => { return screen.width; },  
 99349: () => { document.exitFullscreen(); },  
 99376: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99509: () => { return window.innerWidth; },  
 99535: () => { return window.innerHeight; },  
 99562: () => { if (document.fullscreenElement) return 1; },  
 99608: () => { return document.getElementById('canvas').width; },  
 99660: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99728: () => { if (document.fullscreenElement) return 1; },  
 99774: () => { return document.getElementById('canvas').width; },  
 99826: () => { return screen.width; },  
 99851: () => { return window.innerWidth; },  
 99877: () => { return window.innerHeight; },  
 99904: () => { if (document.fullscreenElement) return 1; },  
 99950: () => { return document.getElementById('canvas').width; },  
 100002: () => { return screen.width; },  
 100027: () => { document.exitFullscreen(); },  
 100054: () => { if (document.fullscreenElement) return 1; },  
 100100: () => { return document.getElementById('canvas').width; },  
 100152: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100220: () => { document.exitFullscreen(); },  
 100247: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100305: () => { return screen.width; },  
 100330: () => { return screen.height; },  
 100356: () => { return window.screenX; },  
 100383: () => { return window.screenY; },  
 100410: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100463: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100534: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100591: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100847: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100918: () => { if (document.fullscreenElement) return 1; },  
 100964: () => { return window.innerWidth; },  
 100990: () => { return window.innerHeight; },  
 101017: () => { if (document.pointerLockElement) return 1; }
};
