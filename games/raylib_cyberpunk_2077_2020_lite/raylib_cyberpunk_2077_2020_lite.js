...
function findWasmBinary() {
  return locateFile('raylib_cyberpunk_2077_2020_lite.wasm');
}
...
var ASM_CONSTS = {
  2380880: () => { if (document.fullscreenElement) return 1; },  
 2380926: () => { return document.getElementById('canvas').width; },  
 2380978: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2381046: () => { document.exitFullscreen(); },  
 2381073: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 2381146: () => { if (document.fullscreenElement) return 1; },  
 2381192: () => { return document.getElementById('canvas').width; },  
 2381244: () => { return screen.width; },  
 2381269: () => { document.exitFullscreen(); },  
 2381296: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2381429: () => { return window.innerWidth; },  
 2381455: () => { return window.innerHeight; },  
 2381482: () => { if (document.fullscreenElement) return 1; },  
 2381528: () => { return document.getElementById('canvas').width; },  
 2381580: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2381648: () => { if (document.fullscreenElement) return 1; },  
 2381694: () => { return document.getElementById('canvas').width; },  
 2381746: () => { return screen.width; },  
 2381771: () => { return window.innerWidth; },  
 2381797: () => { return window.innerHeight; },  
 2381824: () => { if (document.fullscreenElement) return 1; },  
 2381870: () => { return document.getElementById('canvas').width; },  
 2381922: () => { return screen.width; },  
 2381947: () => { document.exitFullscreen(); },  
 2381974: () => { if (document.fullscreenElement) return 1; },  
 2382020: () => { return document.getElementById('canvas').width; },  
 2382072: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2382140: () => { document.exitFullscreen(); },  
 2382167: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 2382225: () => { return screen.width; },  
 2382250: () => { return screen.height; },  
 2382276: () => { return window.screenX; },  
 2382303: () => { return window.screenY; },  
 2382330: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2382383: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 2382454: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 2382511: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2382767: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 2382838: () => { if (document.fullscreenElement) return 1; },  
 2382884: () => { return window.innerWidth; },  
 2382910: () => { return window.innerHeight; },  
 2382937: () => { if (document.pointerLockElement) return 1; }
};
