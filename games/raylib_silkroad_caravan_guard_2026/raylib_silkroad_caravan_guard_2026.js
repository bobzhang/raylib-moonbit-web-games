...
var ASM_CONSTS = {
 ...
 99218: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99286: () => { document.exitFullscreen(); },  
 99313: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99386: () => { if (document.fullscreenElement) return 1; },  
 99432: () => { return document.getElementById('canvas').width; },  
 99484: () => { return screen.width; },  
 99509: () => { document.exitFullscreen(); },  
 99536: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99669: () => { return window.innerWidth; },  
 99695: () => { return window.innerHeight; },  
 99722: () => { if (document.fullscreenElement) return 1; },  
 99768: () => { return document.getElementById('canvas').width; },  
 99820: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99888: () => { if (document.fullscreenElement) return 1; },  
 99934: () => { return document.getElementById('canvas').width; },  
 99986: () => { return screen.width; },  
 100011: () => { return window.innerWidth; },  
 100037: () => { return window.innerHeight; },  
 ...
 100187: () => { document.exitFullscreen(); },  
 100214: () => { if (document.fullscreenElement) return 1; },  
 100260: () => { return document.getElementById('canvas').width; },  
 100312: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100380: () => { document.exitFullscreen(); },  
 100407: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100465: () => { return screen.width; },  
 100490: () => { return screen.height; },  
 100516: () => { return window.screenX; },  
 100543: () => { return window.screenY; },  
 100570: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100623: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100694: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100751: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101007: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101078: () => { if (document.fullscreenElement) return 1; },  
 101124: () => { return window.innerWidth; },  
 101150: () => { return window.innerHeight; },  
 101177: () => { if (document.pointerLockElement) return 1; }
};
