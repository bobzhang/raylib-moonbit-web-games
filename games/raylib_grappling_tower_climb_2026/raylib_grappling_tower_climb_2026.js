...
var ASM_CONSTS = {
  98000: () => { if (document.fullscreenElement) return 1; },  
 98046: () => { return document.getElementById('canvas').width; },  
 98098: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98166: () => { document.exitFullscreen(); },  
 98193: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98266: () => { if (document.fullscreenElement) return 1; },  
 98312: () => { return document.getElementById('canvas').width; },  
 98364: () => { return screen.width; },  
 98389: () => { document.exitFullscreen(); },  
 98416: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98549: () => { return window.innerWidth; },  
 98575: () => { return window.innerHeight; },  
 98602: () => { if (document.fullscreenElement) return 1; },  
 98648: () => { return document.getElementById('canvas').width; },  
 98700: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98768: () => { if (document.fullscreenElement) return 1; },  
 98814: () => { return document.getElementById('canvas').width; },  
 98866: () => { return screen.width; },  
 98891: () => { return window.innerWidth; },  
 98917: () => { return window.innerHeight; },  
 98944: () => { if (document.fullscreenElement) return 1; },  
 98990: () => { return document.getElementById('canvas').width; },  
 99042: () => { return screen.width; },  
 99067: () => { document.exitFullscreen(); },  
 99094: () => { if (document.fullscreenElement) return 1; },  
 99140: () => { return document.getElementById('canvas').width; },  
 99192: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99260: () => { document.exitFullscreen(); },  
 99287: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99345: () => { return screen.width; },  
 99370: () => { return screen.height; },  
 99396: () => { return window.screenX; },  
 99423: () => { return window.screenY; },  
 99450: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99503: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99574: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99631: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99887: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99958: () => { if (document.fullscreenElement) return 1; },  
 100004: () => { return window.innerWidth; },  
 100030: () => { return window.innerHeight; },  
 100057: () => { if (document.pointerLockElement) return 1; }
};
