...
var ASM_CONSTS = {
  98160: () => { if (document.fullscreenElement) return 1; },  
 98206: () => { return document.getElementById('canvas').width; },  
 98258: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98326: () => { document.exitFullscreen(); },  
 98353: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98426: () => { if (document.fullscreenElement) return 1; },  
 98472: () => { return document.getElementById('canvas').width; },  
 98524: () => { return screen.width; },  
 98549: () => { document.exitFullscreen(); },  
 98576: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98709: () => { return window.innerWidth; },  
 98735: () => { return window.innerHeight; },  
 98762: () => { if (document.fullscreenElement) return 1; },  
 98808: () => { return document.getElementById('canvas').width; },  
 98860: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98928: () => { if (document.fullscreenElement) return 1; },  
 98974: () => { return document.getElementById('canvas').width; },  
 99026: () => { return screen.width; },  
 99051: () => { return window.innerWidth; },  
 99077: () => { return window.innerHeight; },  
 99104: () => { if (document.fullscreenElement) return 1; },  
 99150: () => { return document.getElementById('canvas').width; },  
 99202: () => { return screen.width; },  
 99227: () => { document.exitFullscreen(); },  
 99254: () => { if (document.fullscreenElement) return 1; },  
 99300: () => { return document.getElementById('canvas').width; },  
 99352: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99420: () => { document.exitFullscreen(); },  
 99447: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99505: () => { return screen.width; },  
 99530: () => { return screen.height; },  
 99556: () => { return window.screenX; },  
 99583: () => { return window.screenY; },  
 99610: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99663: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99734: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99791: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100047: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100118: () => { if (document.fullscreenElement) return 1; },  
 100164: () => { return window.innerWidth; },  
 100190: () => { return window.innerHeight; },  
 100217: () => { if (document.pointerLockElement) return 1; }
};
