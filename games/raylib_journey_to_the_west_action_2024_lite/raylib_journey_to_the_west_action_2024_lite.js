...
function findWasmBinary() {
  return locateFile('raylib_journey_to_the_west_action_2024_lite.wasm');
}
...
var ASM_CONSTS = {
  2382400: () => { if (document.fullscreenElement) return 1; },  
 2382446: () => { return document.getElementById('canvas').width; },  
 2382498: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2382566: () => { document.exitFullscreen(); },  
 2382593: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 2382666: () => { if (document.fullscreenElement) return 1; },  
 2382712: () => { return document.getElementById('canvas').width; },  
 2382764: () => { return screen.width; },  
 2382789: () => { document.exitFullscreen(); },  
 2382816: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2382949: () => { return window.innerWidth; },  
 2382975: () => { return window.innerHeight; },  
 2383002: () => { if (document.fullscreenElement) return 1; },  
 2383048: () => { return document.getElementById('canvas').width; },  
 2383100: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2383168: () => { if (document.fullscreenElement) return 1; },  
 2383214: () => { return document.getElementById('canvas').width; },  
 2383266: () => { return screen.width; },  
 2383291: () => { return window.innerWidth; },  
 2383317: () => { return window.innerHeight; },  
 2383344: () => { if (document.fullscreenElement) return 1; },  
 2383390: () => { return document.getElementById('canvas').width; },  
 2383442: () => { return screen.width; },  
 2383467: () => { document.exitFullscreen(); },  
 2383494: () => { if (document.fullscreenElement) return 1; },  
 2383540: () => { return document.getElementById('canvas').width; },  
 2383592: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2383660: () => { document.exitFullscreen(); },  
 2383687: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 2383745: () => { return screen.width; },  
 2383770: () => { return screen.height; },  
 2383796: () => { return window.screenX; },  
 2383823: () => { return window.screenY; },  
 2383850: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2383903: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 2383974: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 2384031: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2384287: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 2384358: () => { if (document.fullscreenElement) return 1; },  
 2384404: () => { return window.innerWidth; },  
 2384430: () => { return window.innerHeight; },  
 2384457: () => { if (document.pointerLockElement) return 1; }
};
...
// include: /Users/hongbozhang/git/tonyfettes-raylib/tools/web_mobile_touch.post.js
if (typeof Module !== "object") Module = {};
...
// end include: /Users/hongbozhang/git/tonyfettes-raylib/tools/web_mobile_touch.post.js
