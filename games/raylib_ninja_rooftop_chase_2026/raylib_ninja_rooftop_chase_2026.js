...
var ASM_CONSTS = {
  98240: () => { if (document.fullscreenElement) return 1; },  
 98286: () => { return document.getElementById('canvas').width; },  
 98338: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98406: () => { document.exitFullscreen(); },  
 98433: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98506: () => { if (document.fullscreenElement) return 1; },  
 98552: () => { return document.getElementById('canvas').width; },  
 98604: () => { return screen.width; },  
 98629: () => { document.exitFullscreen(); },  
 98656: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98789: () => { return window.innerWidth; },  
 98815: () => { return window.innerHeight; },  
 98842: () => { if (document.fullscreenElement) return 1; },  
 98888: () => { return document.getElementById('canvas').width; },  
 98940: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99008: () => { if (document.fullscreenElement) return 1; },  
 99054: () => { return document.getElementById('canvas').width; },  
 99106: () => { return screen.width; },  
 99131: () => { return window.innerWidth; },  
 99157: () => { return window.innerHeight; },  
 99184: () => { if (document.fullscreenElement) return 1; },  
 99230: () => { return document.getElementById('canvas').width; },  
 99282: () => { return screen.width; },  
 99307: () => { document.exitFullscreen(); },  
 99334: () => { if (document.fullscreenElement) return 1; },  
 99380: () => { return document.getElementById('canvas').width; },  
 99432: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99500: () => { document.exitFullscreen(); },  
 99527: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99585: () => { return screen.width; },  
 99610: () => { return screen.height; },  
 99636: () => { return window.screenX; },  
 99663: () => { return window.screenY; },  
 99690: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99743: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99814: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99871: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100127: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100198: () => { if (document.fullscreenElement) return 1; },  
 100244: () => { return window.innerWidth; },  
 100270: () => { return window.innerHeight; },  
 100297: () => { if (document.pointerLockElement) return 1; }
};
