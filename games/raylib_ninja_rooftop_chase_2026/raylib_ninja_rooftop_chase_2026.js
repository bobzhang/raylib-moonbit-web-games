...
function findWasmBinary() {
  return locateFile('raylib_ninja_rooftop_chase_2026.wasm');
}
...
var ASM_CONSTS = {
  98416: () => { if (document.fullscreenElement) return 1; },  
 98462: () => { return document.getElementById('canvas').width; },  
 98514: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98582: () => { document.exitFullscreen(); },  
 98609: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98682: () => { if (document.fullscreenElement) return 1; },  
 98728: () => { return document.getElementById('canvas').width; },  
 98780: () => { return screen.width; },  
 98805: () => { document.exitFullscreen(); },  
 98832: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98965: () => { return window.innerWidth; },  
 98991: () => { return window.innerHeight; },  
 99018: () => { if (document.fullscreenElement) return 1; },  
 99064: () => { return document.getElementById('canvas').width; },  
 99116: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99184: () => { if (document.fullscreenElement) return 1; },  
 99230: () => { return document.getElementById('canvas').width; },  
 99282: () => { return screen.width; },  
 99307: () => { return window.innerWidth; },  
 99333: () => { return window.innerHeight; },  
 99360: () => { if (document.fullscreenElement) return 1; },  
 99406: () => { return document.getElementById('canvas').width; },  
 99458: () => { return screen.width; },  
 99483: () => { document.exitFullscreen(); },  
 99510: () => { if (document.fullscreenElement) return 1; },  
 99556: () => { return document.getElementById('canvas').width; },  
 99608: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99676: () => { document.exitFullscreen(); },  
 99703: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99761: () => { return screen.width; },  
 99786: () => { return screen.height; },  
 99812: () => { return window.screenX; },  
 99839: () => { return window.screenY; },  
 99866: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99919: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99990: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100047: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100303: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100374: () => { if (document.fullscreenElement) return 1; },  
 100420: () => { return window.innerWidth; },  
 100446: () => { return window.innerHeight; },  
 100473: () => { if (document.pointerLockElement) return 1; }
};
