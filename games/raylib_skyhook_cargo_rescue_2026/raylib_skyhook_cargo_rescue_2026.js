...
var ASM_CONSTS = {
 ...
 107834: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107902: () => { document.exitFullscreen(); },  
 107929: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 108002: () => { if (document.fullscreenElement) return 1; },  
 108048: () => { return document.getElementById('canvas').width; },  
 108100: () => { return screen.width; },  
 108125: () => { document.exitFullscreen(); },  
 108152: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108285: () => { return window.innerWidth; },  
 108311: () => { return window.innerHeight; },  
 108338: () => { if (document.fullscreenElement) return 1; },  
 108384: () => { return document.getElementById('canvas').width; },  
 108436: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 108627: () => { return window.innerWidth; },  
 108653: () => { return window.innerHeight; },  
 108680: () => { if (document.fullscreenElement) return 1; },  
 108726: () => { return document.getElementById('canvas').width; },  
 108778: () => { return screen.width; },  
 108803: () => { document.exitFullscreen(); },  
 108830: () => { if (document.fullscreenElement) return 1; },  
 108876: () => { return document.getElementById('canvas').width; },  
 108928: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108996: () => { document.exitFullscreen(); },  
 109023: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 109081: () => { return screen.width; },  
 109106: () => { return screen.height; },  
 109132: () => { return window.screenX; },  
 109159: () => { return window.screenY; },  
 109186: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 109239: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 109310: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 109367: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 109623: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 109694: () => { if (document.fullscreenElement) return 1; },  
 109740: () => { return window.innerWidth; },  
 109766: () => { return window.innerHeight; },  
 109793: () => { if (document.pointerLockElement) return 1; },  
