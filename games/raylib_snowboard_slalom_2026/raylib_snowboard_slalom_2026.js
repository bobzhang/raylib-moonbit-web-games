...
var ASM_CONSTS = {
 ...
 98210: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98278: () => { document.exitFullscreen(); },  
 98305: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98378: () => { if (document.fullscreenElement) return 1; },  
 98424: () => { return document.getElementById('canvas').width; },  
 98476: () => { return screen.width; },  
 98501: () => { document.exitFullscreen(); },  
 98528: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98661: () => { return window.innerWidth; },  
 98687: () => { return window.innerHeight; },  
 98714: () => { if (document.fullscreenElement) return 1; },  
 98760: () => { return document.getElementById('canvas').width; },  
 98812: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98880: () => { if (document.fullscreenElement) return 1; },  
 98926: () => { return document.getElementById('canvas').width; },  
 98978: () => { return screen.width; },  
 99003: () => { return window.innerWidth; },  
 99029: () => { return window.innerHeight; },  
 99056: () => { if (document.fullscreenElement) return 1; },  
 99102: () => { return document.getElementById('canvas').width; },  
 99154: () => { return screen.width; },  
 99179: () => { document.exitFullscreen(); },  
 99206: () => { if (document.fullscreenElement) return 1; },  
 99252: () => { return document.getElementById('canvas').width; },  
 99304: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99372: () => { document.exitFullscreen(); },  
 99399: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99457: () => { return screen.width; },  
 99482: () => { return screen.height; },  
 99508: () => { return window.screenX; },  
 99535: () => { return window.screenY; },  
 99562: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99615: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99686: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99743: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99999: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100070: () => { if (document.fullscreenElement) return 1; },  
 100116: () => { return window.innerWidth; },  
 100142: () => { return window.innerHeight; },  
 100169: () => { if (document.pointerLockElement) return 1; }
};
