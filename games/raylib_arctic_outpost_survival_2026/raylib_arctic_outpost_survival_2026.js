...
function findWasmBinary() {
  return locateFile('raylib_arctic_outpost_survival_2026.wasm');
}
...
var ASM_CONSTS = {
 ...
 107482: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107550: () => { document.exitFullscreen(); },  
 107577: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107650: () => { if (document.fullscreenElement) return 1; },  
 107696: () => { return document.getElementById('canvas').width; },  
 107748: () => { return screen.width; },  
 107773: () => { document.exitFullscreen(); },  
 107800: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107933: () => { return window.innerWidth; },  
 107959: () => { return window.innerHeight; },  
 107986: () => { if (document.fullscreenElement) return 1; },  
 108032: () => { return document.getElementById('canvas').width; },  
 108084: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 108275: () => { return window.innerWidth; },  
 108301: () => { return window.innerHeight; },  
