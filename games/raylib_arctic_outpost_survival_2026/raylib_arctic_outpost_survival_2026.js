...
var ASM_CONSTS = {
 ...
 107642: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107710: () => { document.exitFullscreen(); },  
 107737: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107810: () => { if (document.fullscreenElement) return 1; },  
 107856: () => { return document.getElementById('canvas').width; },  
 107908: () => { return screen.width; },  
 107933: () => { document.exitFullscreen(); },  
 107960: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108093: () => { return window.innerWidth; },  
 108119: () => { return window.innerHeight; },  
 108146: () => { if (document.fullscreenElement) return 1; },  
 108192: () => { return document.getElementById('canvas').width; },  
 108244: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 108435: () => { return window.innerWidth; },  
 108461: () => { return window.innerHeight; },  
