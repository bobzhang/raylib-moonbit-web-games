...
var ASM_CONSTS = {
 ...
 97842: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97910: () => { document.exitFullscreen(); },  
 97937: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98010: () => { if (document.fullscreenElement) return 1; },  
 98056: () => { return document.getElementById('canvas').width; },  
 98108: () => { return screen.width; },  
 98133: () => { document.exitFullscreen(); },  
 98160: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98293: () => { return window.innerWidth; },  
 98319: () => { return window.innerHeight; },  
 98346: () => { if (document.fullscreenElement) return 1; },  
 98392: () => { return document.getElementById('canvas').width; },  
 98444: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98512: () => { if (document.fullscreenElement) return 1; },  
 98558: () => { return document.getElementById('canvas').width; },  
 98610: () => { return screen.width; },  
 98635: () => { return window.innerWidth; },  
 98661: () => { return window.innerHeight; },  
 98688: () => { if (document.fullscreenElement) return 1; },  
 98734: () => { return document.getElementById('canvas').width; },  
 98786: () => { return screen.width; },  
 98811: () => { document.exitFullscreen(); },  
 98838: () => { if (document.fullscreenElement) return 1; },  
 98884: () => { return document.getElementById('canvas').width; },  
 98936: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99004: () => { document.exitFullscreen(); },  
 99031: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99089: () => { return screen.width; },  
 99114: () => { return screen.height; },  
 99140: () => { return window.screenX; },  
 99167: () => { return window.screenY; },  
 99194: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99247: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99318: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99375: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99631: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99702: () => { if (document.fullscreenElement) return 1; },  
 99748: () => { return window.innerWidth; },  
 99774: () => { return window.innerHeight; },  
 99801: () => { if (document.pointerLockElement) return 1; }
};
