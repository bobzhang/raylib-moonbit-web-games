...
function findWasmBinary() {
  return locateFile('raylib_night_market_chef_duel_2026.wasm');
}
...
var ASM_CONSTS = {
 ...
 98754: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98822: () => { document.exitFullscreen(); },  
 98849: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98922: () => { if (document.fullscreenElement) return 1; },  
 98968: () => { return document.getElementById('canvas').width; },  
 99020: () => { return screen.width; },  
 99045: () => { document.exitFullscreen(); },  
 99072: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99205: () => { return window.innerWidth; },  
 99231: () => { return window.innerHeight; },  
 99258: () => { if (document.fullscreenElement) return 1; },  
 99304: () => { return document.getElementById('canvas').width; },  
 99356: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99424: () => { if (document.fullscreenElement) return 1; },  
 99470: () => { return document.getElementById('canvas').width; },  
 99522: () => { return screen.width; },  
 ...
 99723: () => { document.exitFullscreen(); },  
 99750: () => { if (document.fullscreenElement) return 1; },  
 99796: () => { return document.getElementById('canvas').width; },  
 99848: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99916: () => { document.exitFullscreen(); },  
 99943: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100001: () => { return screen.width; },  
 100026: () => { return screen.height; },  
 100052: () => { return window.screenX; },  
 100079: () => { return window.screenY; },  
 100106: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100159: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100230: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100287: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100543: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100614: () => { if (document.fullscreenElement) return 1; },  
 100660: () => { return window.innerWidth; },  
 100686: () => { return window.innerHeight; },  
 100713: () => { if (document.pointerLockElement) return 1; }
};
