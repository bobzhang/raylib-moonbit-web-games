...
var ASM_CONSTS = {
 ...
 98770: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98838: () => { document.exitFullscreen(); },  
 98865: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98938: () => { if (document.fullscreenElement) return 1; },  
 98984: () => { return document.getElementById('canvas').width; },  
 99036: () => { return screen.width; },  
 99061: () => { document.exitFullscreen(); },  
 99088: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99221: () => { return window.innerWidth; },  
 99247: () => { return window.innerHeight; },  
 99274: () => { if (document.fullscreenElement) return 1; },  
 99320: () => { return document.getElementById('canvas').width; },  
 99372: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99440: () => { if (document.fullscreenElement) return 1; },  
 99486: () => { return document.getElementById('canvas').width; },  
 99538: () => { return screen.width; },  
 99563: () => { return window.innerWidth; },  
 99589: () => { return window.innerHeight; },  
 ...
 99812: () => { return document.getElementById('canvas').width; },  
 99864: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99932: () => { document.exitFullscreen(); },  
 99959: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100017: () => { return screen.width; },  
 100042: () => { return screen.height; },  
 100068: () => { return window.screenX; },  
 100095: () => { return window.screenY; },  
 100122: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100175: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100246: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100303: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100559: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100630: () => { if (document.fullscreenElement) return 1; },  
 100676: () => { return window.innerWidth; },  
 100702: () => { return window.innerHeight; },  
 100729: () => { if (document.pointerLockElement) return 1; }
};
