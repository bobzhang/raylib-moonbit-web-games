...
var ASM_CONSTS = {
 ...
 98642: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98710: () => { document.exitFullscreen(); },  
 98737: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98810: () => { if (document.fullscreenElement) return 1; },  
 98856: () => { return document.getElementById('canvas').width; },  
 98908: () => { return screen.width; },  
 98933: () => { document.exitFullscreen(); },  
 98960: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99093: () => { return window.innerWidth; },  
 99119: () => { return window.innerHeight; },  
 99146: () => { if (document.fullscreenElement) return 1; },  
 99192: () => { return document.getElementById('canvas').width; },  
 99244: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99312: () => { if (document.fullscreenElement) return 1; },  
 99358: () => { return document.getElementById('canvas').width; },  
 99410: () => { return screen.width; },  
 99435: () => { return window.innerWidth; },  
 99461: () => { return window.innerHeight; },  
 99488: () => { if (document.fullscreenElement) return 1; },  
 99534: () => { return document.getElementById('canvas').width; },  
 99586: () => { return screen.width; },  
 99611: () => { document.exitFullscreen(); },  
 99638: () => { if (document.fullscreenElement) return 1; },  
 99684: () => { return document.getElementById('canvas').width; },  
 99736: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99804: () => { document.exitFullscreen(); },  
 99831: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99889: () => { return screen.width; },  
 99914: () => { return screen.height; },  
 99940: () => { return window.screenX; },  
 99967: () => { return window.screenY; },  
 99994: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100047: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100118: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100175: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100431: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100502: () => { if (document.fullscreenElement) return 1; },  
 100548: () => { return window.innerWidth; },  
 100574: () => { return window.innerHeight; },  
 100601: () => { if (document.pointerLockElement) return 1; }
};
