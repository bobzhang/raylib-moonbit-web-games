...
function findWasmBinary() {
  return locateFile('raylib_vampire_survivors_2022_lite.wasm');
}
...
var ASM_CONSTS = {
  2382432: () => { if (document.fullscreenElement) return 1; },  
 2382478: () => { return document.getElementById('canvas').width; },  
 2382530: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2382598: () => { document.exitFullscreen(); },  
 2382625: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 2382698: () => { if (document.fullscreenElement) return 1; },  
 2382744: () => { return document.getElementById('canvas').width; },  
 2382796: () => { return screen.width; },  
 2382821: () => { document.exitFullscreen(); },  
 2382848: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2382981: () => { return window.innerWidth; },  
 2383007: () => { return window.innerHeight; },  
 2383034: () => { if (document.fullscreenElement) return 1; },  
 2383080: () => { return document.getElementById('canvas').width; },  
 2383132: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2383200: () => { if (document.fullscreenElement) return 1; },  
 2383246: () => { return document.getElementById('canvas').width; },  
 2383298: () => { return screen.width; },  
 2383323: () => { return window.innerWidth; },  
 2383349: () => { return window.innerHeight; },  
 2383376: () => { if (document.fullscreenElement) return 1; },  
 2383422: () => { return document.getElementById('canvas').width; },  
 2383474: () => { return screen.width; },  
 2383499: () => { document.exitFullscreen(); },  
 2383526: () => { if (document.fullscreenElement) return 1; },  
 2383572: () => { return document.getElementById('canvas').width; },  
 2383624: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2383692: () => { document.exitFullscreen(); },  
 2383719: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 2383777: () => { return screen.width; },  
 2383802: () => { return screen.height; },  
 2383828: () => { return window.screenX; },  
 2383855: () => { return window.screenY; },  
 2383882: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2383935: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 2384006: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 2384063: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2384319: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 2384390: () => { if (document.fullscreenElement) return 1; },  
 2384436: () => { return window.innerWidth; },  
 2384462: () => { return window.innerHeight; },  
 2384489: () => { if (document.pointerLockElement) return 1; }
};
