...
var ASM_CONSTS = {
  97184: () => { if (document.fullscreenElement) return 1; },  
 97230: () => { return document.getElementById('canvas').width; },  
 97282: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97350: () => { document.exitFullscreen(); },  
 97377: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97450: () => { if (document.fullscreenElement) return 1; },  
 97496: () => { return document.getElementById('canvas').width; },  
 97548: () => { return screen.width; },  
 97573: () => { document.exitFullscreen(); },  
 97600: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97733: () => { return window.innerWidth; },  
 97759: () => { return window.innerHeight; },  
 97786: () => { if (document.fullscreenElement) return 1; },  
 97832: () => { return document.getElementById('canvas').width; },  
 97884: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97952: () => { if (document.fullscreenElement) return 1; },  
 97998: () => { return document.getElementById('canvas').width; },  
 98050: () => { return screen.width; },  
 98075: () => { return window.innerWidth; },  
 98101: () => { return window.innerHeight; },  
 98128: () => { if (document.fullscreenElement) return 1; },  
 98174: () => { return document.getElementById('canvas').width; },  
 98226: () => { return screen.width; },  
 98251: () => { document.exitFullscreen(); },  
 98278: () => { if (document.fullscreenElement) return 1; },  
 98324: () => { return document.getElementById('canvas').width; },  
 98376: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98444: () => { document.exitFullscreen(); },  
 98471: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98529: () => { return screen.width; },  
 98554: () => { return screen.height; },  
 98580: () => { return window.screenX; },  
 98607: () => { return window.screenY; },  
 98634: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98687: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98758: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98815: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99071: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99142: () => { if (document.fullscreenElement) return 1; },  
 99188: () => { return window.innerWidth; },  
 99214: () => { return window.innerHeight; },  
 99241: () => { if (document.pointerLockElement) return 1; }
};
