...
function findWasmBinary() {
  return locateFile('raylib_tower_defense_frontier_2026.wasm');
}
...
var ASM_CONSTS = {
  97360: () => { if (document.fullscreenElement) return 1; },  
 97406: () => { return document.getElementById('canvas').width; },  
 97458: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97526: () => { document.exitFullscreen(); },  
 97553: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97626: () => { if (document.fullscreenElement) return 1; },  
 97672: () => { return document.getElementById('canvas').width; },  
 97724: () => { return screen.width; },  
 97749: () => { document.exitFullscreen(); },  
 97776: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97909: () => { return window.innerWidth; },  
 97935: () => { return window.innerHeight; },  
 97962: () => { if (document.fullscreenElement) return 1; },  
 98008: () => { return document.getElementById('canvas').width; },  
 98060: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98128: () => { if (document.fullscreenElement) return 1; },  
 98174: () => { return document.getElementById('canvas').width; },  
 98226: () => { return screen.width; },  
 98251: () => { return window.innerWidth; },  
 98277: () => { return window.innerHeight; },  
 98304: () => { if (document.fullscreenElement) return 1; },  
 98350: () => { return document.getElementById('canvas').width; },  
 98402: () => { return screen.width; },  
 98427: () => { document.exitFullscreen(); },  
 98454: () => { if (document.fullscreenElement) return 1; },  
 98500: () => { return document.getElementById('canvas').width; },  
 98552: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98620: () => { document.exitFullscreen(); },  
 98647: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98705: () => { return screen.width; },  
 98730: () => { return screen.height; },  
 98756: () => { return window.screenX; },  
 98783: () => { return window.screenY; },  
 98810: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98863: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98934: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98991: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99247: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99318: () => { if (document.fullscreenElement) return 1; },  
 99364: () => { return window.innerWidth; },  
 99390: () => { return window.innerHeight; },  
 99417: () => { if (document.pointerLockElement) return 1; }
};
