...
function findWasmBinary() {
  return locateFile('raylib_temple_relic_run_2026.wasm');
}
...
var ASM_CONSTS = {
  98496: () => { if (document.fullscreenElement) return 1; },  
 98542: () => { return document.getElementById('canvas').width; },  
 98594: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98662: () => { document.exitFullscreen(); },  
 98689: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98762: () => { if (document.fullscreenElement) return 1; },  
 98808: () => { return document.getElementById('canvas').width; },  
 98860: () => { return screen.width; },  
 98885: () => { document.exitFullscreen(); },  
 98912: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99045: () => { return window.innerWidth; },  
 99071: () => { return window.innerHeight; },  
 99098: () => { if (document.fullscreenElement) return 1; },  
 99144: () => { return document.getElementById('canvas').width; },  
 99196: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99264: () => { if (document.fullscreenElement) return 1; },  
 99310: () => { return document.getElementById('canvas').width; },  
 99362: () => { return screen.width; },  
 99387: () => { return window.innerWidth; },  
 99413: () => { return window.innerHeight; },  
 99440: () => { if (document.fullscreenElement) return 1; },  
 99486: () => { return document.getElementById('canvas').width; },  
 99538: () => { return screen.width; },  
 99563: () => { document.exitFullscreen(); },  
 99590: () => { if (document.fullscreenElement) return 1; },  
 99636: () => { return document.getElementById('canvas').width; },  
 99688: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99756: () => { document.exitFullscreen(); },  
 99783: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99841: () => { return screen.width; },  
 99866: () => { return screen.height; },  
 99892: () => { return window.screenX; },  
 99919: () => { return window.screenY; },  
 99946: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99999: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100070: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100127: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100383: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100454: () => { if (document.fullscreenElement) return 1; },  
 100500: () => { return window.innerWidth; },  
 100526: () => { return window.innerHeight; },  
 100553: () => { if (document.pointerLockElement) return 1; }
};
