...
var ASM_CONSTS = {
  98320: () => { if (document.fullscreenElement) return 1; },  
 98366: () => { return document.getElementById('canvas').width; },  
 98418: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98486: () => { document.exitFullscreen(); },  
 98513: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98586: () => { if (document.fullscreenElement) return 1; },  
 98632: () => { return document.getElementById('canvas').width; },  
 98684: () => { return screen.width; },  
 98709: () => { document.exitFullscreen(); },  
 98736: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98869: () => { return window.innerWidth; },  
 98895: () => { return window.innerHeight; },  
 98922: () => { if (document.fullscreenElement) return 1; },  
 98968: () => { return document.getElementById('canvas').width; },  
 99020: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99088: () => { if (document.fullscreenElement) return 1; },  
 99134: () => { return document.getElementById('canvas').width; },  
 99186: () => { return screen.width; },  
 99211: () => { return window.innerWidth; },  
 99237: () => { return window.innerHeight; },  
 99264: () => { if (document.fullscreenElement) return 1; },  
 99310: () => { return document.getElementById('canvas').width; },  
 99362: () => { return screen.width; },  
 99387: () => { document.exitFullscreen(); },  
 99414: () => { if (document.fullscreenElement) return 1; },  
 99460: () => { return document.getElementById('canvas').width; },  
 99512: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99580: () => { document.exitFullscreen(); },  
 99607: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99665: () => { return screen.width; },  
 99690: () => { return screen.height; },  
 99716: () => { return window.screenX; },  
 99743: () => { return window.screenY; },  
 99770: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99823: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99894: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99951: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100207: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100278: () => { if (document.fullscreenElement) return 1; },  
 100324: () => { return window.innerWidth; },  
 100350: () => { return window.innerHeight; },  
 100377: () => { if (document.pointerLockElement) return 1; }
};
