...
var ASM_CONSTS = {
  106424: () => { if (document.fullscreenElement) return 1; },  
 106470: () => { return document.getElementById('canvas').width; },  
 106522: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106590: () => { document.exitFullscreen(); },  
 106617: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106690: () => { if (document.fullscreenElement) return 1; },  
 106736: () => { return document.getElementById('canvas').width; },  
 106788: () => { return screen.width; },  
 106813: () => { document.exitFullscreen(); },  
 106840: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 106973: () => { return window.innerWidth; },  
 106999: () => { return window.innerHeight; },  
 107026: () => { if (document.fullscreenElement) return 1; },  
 107072: () => { return document.getElementById('canvas').width; },  
 107124: () => { return parseInt(document.getElementById('canvas').style.width); },  
