...
function findWasmBinary() {
  return locateFile('raylib_stardew_valley_2016_lite.wasm');
}
...
var ASM_CONSTS = {
  2382384: () => { if (document.fullscreenElement) return 1; },  
 2382430: () => { return document.getElementById('canvas').width; },  
 2382482: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2382550: () => { document.exitFullscreen(); },  
 2382577: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 2382650: () => { if (document.fullscreenElement) return 1; },  
 2382696: () => { return document.getElementById('canvas').width; },  
 2382748: () => { return screen.width; },  
 2382773: () => { document.exitFullscreen(); },  
 2382800: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2382933: () => { return window.innerWidth; },  
 2382959: () => { return window.innerHeight; },  
 2382986: () => { if (document.fullscreenElement) return 1; },  
 2383032: () => { return document.getElementById('canvas').width; },  
 2383084: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2383152: () => { if (document.fullscreenElement) return 1; },  
 2383198: () => { return document.getElementById('canvas').width; },  
 2383250: () => { return screen.width; },  
 2383275: () => { return window.innerWidth; },  
 2383301: () => { return window.innerHeight; },  
 2383328: () => { if (document.fullscreenElement) return 1; },  
 2383374: () => { return document.getElementById('canvas').width; },  
 2383426: () => { return screen.width; },  
 2383451: () => { document.exitFullscreen(); },  
 2383478: () => { if (document.fullscreenElement) return 1; },  
 2383524: () => { return document.getElementById('canvas').width; },  
 2383576: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2383644: () => { document.exitFullscreen(); },  
 2383671: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 2383729: () => { return screen.width; },  
 2383754: () => { return screen.height; },  
 2383780: () => { return window.screenX; },  
 2383807: () => { return window.screenY; },  
 2383834: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2383887: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 2383958: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 2384015: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2384271: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 2384342: () => { if (document.fullscreenElement) return 1; },  
 2384388: () => { return window.innerWidth; },  
 2384414: () => { return window.innerHeight; },  
 2384441: () => { if (document.pointerLockElement) return 1; }
};
