...
var ASM_CONSTS = {
  97776: () => { if (document.fullscreenElement) return 1; },  
 97822: () => { return document.getElementById('canvas').width; },  
 97874: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97942: () => { document.exitFullscreen(); },  
 97969: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98042: () => { if (document.fullscreenElement) return 1; },  
 98088: () => { return document.getElementById('canvas').width; },  
 98140: () => { return screen.width; },  
 98165: () => { document.exitFullscreen(); },  
 98192: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98325: () => { return window.innerWidth; },  
 98351: () => { return window.innerHeight; },  
 98378: () => { if (document.fullscreenElement) return 1; },  
 98424: () => { return document.getElementById('canvas').width; },  
 98476: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98544: () => { if (document.fullscreenElement) return 1; },  
 98590: () => { return document.getElementById('canvas').width; },  
 98642: () => { return screen.width; },  
 98667: () => { return window.innerWidth; },  
 98693: () => { return window.innerHeight; },  
 98720: () => { if (document.fullscreenElement) return 1; },  
 98766: () => { return document.getElementById('canvas').width; },  
 98818: () => { return screen.width; },  
 98843: () => { document.exitFullscreen(); },  
 98870: () => { if (document.fullscreenElement) return 1; },  
 98916: () => { return document.getElementById('canvas').width; },  
 98968: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99036: () => { document.exitFullscreen(); },  
 99063: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99121: () => { return screen.width; },  
 99146: () => { return screen.height; },  
 99172: () => { return window.screenX; },  
 99199: () => { return window.screenY; },  
 99226: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99279: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99350: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99407: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99663: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99734: () => { if (document.fullscreenElement) return 1; },  
 99780: () => { return window.innerWidth; },  
 99806: () => { return window.innerHeight; },  
 99833: () => { if (document.pointerLockElement) return 1; }
};
