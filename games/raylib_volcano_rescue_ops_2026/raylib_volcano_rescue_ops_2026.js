...
var ASM_CONSTS = {
 ...
 101802: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101855: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101926: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101983: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102239: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102310: () => { if (document.fullscreenElement) return 1; },  
 102356: () => { return window.innerWidth; },  
 102382: () => { return window.innerHeight; },  
 102409: () => { if (document.pointerLockElement) return 1; }
};
