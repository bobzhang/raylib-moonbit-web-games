...
function findWasmBinary() {
  return locateFile('raylib_volcano_rescue_ops_2026.wasm');
}
...
var ASM_CONSTS = {
  100512: () => { if (document.fullscreenElement) return 1; },  
 100558: () => { return document.getElementById('canvas').width; },  
 100610: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100678: () => { document.exitFullscreen(); },  
 100705: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100778: () => { if (document.fullscreenElement) return 1; },  
 100824: () => { return document.getElementById('canvas').width; },  
 100876: () => { return screen.width; },  
 100901: () => { document.exitFullscreen(); },  
 100928: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101061: () => { return window.innerWidth; },  
 101087: () => { return window.innerHeight; },  
 101114: () => { if (document.fullscreenElement) return 1; },  
 101160: () => { return document.getElementById('canvas').width; },  
 101212: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 101403: () => { return window.innerWidth; },  
 101429: () => { return window.innerHeight; },  
 101456: () => { if (document.fullscreenElement) return 1; },  
 101502: () => { return document.getElementById('canvas').width; },  
 101554: () => { return screen.width; },  
 101579: () => { document.exitFullscreen(); },  
 101606: () => { if (document.fullscreenElement) return 1; },  
 101652: () => { return document.getElementById('canvas').width; },  
 101704: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101772: () => { document.exitFullscreen(); },  
 101799: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101857: () => { return screen.width; },  
 101882: () => { return screen.height; },  
 101908: () => { return window.screenX; },  
 101935: () => { return window.screenY; },  
 101962: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102015: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102086: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102143: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102399: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102470: () => { if (document.fullscreenElement) return 1; },  
 102516: () => { return window.innerWidth; },  
 102542: () => { return window.innerHeight; },  
 102569: () => { if (document.pointerLockElement) return 1; }
};
