...
var ASM_CONSTS = {
 ...
 100626: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100694: () => { document.exitFullscreen(); },  
 100721: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100794: () => { if (document.fullscreenElement) return 1; },  
 100840: () => { return document.getElementById('canvas').width; },  
 100892: () => { return screen.width; },  
 100917: () => { document.exitFullscreen(); },  
 100944: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101077: () => { return window.innerWidth; },  
 101103: () => { return window.innerHeight; },  
 101130: () => { if (document.fullscreenElement) return 1; },  
 101176: () => { return document.getElementById('canvas').width; },  
 101228: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 101419: () => { return window.innerWidth; },  
 101445: () => { return window.innerHeight; },  
 101472: () => { if (document.fullscreenElement) return 1; },  
 101518: () => { return document.getElementById('canvas').width; },  
 101570: () => { return screen.width; },  
 101595: () => { document.exitFullscreen(); },  
 101622: () => { if (document.fullscreenElement) return 1; },  
 101668: () => { return document.getElementById('canvas').width; },  
 101720: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101788: () => { document.exitFullscreen(); },  
 101815: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101873: () => { return screen.width; },  
 101898: () => { return screen.height; },  
 101924: () => { return window.screenX; },  
 101951: () => { return window.screenY; },  
 101978: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102031: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102102: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102159: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102415: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102486: () => { if (document.fullscreenElement) return 1; },  
 102532: () => { return window.innerWidth; },  
 102558: () => { return window.innerHeight; },  
 102585: () => { if (document.pointerLockElement) return 1; }
};
