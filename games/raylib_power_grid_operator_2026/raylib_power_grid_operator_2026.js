...
var ASM_CONSTS = {
  97872: () => { if (document.fullscreenElement) return 1; },  
 97918: () => { return document.getElementById('canvas').width; },  
 97970: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98038: () => { document.exitFullscreen(); },  
 98065: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98138: () => { if (document.fullscreenElement) return 1; },  
 98184: () => { return document.getElementById('canvas').width; },  
 98236: () => { return screen.width; },  
 98261: () => { document.exitFullscreen(); },  
 98288: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98421: () => { return window.innerWidth; },  
 98447: () => { return window.innerHeight; },  
 98474: () => { if (document.fullscreenElement) return 1; },  
 98520: () => { return document.getElementById('canvas').width; },  
 98572: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98640: () => { if (document.fullscreenElement) return 1; },  
 98686: () => { return document.getElementById('canvas').width; },  
 98738: () => { return screen.width; },  
 98763: () => { return window.innerWidth; },  
 98789: () => { return window.innerHeight; },  
 98816: () => { if (document.fullscreenElement) return 1; },  
 98862: () => { return document.getElementById('canvas').width; },  
 98914: () => { return screen.width; },  
 98939: () => { document.exitFullscreen(); },  
 98966: () => { if (document.fullscreenElement) return 1; },  
 99012: () => { return document.getElementById('canvas').width; },  
 99064: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99132: () => { document.exitFullscreen(); },  
 99159: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99217: () => { return screen.width; },  
 99242: () => { return screen.height; },  
 99268: () => { return window.screenX; },  
 99295: () => { return window.screenY; },  
 99322: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99375: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99446: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99503: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99759: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99830: () => { if (document.fullscreenElement) return 1; },  
 99876: () => { return window.innerWidth; },  
 99902: () => { return window.innerHeight; },  
 99929: () => { if (document.pointerLockElement) return 1; }
};
