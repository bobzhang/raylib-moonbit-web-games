...
function findWasmBinary() {
  return locateFile('raylib_power_grid_operator_2026.wasm');
}
...
var ASM_CONSTS = {
  97712: () => { if (document.fullscreenElement) return 1; },  
 97758: () => { return document.getElementById('canvas').width; },  
 97810: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97878: () => { document.exitFullscreen(); },  
 97905: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97978: () => { if (document.fullscreenElement) return 1; },  
 98024: () => { return document.getElementById('canvas').width; },  
 98076: () => { return screen.width; },  
 98101: () => { document.exitFullscreen(); },  
 98128: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98261: () => { return window.innerWidth; },  
 98287: () => { return window.innerHeight; },  
 98314: () => { if (document.fullscreenElement) return 1; },  
 98360: () => { return document.getElementById('canvas').width; },  
 98412: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98480: () => { if (document.fullscreenElement) return 1; },  
 98526: () => { return document.getElementById('canvas').width; },  
 98578: () => { return screen.width; },  
 98603: () => { return window.innerWidth; },  
 98629: () => { return window.innerHeight; },  
 98656: () => { if (document.fullscreenElement) return 1; },  
 98702: () => { return document.getElementById('canvas').width; },  
 98754: () => { return screen.width; },  
 98779: () => { document.exitFullscreen(); },  
 98806: () => { if (document.fullscreenElement) return 1; },  
 98852: () => { return document.getElementById('canvas').width; },  
 98904: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98972: () => { document.exitFullscreen(); },  
 98999: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99057: () => { return screen.width; },  
 99082: () => { return screen.height; },  
 99108: () => { return window.screenX; },  
 99135: () => { return window.screenY; },  
 99162: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99215: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99286: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99343: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99599: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99670: () => { if (document.fullscreenElement) return 1; },  
 99716: () => { return window.innerWidth; },  
 99742: () => { return window.innerHeight; },  
 99769: () => { if (document.pointerLockElement) return 1; }
};
