...
var ASM_CONSTS = {
 ...
 98706: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98774: () => { document.exitFullscreen(); },  
 98801: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98874: () => { if (document.fullscreenElement) return 1; },  
 98920: () => { return document.getElementById('canvas').width; },  
 98972: () => { return screen.width; },  
 98997: () => { document.exitFullscreen(); },  
 99024: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99157: () => { return window.innerWidth; },  
 99183: () => { return window.innerHeight; },  
 ...
 99499: () => { return window.innerWidth; },  
 99525: () => { return window.innerHeight; },  
 99552: () => { if (document.fullscreenElement) return 1; },  
 99598: () => { return document.getElementById('canvas').width; },  
 99650: () => { return screen.width; },  
 99675: () => { document.exitFullscreen(); },  
 99702: () => { if (document.fullscreenElement) return 1; },  
 99748: () => { return document.getElementById('canvas').width; },  
 99800: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99868: () => { document.exitFullscreen(); },  
 99895: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99953: () => { return screen.width; },  
 99978: () => { return screen.height; },  
 100004: () => { return window.screenX; },  
 100031: () => { return window.screenY; },  
 100058: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100111: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100182: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 ...
 100612: () => { return window.innerWidth; },  
 100638: () => { return window.innerHeight; },  
 100665: () => { if (document.pointerLockElement) return 1; }
};
