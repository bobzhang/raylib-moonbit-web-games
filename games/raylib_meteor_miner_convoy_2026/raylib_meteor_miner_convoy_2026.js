...
function findWasmBinary() {
  return locateFile('raylib_meteor_miner_convoy_2026.wasm');
}
...
var ASM_CONSTS = {
  98784: () => { if (document.fullscreenElement) return 1; },  
 98830: () => { return document.getElementById('canvas').width; },  
 98882: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98950: () => { document.exitFullscreen(); },  
 98977: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99050: () => { if (document.fullscreenElement) return 1; },  
 99096: () => { return document.getElementById('canvas').width; },  
 99148: () => { return screen.width; },  
 99173: () => { document.exitFullscreen(); },  
 99200: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99333: () => { return window.innerWidth; },  
 99359: () => { return window.innerHeight; },  
 99386: () => { if (document.fullscreenElement) return 1; },  
 99432: () => { return document.getElementById('canvas').width; },  
 99484: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99552: () => { if (document.fullscreenElement) return 1; },  
 99598: () => { return document.getElementById('canvas').width; },  
 99650: () => { return screen.width; },  
 99675: () => { return window.innerWidth; },  
 99701: () => { return window.innerHeight; },  
 99728: () => { if (document.fullscreenElement) return 1; },  
 99774: () => { return document.getElementById('canvas').width; },  
 99826: () => { return screen.width; },  
 99851: () => { document.exitFullscreen(); },  
 99878: () => { if (document.fullscreenElement) return 1; },  
 99924: () => { return document.getElementById('canvas').width; },  
 99976: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100044: () => { document.exitFullscreen(); },  
 100071: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100129: () => { return screen.width; },  
 100154: () => { return screen.height; },  
 100180: () => { return window.screenX; },  
 100207: () => { return window.screenY; },  
 100234: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100287: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100358: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100415: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100671: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100742: () => { if (document.fullscreenElement) return 1; },  
 100788: () => { return window.innerWidth; },  
 100814: () => { return window.innerHeight; },  
 100841: () => { if (document.pointerLockElement) return 1; }
};
