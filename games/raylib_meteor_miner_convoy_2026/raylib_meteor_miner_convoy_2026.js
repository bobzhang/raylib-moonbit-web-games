...
var ASM_CONSTS = {
 ...
 98850: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98918: () => { document.exitFullscreen(); },  
 98945: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 ...
 99452: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99520: () => { if (document.fullscreenElement) return 1; },  
 99566: () => { return document.getElementById('canvas').width; },  
 99618: () => { return screen.width; },  
 99643: () => { return window.innerWidth; },  
 99669: () => { return window.innerHeight; },  
 99696: () => { if (document.fullscreenElement) return 1; },  
 99742: () => { return document.getElementById('canvas').width; },  
 99794: () => { return screen.width; },  
 99819: () => { document.exitFullscreen(); },  
 99846: () => { if (document.fullscreenElement) return 1; },  
 99892: () => { return document.getElementById('canvas').width; },  
 99944: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100012: () => { document.exitFullscreen(); },  
 100039: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100097: () => { return screen.width; },  
 100122: () => { return screen.height; },  
 100148: () => { return window.screenX; },  
 100175: () => { return window.screenY; },  
 100202: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100255: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100326: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100383: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100639: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100710: () => { if (document.fullscreenElement) return 1; },  
 100756: () => { return window.innerWidth; },  
 100782: () => { return window.innerHeight; },  
 100809: () => { if (document.pointerLockElement) return 1; }
};
