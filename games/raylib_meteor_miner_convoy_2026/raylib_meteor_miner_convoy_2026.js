...
var ASM_CONSTS = {
  98736: () => { if (document.fullscreenElement) return 1; },  
 98782: () => { return document.getElementById('canvas').width; },  
 98834: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98902: () => { document.exitFullscreen(); },  
 98929: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99002: () => { if (document.fullscreenElement) return 1; },  
 99048: () => { return document.getElementById('canvas').width; },  
 99100: () => { return screen.width; },  
 99125: () => { document.exitFullscreen(); },  
 99152: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99285: () => { return window.innerWidth; },  
 99311: () => { return window.innerHeight; },  
 99338: () => { if (document.fullscreenElement) return 1; },  
 99384: () => { return document.getElementById('canvas').width; },  
 99436: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99504: () => { if (document.fullscreenElement) return 1; },  
 99550: () => { return document.getElementById('canvas').width; },  
 99602: () => { return screen.width; },  
 99627: () => { return window.innerWidth; },  
 99653: () => { return window.innerHeight; },  
 99680: () => { if (document.fullscreenElement) return 1; },  
 99726: () => { return document.getElementById('canvas').width; },  
 99778: () => { return screen.width; },  
 99803: () => { document.exitFullscreen(); },  
 99830: () => { if (document.fullscreenElement) return 1; },  
 99876: () => { return document.getElementById('canvas').width; },  
 99928: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99996: () => { document.exitFullscreen(); },  
 100023: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100081: () => { return screen.width; },  
 100106: () => { return screen.height; },  
 100132: () => { return window.screenX; },  
 100159: () => { return window.screenY; },  
 100186: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100239: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100310: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100367: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100623: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100694: () => { if (document.fullscreenElement) return 1; },  
 100740: () => { return window.innerWidth; },  
 100766: () => { return window.innerHeight; },  
 100793: () => { if (document.pointerLockElement) return 1; }
};
