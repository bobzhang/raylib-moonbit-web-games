...
var ASM_CONSTS = {
 ...
 98002: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98070: () => { document.exitFullscreen(); },  
 98097: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98170: () => { if (document.fullscreenElement) return 1; },  
 98216: () => { return document.getElementById('canvas').width; },  
 98268: () => { return screen.width; },  
 98293: () => { document.exitFullscreen(); },  
 98320: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98453: () => { return window.innerWidth; },  
 98479: () => { return window.innerHeight; },  
 98506: () => { if (document.fullscreenElement) return 1; },  
 98552: () => { return document.getElementById('canvas').width; },  
 98604: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98672: () => { if (document.fullscreenElement) return 1; },  
 98718: () => { return document.getElementById('canvas').width; },  
 98770: () => { return screen.width; },  
 98795: () => { return window.innerWidth; },  
 98821: () => { return window.innerHeight; },  
 98848: () => { if (document.fullscreenElement) return 1; },  
 98894: () => { return document.getElementById('canvas').width; },  
 98946: () => { return screen.width; },  
 98971: () => { document.exitFullscreen(); },  
 98998: () => { if (document.fullscreenElement) return 1; },  
 99044: () => { return document.getElementById('canvas').width; },  
 99096: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99164: () => { document.exitFullscreen(); },  
 99191: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99249: () => { return screen.width; },  
 99274: () => { return screen.height; },  
 99300: () => { return window.screenX; },  
 99327: () => { return window.screenY; },  
 99354: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99407: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99478: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99535: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99791: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99862: () => { if (document.fullscreenElement) return 1; },  
 99908: () => { return window.innerWidth; },  
 99934: () => { return window.innerHeight; },  
 99961: () => { if (document.pointerLockElement) return 1; }
};
