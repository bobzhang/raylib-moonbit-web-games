...
function findWasmBinary() {
  return locateFile('raylib_hospital_triage_2026.wasm');
}
...
var ASM_CONSTS = {
  98080: () => { if (document.fullscreenElement) return 1; },  
 98126: () => { return document.getElementById('canvas').width; },  
 98178: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98246: () => { document.exitFullscreen(); },  
 98273: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98346: () => { if (document.fullscreenElement) return 1; },  
 98392: () => { return document.getElementById('canvas').width; },  
 98444: () => { return screen.width; },  
 98469: () => { document.exitFullscreen(); },  
 98496: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98629: () => { return window.innerWidth; },  
 98655: () => { return window.innerHeight; },  
 98682: () => { if (document.fullscreenElement) return 1; },  
 98728: () => { return document.getElementById('canvas').width; },  
 98780: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98848: () => { if (document.fullscreenElement) return 1; },  
 98894: () => { return document.getElementById('canvas').width; },  
 98946: () => { return screen.width; },  
 98971: () => { return window.innerWidth; },  
 98997: () => { return window.innerHeight; },  
 99024: () => { if (document.fullscreenElement) return 1; },  
 99070: () => { return document.getElementById('canvas').width; },  
 99122: () => { return screen.width; },  
 99147: () => { document.exitFullscreen(); },  
 99174: () => { if (document.fullscreenElement) return 1; },  
 99220: () => { return document.getElementById('canvas').width; },  
 99272: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99340: () => { document.exitFullscreen(); },  
 99367: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99425: () => { return screen.width; },  
 99450: () => { return screen.height; },  
 99476: () => { return window.screenX; },  
 99503: () => { return window.screenY; },  
 99530: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99583: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99654: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99711: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99967: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100038: () => { if (document.fullscreenElement) return 1; },  
 100084: () => { return window.innerWidth; },  
 100110: () => { return window.innerHeight; },  
 100137: () => { if (document.pointerLockElement) return 1; }
};
