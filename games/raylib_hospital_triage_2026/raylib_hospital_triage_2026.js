...
var ASM_CONSTS = {
  98064: () => { if (document.fullscreenElement) return 1; },  
 98110: () => { return document.getElementById('canvas').width; },  
 98162: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98230: () => { document.exitFullscreen(); },  
 98257: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98330: () => { if (document.fullscreenElement) return 1; },  
 98376: () => { return document.getElementById('canvas').width; },  
 98428: () => { return screen.width; },  
 98453: () => { document.exitFullscreen(); },  
 98480: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98613: () => { return window.innerWidth; },  
 98639: () => { return window.innerHeight; },  
 98666: () => { if (document.fullscreenElement) return 1; },  
 98712: () => { return document.getElementById('canvas').width; },  
 98764: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98832: () => { if (document.fullscreenElement) return 1; },  
 98878: () => { return document.getElementById('canvas').width; },  
 98930: () => { return screen.width; },  
 98955: () => { return window.innerWidth; },  
 98981: () => { return window.innerHeight; },  
 99008: () => { if (document.fullscreenElement) return 1; },  
 99054: () => { return document.getElementById('canvas').width; },  
 99106: () => { return screen.width; },  
 99131: () => { document.exitFullscreen(); },  
 99158: () => { if (document.fullscreenElement) return 1; },  
 99204: () => { return document.getElementById('canvas').width; },  
 99256: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99324: () => { document.exitFullscreen(); },  
 99351: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99409: () => { return screen.width; },  
 99434: () => { return screen.height; },  
 99460: () => { return window.screenX; },  
 99487: () => { return window.screenY; },  
 99514: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99567: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99638: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99695: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99951: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100022: () => { if (document.fullscreenElement) return 1; },  
 100068: () => { return window.innerWidth; },  
 100094: () => { return window.innerHeight; },  
 100121: () => { if (document.pointerLockElement) return 1; }
};
