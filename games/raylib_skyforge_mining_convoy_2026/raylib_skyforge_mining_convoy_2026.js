...
var ASM_CONSTS = {
  98016: () => { if (document.fullscreenElement) return 1; },  
 98062: () => { return document.getElementById('canvas').width; },  
 98114: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98182: () => { document.exitFullscreen(); },  
 98209: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98282: () => { if (document.fullscreenElement) return 1; },  
 98328: () => { return document.getElementById('canvas').width; },  
 98380: () => { return screen.width; },  
 98405: () => { document.exitFullscreen(); },  
 98432: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98565: () => { return window.innerWidth; },  
 98591: () => { return window.innerHeight; },  
 98618: () => { if (document.fullscreenElement) return 1; },  
 98664: () => { return document.getElementById('canvas').width; },  
 98716: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98784: () => { if (document.fullscreenElement) return 1; },  
 98830: () => { return document.getElementById('canvas').width; },  
 98882: () => { return screen.width; },  
 98907: () => { return window.innerWidth; },  
 98933: () => { return window.innerHeight; },  
 98960: () => { if (document.fullscreenElement) return 1; },  
 99006: () => { return document.getElementById('canvas').width; },  
 99058: () => { return screen.width; },  
 99083: () => { document.exitFullscreen(); },  
 99110: () => { if (document.fullscreenElement) return 1; },  
 99156: () => { return document.getElementById('canvas').width; },  
 99208: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99276: () => { document.exitFullscreen(); },  
 99303: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99361: () => { return screen.width; },  
 99386: () => { return screen.height; },  
 99412: () => { return window.screenX; },  
 99439: () => { return window.screenY; },  
 99466: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99519: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99590: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99647: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99903: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99974: () => { if (document.fullscreenElement) return 1; },  
 100020: () => { return window.innerWidth; },  
 100046: () => { return window.innerHeight; },  
 100073: () => { if (document.pointerLockElement) return 1; }
};
