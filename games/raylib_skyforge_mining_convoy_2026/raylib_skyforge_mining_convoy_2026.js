...
var ASM_CONSTS = {
 ...
 98290: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98358: () => { document.exitFullscreen(); },  
 98385: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98458: () => { if (document.fullscreenElement) return 1; },  
 98504: () => { return document.getElementById('canvas').width; },  
 98556: () => { return screen.width; },  
 98581: () => { document.exitFullscreen(); },  
 98608: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98741: () => { return window.innerWidth; },  
 98767: () => { return window.innerHeight; },  
 98794: () => { if (document.fullscreenElement) return 1; },  
 98840: () => { return document.getElementById('canvas').width; },  
 98892: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98960: () => { if (document.fullscreenElement) return 1; },  
 99006: () => { return document.getElementById('canvas').width; },  
 99058: () => { return screen.width; },  
 99083: () => { return window.innerWidth; },  
 99109: () => { return window.innerHeight; },  
 99136: () => { if (document.fullscreenElement) return 1; },  
 99182: () => { return document.getElementById('canvas').width; },  
 99234: () => { return screen.width; },  
 99259: () => { document.exitFullscreen(); },  
 99286: () => { if (document.fullscreenElement) return 1; },  
 99332: () => { return document.getElementById('canvas').width; },  
 99384: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99452: () => { document.exitFullscreen(); },  
 99479: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99537: () => { return screen.width; },  
 99562: () => { return screen.height; },  
 99588: () => { return window.screenX; },  
 99615: () => { return window.screenY; },  
 99642: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99695: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99766: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99823: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100079: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100150: () => { if (document.fullscreenElement) return 1; },  
 100196: () => { return window.innerWidth; },  
 100222: () => { return window.innerHeight; },  
 100249: () => { if (document.pointerLockElement) return 1; }
};
