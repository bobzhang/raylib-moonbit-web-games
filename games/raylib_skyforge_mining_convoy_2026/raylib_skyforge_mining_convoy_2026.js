...
function findWasmBinary() {
  return locateFile('raylib_skyforge_mining_convoy_2026.wasm');
}
...
var ASM_CONSTS = {
  98176: () => { if (document.fullscreenElement) return 1; },  
 98222: () => { return document.getElementById('canvas').width; },  
 98274: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98342: () => { document.exitFullscreen(); },  
 98369: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98442: () => { if (document.fullscreenElement) return 1; },  
 98488: () => { return document.getElementById('canvas').width; },  
 98540: () => { return screen.width; },  
 98565: () => { document.exitFullscreen(); },  
 98592: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98725: () => { return window.innerWidth; },  
 98751: () => { return window.innerHeight; },  
 98778: () => { if (document.fullscreenElement) return 1; },  
 98824: () => { return document.getElementById('canvas').width; },  
 98876: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98944: () => { if (document.fullscreenElement) return 1; },  
 98990: () => { return document.getElementById('canvas').width; },  
 99042: () => { return screen.width; },  
 99067: () => { return window.innerWidth; },  
 99093: () => { return window.innerHeight; },  
 99120: () => { if (document.fullscreenElement) return 1; },  
 99166: () => { return document.getElementById('canvas').width; },  
 99218: () => { return screen.width; },  
 99243: () => { document.exitFullscreen(); },  
 99270: () => { if (document.fullscreenElement) return 1; },  
 99316: () => { return document.getElementById('canvas').width; },  
 99368: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99436: () => { document.exitFullscreen(); },  
 99463: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99521: () => { return screen.width; },  
 99546: () => { return screen.height; },  
 99572: () => { return window.screenX; },  
 99599: () => { return window.screenY; },  
 99626: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99679: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99750: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99807: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100063: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100134: () => { if (document.fullscreenElement) return 1; },  
 100180: () => { return window.innerWidth; },  
 100206: () => { return window.innerHeight; },  
 100233: () => { if (document.pointerLockElement) return 1; }
};
