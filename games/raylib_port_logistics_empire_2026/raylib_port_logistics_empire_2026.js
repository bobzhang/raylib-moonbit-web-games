...
function findWasmBinary() {
  return locateFile('raylib_port_logistics_empire_2026.wasm');
}
...
var ASM_CONSTS = {
  100432: () => { if (document.fullscreenElement) return 1; },  
 100478: () => { return document.getElementById('canvas').width; },  
 100530: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100598: () => { document.exitFullscreen(); },  
 100625: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100698: () => { if (document.fullscreenElement) return 1; },  
 100744: () => { return document.getElementById('canvas').width; },  
 100796: () => { return screen.width; },  
 100821: () => { document.exitFullscreen(); },  
 100848: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100981: () => { return window.innerWidth; },  
 101007: () => { return window.innerHeight; },  
 101034: () => { if (document.fullscreenElement) return 1; },  
 101080: () => { return document.getElementById('canvas').width; },  
 101132: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101200: () => { if (document.fullscreenElement) return 1; },  
 101246: () => { return document.getElementById('canvas').width; },  
 101298: () => { return screen.width; },  
 101323: () => { return window.innerWidth; },  
 101349: () => { return window.innerHeight; },  
 101376: () => { if (document.fullscreenElement) return 1; },  
 101422: () => { return document.getElementById('canvas').width; },  
 101474: () => { return screen.width; },  
 101499: () => { document.exitFullscreen(); },  
 101526: () => { if (document.fullscreenElement) return 1; },  
 101572: () => { return document.getElementById('canvas').width; },  
 101624: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101692: () => { document.exitFullscreen(); },  
 101719: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101777: () => { return screen.width; },  
 101802: () => { return screen.height; },  
 101828: () => { return window.screenX; },  
 101855: () => { return window.screenY; },  
 101882: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101935: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102006: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102063: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102319: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102390: () => { if (document.fullscreenElement) return 1; },  
 102436: () => { return window.innerWidth; },  
 102462: () => { return window.innerHeight; },  
 102489: () => { if (document.pointerLockElement) return 1; }
};
