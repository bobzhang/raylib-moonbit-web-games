...
var ASM_CONSTS = {
 ...
 100370: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100438: () => { document.exitFullscreen(); },  
 100465: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100538: () => { if (document.fullscreenElement) return 1; },  
 100584: () => { return document.getElementById('canvas').width; },  
 100636: () => { return screen.width; },  
 100661: () => { document.exitFullscreen(); },  
 100688: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100821: () => { return window.innerWidth; },  
 100847: () => { return window.innerHeight; },  
 100874: () => { if (document.fullscreenElement) return 1; },  
 100920: () => { return document.getElementById('canvas').width; },  
 100972: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101040: () => { if (document.fullscreenElement) return 1; },  
 101086: () => { return document.getElementById('canvas').width; },  
 101138: () => { return screen.width; },  
 101163: () => { return window.innerWidth; },  
 101189: () => { return window.innerHeight; },  
 101216: () => { if (document.fullscreenElement) return 1; },  
 101262: () => { return document.getElementById('canvas').width; },  
 101314: () => { return screen.width; },  
 101339: () => { document.exitFullscreen(); },  
 101366: () => { if (document.fullscreenElement) return 1; },  
 101412: () => { return document.getElementById('canvas').width; },  
 101464: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101532: () => { document.exitFullscreen(); },  
 101559: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101617: () => { return screen.width; },  
 101642: () => { return screen.height; },  
 101668: () => { return window.screenX; },  
 101695: () => { return window.screenY; },  
 101722: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101775: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101846: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101903: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102159: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102230: () => { if (document.fullscreenElement) return 1; },  
 102276: () => { return window.innerWidth; },  
 102302: () => { return window.innerHeight; },  
 102329: () => { if (document.pointerLockElement) return 1; }
};
