...
function findWasmBinary() {
  return locateFile('raylib_city_builder_mini_2026.wasm');
}
...
var ASM_CONSTS = {
  97424: () => { if (document.fullscreenElement) return 1; },  
 97470: () => { return document.getElementById('canvas').width; },  
 97522: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97590: () => { document.exitFullscreen(); },  
 97617: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97690: () => { if (document.fullscreenElement) return 1; },  
 97736: () => { return document.getElementById('canvas').width; },  
 97788: () => { return screen.width; },  
 97813: () => { document.exitFullscreen(); },  
 97840: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97973: () => { return window.innerWidth; },  
 97999: () => { return window.innerHeight; },  
 98026: () => { if (document.fullscreenElement) return 1; },  
 98072: () => { return document.getElementById('canvas').width; },  
 98124: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98192: () => { if (document.fullscreenElement) return 1; },  
 98238: () => { return document.getElementById('canvas').width; },  
 98290: () => { return screen.width; },  
 98315: () => { return window.innerWidth; },  
 98341: () => { return window.innerHeight; },  
 98368: () => { if (document.fullscreenElement) return 1; },  
 98414: () => { return document.getElementById('canvas').width; },  
 98466: () => { return screen.width; },  
 98491: () => { document.exitFullscreen(); },  
 98518: () => { if (document.fullscreenElement) return 1; },  
 98564: () => { return document.getElementById('canvas').width; },  
 98616: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98684: () => { document.exitFullscreen(); },  
 98711: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98769: () => { return screen.width; },  
 98794: () => { return screen.height; },  
 98820: () => { return window.screenX; },  
 98847: () => { return window.screenY; },  
 98874: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98927: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98998: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99055: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99311: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99382: () => { if (document.fullscreenElement) return 1; },  
 99428: () => { return window.innerWidth; },  
 99454: () => { return window.innerHeight; },  
 99481: () => { if (document.pointerLockElement) return 1; }
};
