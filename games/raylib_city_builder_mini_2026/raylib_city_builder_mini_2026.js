...
var ASM_CONSTS = {
  97600: () => { if (document.fullscreenElement) return 1; },  
 97646: () => { return document.getElementById('canvas').width; },  
 97698: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97766: () => { document.exitFullscreen(); },  
 97793: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97866: () => { if (document.fullscreenElement) return 1; },  
 97912: () => { return document.getElementById('canvas').width; },  
 97964: () => { return screen.width; },  
 97989: () => { document.exitFullscreen(); },  
 98016: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98149: () => { return window.innerWidth; },  
 98175: () => { return window.innerHeight; },  
 98202: () => { if (document.fullscreenElement) return 1; },  
 98248: () => { return document.getElementById('canvas').width; },  
 98300: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 98590: () => { return document.getElementById('canvas').width; },  
 98642: () => { return screen.width; },  
 98667: () => { document.exitFullscreen(); },  
 98694: () => { if (document.fullscreenElement) return 1; },  
 98740: () => { return document.getElementById('canvas').width; },  
 98792: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98860: () => { document.exitFullscreen(); },  
 98887: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98945: () => { return screen.width; },  
 98970: () => { return screen.height; },  
 98996: () => { return window.screenX; },  
 99023: () => { return window.screenY; },  
 99050: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99103: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99174: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99231: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99487: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99558: () => { if (document.fullscreenElement) return 1; },  
 99604: () => { return window.innerWidth; },  
 99630: () => { return window.innerHeight; },  
 99657: () => { if (document.pointerLockElement) return 1; }
};
