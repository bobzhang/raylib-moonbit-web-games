...
function findWasmBinary() {
  return locateFile('raylib_matchlink_festival_2026.wasm');
}
...
var ASM_CONSTS = {
  99552: () => { if (document.fullscreenElement) return 1; },  
 99598: () => { return document.getElementById('canvas').width; },  
 99650: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99718: () => { document.exitFullscreen(); },  
 99745: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99818: () => { if (document.fullscreenElement) return 1; },  
 99864: () => { return document.getElementById('canvas').width; },  
 99916: () => { return screen.width; },  
 99941: () => { document.exitFullscreen(); },  
 99968: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100101: () => { return window.innerWidth; },  
 100127: () => { return window.innerHeight; },  
 100154: () => { if (document.fullscreenElement) return 1; },  
 100200: () => { return document.getElementById('canvas').width; },  
 100252: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100443: () => { return window.innerWidth; },  
 100469: () => { return window.innerHeight; },  
 ...
 100619: () => { document.exitFullscreen(); },  
 100646: () => { if (document.fullscreenElement) return 1; },  
 100692: () => { return document.getElementById('canvas').width; },  
 100744: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100812: () => { document.exitFullscreen(); },  
 100839: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100897: () => { return screen.width; },  
 100922: () => { return screen.height; },  
 100948: () => { return window.screenX; },  
 100975: () => { return window.screenY; },  
 101002: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101055: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101126: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101183: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101439: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101510: () => { if (document.fullscreenElement) return 1; },  
 101556: () => { return window.innerWidth; },  
 101582: () => { return window.innerHeight; },  
 101609: () => { if (document.pointerLockElement) return 1; }
};
