...
var ASM_CONSTS = {
  107336: () => { if (document.fullscreenElement) return 1; },  
 107382: () => { return document.getElementById('canvas').width; },  
 107434: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107502: () => { document.exitFullscreen(); },  
 107529: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107602: () => { if (document.fullscreenElement) return 1; },  
 107648: () => { return document.getElementById('canvas').width; },  
 107700: () => { return screen.width; },  
 107725: () => { document.exitFullscreen(); },  
 107752: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107885: () => { return window.innerWidth; },  
 107911: () => { return window.innerHeight; },  
 107938: () => { if (document.fullscreenElement) return 1; },  
 107984: () => { return document.getElementById('canvas').width; },  
 108036: () => { return parseInt(document.getElementById('canvas').style.width); },  
