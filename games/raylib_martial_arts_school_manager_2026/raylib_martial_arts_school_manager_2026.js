...
var ASM_CONSTS = {
 ...
 100274: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100342: () => { document.exitFullscreen(); },  
 100369: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100442: () => { if (document.fullscreenElement) return 1; },  
 100488: () => { return document.getElementById('canvas').width; },  
 100540: () => { return screen.width; },  
 100565: () => { document.exitFullscreen(); },  
 100592: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100725: () => { return window.innerWidth; },  
 100751: () => { return window.innerHeight; },  
 100778: () => { if (document.fullscreenElement) return 1; },  
 100824: () => { return document.getElementById('canvas').width; },  
 100876: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100944: () => { if (document.fullscreenElement) return 1; },  
 100990: () => { return document.getElementById('canvas').width; },  
 101042: () => { return screen.width; },  
 101067: () => { return window.innerWidth; },  
 101093: () => { return window.innerHeight; },  
 ...
 101243: () => { document.exitFullscreen(); },  
 101270: () => { if (document.fullscreenElement) return 1; },  
 101316: () => { return document.getElementById('canvas').width; },  
 101368: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101436: () => { document.exitFullscreen(); },  
 101463: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101521: () => { return screen.width; },  
 101546: () => { return screen.height; },  
 101572: () => { return window.screenX; },  
 101599: () => { return window.screenY; },  
 101626: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101679: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101750: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101807: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102063: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102134: () => { if (document.fullscreenElement) return 1; },  
 102180: () => { return window.innerWidth; },  
 102206: () => { return window.innerHeight; },  
 102233: () => { if (document.pointerLockElement) return 1; }
};
