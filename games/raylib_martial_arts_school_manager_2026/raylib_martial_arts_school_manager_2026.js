...
function findWasmBinary() {
  return locateFile('raylib_martial_arts_school_manager_2026.wasm');
}
...
var ASM_CONSTS = {
  100336: () => { if (document.fullscreenElement) return 1; },  
 100382: () => { return document.getElementById('canvas').width; },  
 100434: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100502: () => { document.exitFullscreen(); },  
 100529: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100602: () => { if (document.fullscreenElement) return 1; },  
 100648: () => { return document.getElementById('canvas').width; },  
 100700: () => { return screen.width; },  
 100725: () => { document.exitFullscreen(); },  
 100752: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100885: () => { return window.innerWidth; },  
 100911: () => { return window.innerHeight; },  
 100938: () => { if (document.fullscreenElement) return 1; },  
 100984: () => { return document.getElementById('canvas').width; },  
 101036: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101104: () => { if (document.fullscreenElement) return 1; },  
 101150: () => { return document.getElementById('canvas').width; },  
 101202: () => { return screen.width; },  
 101227: () => { return window.innerWidth; },  
 101253: () => { return window.innerHeight; },  
 101280: () => { if (document.fullscreenElement) return 1; },  
 101326: () => { return document.getElementById('canvas').width; },  
 101378: () => { return screen.width; },  
 101403: () => { document.exitFullscreen(); },  
 101430: () => { if (document.fullscreenElement) return 1; },  
 101476: () => { return document.getElementById('canvas').width; },  
 101528: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101596: () => { document.exitFullscreen(); },  
 101623: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101681: () => { return screen.width; },  
 101706: () => { return screen.height; },  
 101732: () => { return window.screenX; },  
 101759: () => { return window.screenY; },  
 101786: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101839: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101910: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101967: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102223: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102294: () => { if (document.fullscreenElement) return 1; },  
 102340: () => { return window.innerWidth; },  
 102366: () => { return window.innerHeight; },  
 102393: () => { if (document.pointerLockElement) return 1; }
};
