...
var ASM_CONSTS = {
  107208: () => { if (document.fullscreenElement) return 1; },  
 107254: () => { return document.getElementById('canvas').width; },  
 107306: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107374: () => { document.exitFullscreen(); },  
 107401: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107474: () => { if (document.fullscreenElement) return 1; },  
 107520: () => { return document.getElementById('canvas').width; },  
 107572: () => { return screen.width; },  
 107597: () => { document.exitFullscreen(); },  
 107624: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107757: () => { return window.innerWidth; },  
 107783: () => { return window.innerHeight; },  
 107810: () => { if (document.fullscreenElement) return 1; },  
 107856: () => { return document.getElementById('canvas').width; },  
 107908: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107976: () => { if (document.fullscreenElement) return 1; },  
 108022: () => { return document.getElementById('canvas').width; },  
 108074: () => { return screen.width; },  
 108099: () => { return window.innerWidth; },  
 108125: () => { return window.innerHeight; },  
 108152: () => { if (document.fullscreenElement) return 1; },  
 108198: () => { return document.getElementById('canvas').width; },  
 108250: () => { return screen.width; },  
 108275: () => { document.exitFullscreen(); },  
 108302: () => { if (document.fullscreenElement) return 1; },  
 108348: () => { return document.getElementById('canvas').width; },  
 108400: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108468: () => { document.exitFullscreen(); },  
 108495: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 108553: () => { return screen.width; },  
 108578: () => { return screen.height; },  
 108604: () => { return window.screenX; },  
 108631: () => { return window.screenY; },  
 108658: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 108711: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 108782: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 108839: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 109095: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 109166: () => { if (document.fullscreenElement) return 1; },  
 109212: () => { return window.innerWidth; },  
 109238: () => { return window.innerHeight; },  
 109265: () => { if (document.pointerLockElement) return 1; },  
