...
function findWasmBinary() {
  return locateFile('raylib_neon_2048_storm_2026.wasm');
}
...
var ASM_CONSTS = {
  107048: () => { if (document.fullscreenElement) return 1; },  
 107094: () => { return document.getElementById('canvas').width; },  
 107146: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107214: () => { document.exitFullscreen(); },  
 107241: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107314: () => { if (document.fullscreenElement) return 1; },  
 107360: () => { return document.getElementById('canvas').width; },  
 107412: () => { return screen.width; },  
 107437: () => { document.exitFullscreen(); },  
 107464: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107597: () => { return window.innerWidth; },  
 107623: () => { return window.innerHeight; },  
 107650: () => { if (document.fullscreenElement) return 1; },  
 107696: () => { return document.getElementById('canvas').width; },  
 107748: () => { return parseInt(document.getElementById('canvas').style.width); },  
