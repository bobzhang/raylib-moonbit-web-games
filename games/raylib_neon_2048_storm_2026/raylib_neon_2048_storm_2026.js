...
var ASM_CONSTS = {
 ...
 107290: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107358: () => { document.exitFullscreen(); },  
 107385: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107458: () => { if (document.fullscreenElement) return 1; },  
 107504: () => { return document.getElementById('canvas').width; },  
 107556: () => { return screen.width; },  
 107581: () => { document.exitFullscreen(); },  
 107608: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107741: () => { return window.innerWidth; },  
 107767: () => { return window.innerHeight; },  
 107794: () => { if (document.fullscreenElement) return 1; },  
 107840: () => { return document.getElementById('canvas').width; },  
 107892: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 108083: () => { return window.innerWidth; },  
 108109: () => { return window.innerHeight; },  
