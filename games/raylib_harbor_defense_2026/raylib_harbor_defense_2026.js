...
function findWasmBinary() {
  return locateFile('raylib_harbor_defense_2026.wasm');
}
...
var ASM_CONSTS = {
  98448: () => { if (document.fullscreenElement) return 1; },  
 98494: () => { return document.getElementById('canvas').width; },  
 98546: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98614: () => { document.exitFullscreen(); },  
 98641: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98714: () => { if (document.fullscreenElement) return 1; },  
 98760: () => { return document.getElementById('canvas').width; },  
 98812: () => { return screen.width; },  
 98837: () => { document.exitFullscreen(); },  
 98864: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98997: () => { return window.innerWidth; },  
 99023: () => { return window.innerHeight; },  
 99050: () => { if (document.fullscreenElement) return 1; },  
 99096: () => { return document.getElementById('canvas').width; },  
 99148: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99216: () => { if (document.fullscreenElement) return 1; },  
 99262: () => { return document.getElementById('canvas').width; },  
 99314: () => { return screen.width; },  
 99339: () => { return window.innerWidth; },  
 99365: () => { return window.innerHeight; },  
 99392: () => { if (document.fullscreenElement) return 1; },  
 99438: () => { return document.getElementById('canvas').width; },  
 99490: () => { return screen.width; },  
 99515: () => { document.exitFullscreen(); },  
 99542: () => { if (document.fullscreenElement) return 1; },  
 99588: () => { return document.getElementById('canvas').width; },  
 99640: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99708: () => { document.exitFullscreen(); },  
 99735: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99793: () => { return screen.width; },  
 99818: () => { return screen.height; },  
 99844: () => { return window.screenX; },  
 99871: () => { return window.screenY; },  
 99898: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99951: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100022: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100079: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100335: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100406: () => { if (document.fullscreenElement) return 1; },  
 100452: () => { return window.innerWidth; },  
 100478: () => { return window.innerHeight; },  
 100505: () => { if (document.pointerLockElement) return 1; }
};
