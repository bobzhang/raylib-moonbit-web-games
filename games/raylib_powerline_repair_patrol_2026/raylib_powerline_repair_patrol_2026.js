...
function findWasmBinary() {
  return locateFile('raylib_powerline_repair_patrol_2026.wasm');
}
...
var ASM_CONSTS = {
  99216: () => { if (document.fullscreenElement) return 1; },  
 99262: () => { return document.getElementById('canvas').width; },  
 99314: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99382: () => { document.exitFullscreen(); },  
 99409: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99482: () => { if (document.fullscreenElement) return 1; },  
 99528: () => { return document.getElementById('canvas').width; },  
 99580: () => { return screen.width; },  
 99605: () => { document.exitFullscreen(); },  
 99632: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99765: () => { return window.innerWidth; },  
 99791: () => { return window.innerHeight; },  
 99818: () => { if (document.fullscreenElement) return 1; },  
 99864: () => { return document.getElementById('canvas').width; },  
 99916: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99984: () => { if (document.fullscreenElement) return 1; },  
 100030: () => { return document.getElementById('canvas').width; },  
 100082: () => { return screen.width; },  
 100107: () => { return window.innerWidth; },  
 100133: () => { return window.innerHeight; },  
 ...
 100283: () => { document.exitFullscreen(); },  
 100310: () => { if (document.fullscreenElement) return 1; },  
 100356: () => { return document.getElementById('canvas').width; },  
 100408: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100476: () => { document.exitFullscreen(); },  
 100503: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100561: () => { return screen.width; },  
 100586: () => { return screen.height; },  
 100612: () => { return window.screenX; },  
 100639: () => { return window.screenY; },  
 100666: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100719: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100790: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100847: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101103: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101174: () => { if (document.fullscreenElement) return 1; },  
 101220: () => { return window.innerWidth; },  
 101246: () => { return window.innerHeight; },  
 101273: () => { if (document.pointerLockElement) return 1; }
};
