...
var ASM_CONSTS = {
  99232: () => { if (document.fullscreenElement) return 1; },  
 99278: () => { return document.getElementById('canvas').width; },  
 99330: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99398: () => { document.exitFullscreen(); },  
 99425: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99498: () => { if (document.fullscreenElement) return 1; },  
 99544: () => { return document.getElementById('canvas').width; },  
 99596: () => { return screen.width; },  
 99621: () => { document.exitFullscreen(); },  
 99648: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99781: () => { return window.innerWidth; },  
 99807: () => { return window.innerHeight; },  
 99834: () => { if (document.fullscreenElement) return 1; },  
 99880: () => { return document.getElementById('canvas').width; },  
 99932: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100000: () => { if (document.fullscreenElement) return 1; },  
 100046: () => { return document.getElementById('canvas').width; },  
 100098: () => { return screen.width; },  
 100123: () => { return window.innerWidth; },  
 100149: () => { return window.innerHeight; },  
 100176: () => { if (document.fullscreenElement) return 1; },  
 100222: () => { return document.getElementById('canvas').width; },  
 100274: () => { return screen.width; },  
 100299: () => { document.exitFullscreen(); },  
 100326: () => { if (document.fullscreenElement) return 1; },  
 100372: () => { return document.getElementById('canvas').width; },  
 100424: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100492: () => { document.exitFullscreen(); },  
 100519: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100577: () => { return screen.width; },  
 100602: () => { return screen.height; },  
 100628: () => { return window.screenX; },  
 100655: () => { return window.screenY; },  
 100682: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100735: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100806: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100863: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101119: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101190: () => { if (document.fullscreenElement) return 1; },  
 101236: () => { return window.innerWidth; },  
 101262: () => { return window.innerHeight; },  
 101289: () => { if (document.pointerLockElement) return 1; }
};
