...
var ASM_CONSTS = {
 ...
 99362: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99430: () => { document.exitFullscreen(); },  
 99457: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99530: () => { if (document.fullscreenElement) return 1; },  
 99576: () => { return document.getElementById('canvas').width; },  
 99628: () => { return screen.width; },  
 99653: () => { document.exitFullscreen(); },  
 99680: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99813: () => { return window.innerWidth; },  
 99839: () => { return window.innerHeight; },  
 99866: () => { if (document.fullscreenElement) return 1; },  
 99912: () => { return document.getElementById('canvas').width; },  
 99964: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100032: () => { if (document.fullscreenElement) return 1; },  
 100078: () => { return document.getElementById('canvas').width; },  
 100130: () => { return screen.width; },  
 100155: () => { return window.innerWidth; },  
 100181: () => { return window.innerHeight; },  
 ...
 100331: () => { document.exitFullscreen(); },  
 100358: () => { if (document.fullscreenElement) return 1; },  
 100404: () => { return document.getElementById('canvas').width; },  
 100456: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100524: () => { document.exitFullscreen(); },  
 100551: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100609: () => { return screen.width; },  
 100634: () => { return screen.height; },  
 100660: () => { return window.screenX; },  
 100687: () => { return window.screenY; },  
 100714: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100767: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100838: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100895: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101151: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101222: () => { if (document.fullscreenElement) return 1; },  
 101268: () => { return window.innerWidth; },  
 101294: () => { return window.innerHeight; },  
 101321: () => { if (document.pointerLockElement) return 1; }
};
