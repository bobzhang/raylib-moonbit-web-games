...
function findWasmBinary() {
  return locateFile('raylib_icebreaker_convoy_command_2026.wasm');
}
...
var ASM_CONSTS = {
  99440: () => { if (document.fullscreenElement) return 1; },  
 99486: () => { return document.getElementById('canvas').width; },  
 99538: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99606: () => { document.exitFullscreen(); },  
 99633: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99706: () => { if (document.fullscreenElement) return 1; },  
 99752: () => { return document.getElementById('canvas').width; },  
 99804: () => { return screen.width; },  
 99829: () => { document.exitFullscreen(); },  
 99856: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99989: () => { return window.innerWidth; },  
 100015: () => { return window.innerHeight; },  
 100042: () => { if (document.fullscreenElement) return 1; },  
 100088: () => { return document.getElementById('canvas').width; },  
 100140: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100208: () => { if (document.fullscreenElement) return 1; },  
 100254: () => { return document.getElementById('canvas').width; },  
 100306: () => { return screen.width; },  
 100331: () => { return window.innerWidth; },  
 100357: () => { return window.innerHeight; },  
 100384: () => { if (document.fullscreenElement) return 1; },  
 100430: () => { return document.getElementById('canvas').width; },  
 100482: () => { return screen.width; },  
 100507: () => { document.exitFullscreen(); },  
 100534: () => { if (document.fullscreenElement) return 1; },  
 100580: () => { return document.getElementById('canvas').width; },  
 100632: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100700: () => { document.exitFullscreen(); },  
 100727: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100785: () => { return screen.width; },  
 100810: () => { return screen.height; },  
 100836: () => { return window.screenX; },  
 100863: () => { return window.screenY; },  
 100890: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100943: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101014: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101071: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101327: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101398: () => { if (document.fullscreenElement) return 1; },  
 101444: () => { return window.innerWidth; },  
 101470: () => { return window.innerHeight; },  
 101497: () => { if (document.pointerLockElement) return 1; }
};
