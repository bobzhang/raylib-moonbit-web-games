...
function findWasmBinary() {
  return locateFile('raylib_clocktower_heist_2026.wasm');
}
...
var ASM_CONSTS = {
 ...
 98018: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98086: () => { document.exitFullscreen(); },  
 98113: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98186: () => { if (document.fullscreenElement) return 1; },  
 98232: () => { return document.getElementById('canvas').width; },  
 98284: () => { return screen.width; },  
 98309: () => { document.exitFullscreen(); },  
 98336: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98469: () => { return window.innerWidth; },  
 98495: () => { return window.innerHeight; },  
 98522: () => { if (document.fullscreenElement) return 1; },  
 98568: () => { return document.getElementById('canvas').width; },  
 98620: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98688: () => { if (document.fullscreenElement) return 1; },  
 98734: () => { return document.getElementById('canvas').width; },  
 98786: () => { return screen.width; },  
 98811: () => { return window.innerWidth; },  
 98837: () => { return window.innerHeight; },  
 98864: () => { if (document.fullscreenElement) return 1; },  
 98910: () => { return document.getElementById('canvas').width; },  
 98962: () => { return screen.width; },  
 98987: () => { document.exitFullscreen(); },  
 99014: () => { if (document.fullscreenElement) return 1; },  
 99060: () => { return document.getElementById('canvas').width; },  
 99112: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99180: () => { document.exitFullscreen(); },  
 99207: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99265: () => { return screen.width; },  
 99290: () => { return screen.height; },  
 99316: () => { return window.screenX; },  
 99343: () => { return window.screenY; },  
 99370: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99423: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99494: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99551: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99807: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99878: () => { if (document.fullscreenElement) return 1; },  
 99924: () => { return window.innerWidth; },  
 99950: () => { return window.innerHeight; },  
 99977: () => { if (document.pointerLockElement) return 1; }
};
