...
var ASM_CONSTS = {
  100048: () => { if (document.fullscreenElement) return 1; },  
 100094: () => { return document.getElementById('canvas').width; },  
 100146: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100214: () => { document.exitFullscreen(); },  
 100241: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100314: () => { if (document.fullscreenElement) return 1; },  
 100360: () => { return document.getElementById('canvas').width; },  
 100412: () => { return screen.width; },  
 100437: () => { document.exitFullscreen(); },  
 100464: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100597: () => { return window.innerWidth; },  
 100623: () => { return window.innerHeight; },  
 100650: () => { if (document.fullscreenElement) return 1; },  
 100696: () => { return document.getElementById('canvas').width; },  
 100748: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100816: () => { if (document.fullscreenElement) return 1; },  
 100862: () => { return document.getElementById('canvas').width; },  
 100914: () => { return screen.width; },  
 100939: () => { return window.innerWidth; },  
 100965: () => { return window.innerHeight; },  
 ...
 101115: () => { document.exitFullscreen(); },  
 101142: () => { if (document.fullscreenElement) return 1; },  
 101188: () => { return document.getElementById('canvas').width; },  
 101240: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101308: () => { document.exitFullscreen(); },  
 101335: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101393: () => { return screen.width; },  
 101418: () => { return screen.height; },  
 101444: () => { return window.screenX; },  
 101471: () => { return window.screenY; },  
 101498: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101551: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101622: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101679: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101935: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102006: () => { if (document.fullscreenElement) return 1; },  
 102052: () => { return window.innerWidth; },  
 102078: () => { return window.innerHeight; },  
 102105: () => { if (document.pointerLockElement) return 1; }
};
