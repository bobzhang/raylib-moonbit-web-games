...
function findWasmBinary() {
  return locateFile('raylib_ink_scroll_detective_2026.wasm');
}
...
var ASM_CONSTS = {
  100080: () => { if (document.fullscreenElement) return 1; },  
 100126: () => { return document.getElementById('canvas').width; },  
 100178: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100246: () => { document.exitFullscreen(); },  
 100273: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100346: () => { if (document.fullscreenElement) return 1; },  
 100392: () => { return document.getElementById('canvas').width; },  
 100444: () => { return screen.width; },  
 100469: () => { document.exitFullscreen(); },  
 100496: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100629: () => { return window.innerWidth; },  
 100655: () => { return window.innerHeight; },  
 100682: () => { if (document.fullscreenElement) return 1; },  
 100728: () => { return document.getElementById('canvas').width; },  
 100780: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100971: () => { return window.innerWidth; },  
 100997: () => { return window.innerHeight; },  
 101024: () => { if (document.fullscreenElement) return 1; },  
 101070: () => { return document.getElementById('canvas').width; },  
 101122: () => { return screen.width; },  
 101147: () => { document.exitFullscreen(); },  
 101174: () => { if (document.fullscreenElement) return 1; },  
 101220: () => { return document.getElementById('canvas').width; },  
 101272: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101340: () => { document.exitFullscreen(); },  
 101367: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101425: () => { return screen.width; },  
 101450: () => { return screen.height; },  
 101476: () => { return window.screenX; },  
 101503: () => { return window.screenY; },  
 101530: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101583: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101654: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101711: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101967: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102038: () => { if (document.fullscreenElement) return 1; },  
 102084: () => { return window.innerWidth; },  
 102110: () => { return window.innerHeight; },  
 102137: () => { if (document.pointerLockElement) return 1; }
};
