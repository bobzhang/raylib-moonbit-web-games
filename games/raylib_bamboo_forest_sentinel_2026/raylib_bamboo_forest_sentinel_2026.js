...
function findWasmBinary() {
  return locateFile('raylib_bamboo_forest_sentinel_2026.wasm');
}
...
var ASM_CONSTS = {
  99392: () => { if (document.fullscreenElement) return 1; },  
 99438: () => { return document.getElementById('canvas').width; },  
 99490: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99558: () => { document.exitFullscreen(); },  
 99585: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99658: () => { if (document.fullscreenElement) return 1; },  
 99704: () => { return document.getElementById('canvas').width; },  
 99756: () => { return screen.width; },  
 99781: () => { document.exitFullscreen(); },  
 99808: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99941: () => { return window.innerWidth; },  
 99967: () => { return window.innerHeight; },  
 99994: () => { if (document.fullscreenElement) return 1; },  
 100040: () => { return document.getElementById('canvas').width; },  
 100092: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100160: () => { if (document.fullscreenElement) return 1; },  
 100206: () => { return document.getElementById('canvas').width; },  
 100258: () => { return screen.width; },  
 100283: () => { return window.innerWidth; },  
 100309: () => { return window.innerHeight; },  
 ...
 100459: () => { document.exitFullscreen(); },  
 100486: () => { if (document.fullscreenElement) return 1; },  
 100532: () => { return document.getElementById('canvas').width; },  
 100584: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100652: () => { document.exitFullscreen(); },  
 100679: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100737: () => { return screen.width; },  
 100762: () => { return screen.height; },  
 100788: () => { return window.screenX; },  
 100815: () => { return window.screenY; },  
 100842: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100895: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100966: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101023: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101279: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101350: () => { if (document.fullscreenElement) return 1; },  
 101396: () => { return window.innerWidth; },  
 101422: () => { return window.innerHeight; },  
 101449: () => { if (document.pointerLockElement) return 1; }
};
