...
var ASM_CONSTS = {
  99376: () => { if (document.fullscreenElement) return 1; },  
 99422: () => { return document.getElementById('canvas').width; },  
 99474: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99542: () => { document.exitFullscreen(); },  
 99569: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99642: () => { if (document.fullscreenElement) return 1; },  
 99688: () => { return document.getElementById('canvas').width; },  
 99740: () => { return screen.width; },  
 99765: () => { document.exitFullscreen(); },  
 99792: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99925: () => { return window.innerWidth; },  
 99951: () => { return window.innerHeight; },  
 99978: () => { if (document.fullscreenElement) return 1; },  
 100024: () => { return document.getElementById('canvas').width; },  
 100076: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100144: () => { if (document.fullscreenElement) return 1; },  
 100190: () => { return document.getElementById('canvas').width; },  
 100242: () => { return screen.width; },  
 100267: () => { return window.innerWidth; },  
 100293: () => { return window.innerHeight; },  
 100320: () => { if (document.fullscreenElement) return 1; },  
 100366: () => { return document.getElementById('canvas').width; },  
 100418: () => { return screen.width; },  
 100443: () => { document.exitFullscreen(); },  
 100470: () => { if (document.fullscreenElement) return 1; },  
 100516: () => { return document.getElementById('canvas').width; },  
 100568: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100636: () => { document.exitFullscreen(); },  
 100663: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100721: () => { return screen.width; },  
 100746: () => { return screen.height; },  
 100772: () => { return window.screenX; },  
 100799: () => { return window.screenY; },  
 100826: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100879: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100950: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101007: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101263: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101334: () => { if (document.fullscreenElement) return 1; },  
 101380: () => { return window.innerWidth; },  
 101406: () => { return window.innerHeight; },  
 101433: () => { if (document.pointerLockElement) return 1; }
};
