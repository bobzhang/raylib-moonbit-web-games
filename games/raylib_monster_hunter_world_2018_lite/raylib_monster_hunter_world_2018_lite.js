...
function findWasmBinary() {
  return locateFile('raylib_monster_hunter_world_2018_lite.wasm');
}
...
var ASM_CONSTS = {
  417008: () => { if (document.fullscreenElement) return 1; },  
 417054: () => { return document.getElementById('canvas').width; },  
 417106: () => { return parseInt(document.getElementById('canvas').style.width); },  
 417174: () => { document.exitFullscreen(); },  
 417201: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 417274: () => { if (document.fullscreenElement) return 1; },  
 417320: () => { return document.getElementById('canvas').width; },  
 417372: () => { return screen.width; },  
 417397: () => { document.exitFullscreen(); },  
 417424: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 417557: () => { return window.innerWidth; },  
 417583: () => { return window.innerHeight; },  
 417610: () => { if (document.fullscreenElement) return 1; },  
 417656: () => { return document.getElementById('canvas').width; },  
 417708: () => { return parseInt(document.getElementById('canvas').style.width); },  
 417776: () => { if (document.fullscreenElement) return 1; },  
 417822: () => { return document.getElementById('canvas').width; },  
 417874: () => { return screen.width; },  
 417899: () => { return window.innerWidth; },  
 417925: () => { return window.innerHeight; },  
 417952: () => { if (document.fullscreenElement) return 1; },  
 417998: () => { return document.getElementById('canvas').width; },  
 418050: () => { return screen.width; },  
 418075: () => { document.exitFullscreen(); },  
 418102: () => { if (document.fullscreenElement) return 1; },  
 418148: () => { return document.getElementById('canvas').width; },  
 418200: () => { return parseInt(document.getElementById('canvas').style.width); },  
 418268: () => { document.exitFullscreen(); },  
 418295: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 418353: () => { return screen.width; },  
 418378: () => { return screen.height; },  
 418404: () => { return window.screenX; },  
 418431: () => { return window.screenY; },  
 418458: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 418511: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 418582: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 418639: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 418895: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 418966: () => { if (document.fullscreenElement) return 1; },  
 419012: () => { return window.innerWidth; },  
 419038: () => { return window.innerHeight; },  
 419065: () => { if (document.pointerLockElement) return 1; }
};
