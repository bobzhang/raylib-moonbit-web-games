...
var ASM_CONSTS = {
 ...
 108150: () => { return document.getElementById('canvas').width; },  
 108202: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108270: () => { document.exitFullscreen(); },  
 108297: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 108370: () => { if (document.fullscreenElement) return 1; },  
 108416: () => { return document.getElementById('canvas').width; },  
 108468: () => { return screen.width; },  
 108493: () => { document.exitFullscreen(); },  
 108520: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108653: () => { return window.innerWidth; },  
 108679: () => { return window.innerHeight; },  
 108706: () => { if (document.fullscreenElement) return 1; },  
 108752: () => { return document.getElementById('canvas').width; },  
 108804: () => { return parseInt(document.getElementById('canvas').style.width); },  
