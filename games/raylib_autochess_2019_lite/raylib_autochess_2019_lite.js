...
function findWasmBinary() {
  return locateFile('raylib_autochess_2019_lite.wasm');
}
...
var ASM_CONSTS = {
  2382368: () => { if (document.fullscreenElement) return 1; },  
 2382414: () => { return document.getElementById('canvas').width; },  
 2382466: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2382534: () => { document.exitFullscreen(); },  
 2382561: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 2382634: () => { if (document.fullscreenElement) return 1; },  
 2382680: () => { return document.getElementById('canvas').width; },  
 2382732: () => { return screen.width; },  
 2382757: () => { document.exitFullscreen(); },  
 2382784: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2382917: () => { return window.innerWidth; },  
 2382943: () => { return window.innerHeight; },  
 2382970: () => { if (document.fullscreenElement) return 1; },  
 2383016: () => { return document.getElementById('canvas').width; },  
 2383068: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2383136: () => { if (document.fullscreenElement) return 1; },  
 2383182: () => { return document.getElementById('canvas').width; },  
 2383234: () => { return screen.width; },  
 2383259: () => { return window.innerWidth; },  
 2383285: () => { return window.innerHeight; },  
 2383312: () => { if (document.fullscreenElement) return 1; },  
 2383358: () => { return document.getElementById('canvas').width; },  
 2383410: () => { return screen.width; },  
 2383435: () => { document.exitFullscreen(); },  
 2383462: () => { if (document.fullscreenElement) return 1; },  
 2383508: () => { return document.getElementById('canvas').width; },  
 2383560: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2383628: () => { document.exitFullscreen(); },  
 2383655: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 2383713: () => { return screen.width; },  
 2383738: () => { return screen.height; },  
 2383764: () => { return window.screenX; },  
 2383791: () => { return window.screenY; },  
 2383818: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2383871: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 2383942: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 2383999: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2384255: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 2384326: () => { if (document.fullscreenElement) return 1; },  
 2384372: () => { return window.innerWidth; },  
 2384398: () => { return window.innerHeight; },  
 2384425: () => { if (document.pointerLockElement) return 1; }
};
