...
var ASM_CONSTS = {
  99280: () => { if (document.fullscreenElement) return 1; },  
 99326: () => { return document.getElementById('canvas').width; },  
 99378: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99446: () => { document.exitFullscreen(); },  
 99473: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99546: () => { if (document.fullscreenElement) return 1; },  
 99592: () => { return document.getElementById('canvas').width; },  
 99644: () => { return screen.width; },  
 99669: () => { document.exitFullscreen(); },  
 99696: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99829: () => { return window.innerWidth; },  
 99855: () => { return window.innerHeight; },  
 99882: () => { if (document.fullscreenElement) return 1; },  
 99928: () => { return document.getElementById('canvas').width; },  
 99980: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100048: () => { if (document.fullscreenElement) return 1; },  
 100094: () => { return document.getElementById('canvas').width; },  
 100146: () => { return screen.width; },  
 100171: () => { return window.innerWidth; },  
 100197: () => { return window.innerHeight; },  
 ...
 100347: () => { document.exitFullscreen(); },  
 100374: () => { if (document.fullscreenElement) return 1; },  
 100420: () => { return document.getElementById('canvas').width; },  
 100472: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100540: () => { document.exitFullscreen(); },  
 100567: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100625: () => { return screen.width; },  
 100650: () => { return screen.height; },  
 100676: () => { return window.screenX; },  
 100703: () => { return window.screenY; },  
 100730: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100783: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100854: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100911: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101167: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101238: () => { if (document.fullscreenElement) return 1; },  
 101284: () => { return window.innerWidth; },  
 101310: () => { return window.innerHeight; },  
 101337: () => { if (document.pointerLockElement) return 1; }
};
