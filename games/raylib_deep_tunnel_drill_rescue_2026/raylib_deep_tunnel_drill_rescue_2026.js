...
var ASM_CONSTS = {
 ...
 99202: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99270: () => { document.exitFullscreen(); },  
 99297: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99370: () => { if (document.fullscreenElement) return 1; },  
 99416: () => { return document.getElementById('canvas').width; },  
 99468: () => { return screen.width; },  
 99493: () => { document.exitFullscreen(); },  
 99520: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99653: () => { return window.innerWidth; },  
 99679: () => { return window.innerHeight; },  
 99706: () => { if (document.fullscreenElement) return 1; },  
 99752: () => { return document.getElementById('canvas').width; },  
 99804: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99872: () => { if (document.fullscreenElement) return 1; },  
 99918: () => { return document.getElementById('canvas').width; },  
 99970: () => { return screen.width; },  
 99995: () => { return window.innerWidth; },  
 100021: () => { return window.innerHeight; },  
 ...
 100171: () => { document.exitFullscreen(); },  
 100198: () => { if (document.fullscreenElement) return 1; },  
 100244: () => { return document.getElementById('canvas').width; },  
 100296: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100364: () => { document.exitFullscreen(); },  
 100391: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100449: () => { return screen.width; },  
 100474: () => { return screen.height; },  
 100500: () => { return window.screenX; },  
 100527: () => { return window.screenY; },  
 100554: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100607: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100678: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100735: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100991: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101062: () => { if (document.fullscreenElement) return 1; },  
 101108: () => { return window.innerWidth; },  
 101134: () => { return window.innerHeight; },  
 101161: () => { if (document.pointerLockElement) return 1; }
};
