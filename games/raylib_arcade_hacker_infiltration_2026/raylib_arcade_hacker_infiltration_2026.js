...
function findWasmBinary() {
  return locateFile('raylib_arcade_hacker_infiltration_2026.wasm');
}
...
var ASM_CONSTS = {
 ...
 99170: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99238: () => { document.exitFullscreen(); },  
 99265: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99338: () => { if (document.fullscreenElement) return 1; },  
 99384: () => { return document.getElementById('canvas').width; },  
 99436: () => { return screen.width; },  
 99461: () => { document.exitFullscreen(); },  
 99488: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99621: () => { return window.innerWidth; },  
 99647: () => { return window.innerHeight; },  
 99674: () => { if (document.fullscreenElement) return 1; },  
 99720: () => { return document.getElementById('canvas').width; },  
 99772: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99840: () => { if (document.fullscreenElement) return 1; },  
 99886: () => { return document.getElementById('canvas').width; },  
 99938: () => { return screen.width; },  
 99963: () => { return window.innerWidth; },  
 99989: () => { return window.innerHeight; },  
 100016: () => { if (document.fullscreenElement) return 1; },  
 100062: () => { return document.getElementById('canvas').width; },  
 100114: () => { return screen.width; },  
 100139: () => { document.exitFullscreen(); },  
 100166: () => { if (document.fullscreenElement) return 1; },  
 100212: () => { return document.getElementById('canvas').width; },  
 100264: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100332: () => { document.exitFullscreen(); },  
 100359: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100417: () => { return screen.width; },  
 100442: () => { return screen.height; },  
 100468: () => { return window.screenX; },  
 100495: () => { return window.screenY; },  
 100522: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100575: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100646: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100703: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100959: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101030: () => { if (document.fullscreenElement) return 1; },  
 101076: () => { return window.innerWidth; },  
 101102: () => { return window.innerHeight; },  
 101129: () => { if (document.pointerLockElement) return 1; }
};
