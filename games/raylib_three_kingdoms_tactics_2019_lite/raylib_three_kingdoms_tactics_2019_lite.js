...
function findWasmBinary() {
  return locateFile('raylib_three_kingdoms_tactics_2019_lite.wasm');
}
...
var ASM_CONSTS = {
  2382416: () => { if (document.fullscreenElement) return 1; },  
 2382462: () => { return document.getElementById('canvas').width; },  
 2382514: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2382582: () => { document.exitFullscreen(); },  
 2382609: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 2382682: () => { if (document.fullscreenElement) return 1; },  
 2382728: () => { return document.getElementById('canvas').width; },  
 2382780: () => { return screen.width; },  
 2382805: () => { document.exitFullscreen(); },  
 2382832: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2382965: () => { return window.innerWidth; },  
 2382991: () => { return window.innerHeight; },  
 2383018: () => { if (document.fullscreenElement) return 1; },  
 2383064: () => { return document.getElementById('canvas').width; },  
 2383116: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2383184: () => { if (document.fullscreenElement) return 1; },  
 2383230: () => { return document.getElementById('canvas').width; },  
 2383282: () => { return screen.width; },  
 2383307: () => { return window.innerWidth; },  
 2383333: () => { return window.innerHeight; },  
 2383360: () => { if (document.fullscreenElement) return 1; },  
 2383406: () => { return document.getElementById('canvas').width; },  
 2383458: () => { return screen.width; },  
 2383483: () => { document.exitFullscreen(); },  
 2383510: () => { if (document.fullscreenElement) return 1; },  
 2383556: () => { return document.getElementById('canvas').width; },  
 2383608: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2383676: () => { document.exitFullscreen(); },  
 2383703: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 2383761: () => { return screen.width; },  
 2383786: () => { return screen.height; },  
 2383812: () => { return window.screenX; },  
 2383839: () => { return window.screenY; },  
 2383866: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2383919: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 2383990: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 2384047: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2384303: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 2384374: () => { if (document.fullscreenElement) return 1; },  
 2384420: () => { return window.innerWidth; },  
 2384446: () => { return window.innerHeight; },  
 2384473: () => { if (document.pointerLockElement) return 1; }
};
