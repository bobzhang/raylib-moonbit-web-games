...
function findWasmBinary() {
  return locateFile('raylib_dragon_boat_sprint_2026.wasm');
}
...
var ASM_CONSTS = {
  99888: () => { if (document.fullscreenElement) return 1; },  
 99934: () => { return document.getElementById('canvas').width; },  
 99986: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100054: () => { document.exitFullscreen(); },  
 100081: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100154: () => { if (document.fullscreenElement) return 1; },  
 100200: () => { return document.getElementById('canvas').width; },  
 100252: () => { return screen.width; },  
 100277: () => { document.exitFullscreen(); },  
 100304: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100437: () => { return window.innerWidth; },  
 100463: () => { return window.innerHeight; },  
 100490: () => { if (document.fullscreenElement) return 1; },  
 100536: () => { return document.getElementById('canvas').width; },  
 100588: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100656: () => { if (document.fullscreenElement) return 1; },  
 100702: () => { return document.getElementById('canvas').width; },  
 100754: () => { return screen.width; },  
 100779: () => { return window.innerWidth; },  
 100805: () => { return window.innerHeight; },  
 ...
 100955: () => { document.exitFullscreen(); },  
 100982: () => { if (document.fullscreenElement) return 1; },  
 101028: () => { return document.getElementById('canvas').width; },  
 101080: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101148: () => { document.exitFullscreen(); },  
 101175: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101233: () => { return screen.width; },  
 101258: () => { return screen.height; },  
 101284: () => { return window.screenX; },  
 101311: () => { return window.screenY; },  
 101338: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101391: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101462: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101519: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101775: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101846: () => { if (document.fullscreenElement) return 1; },  
 101892: () => { return window.innerWidth; },  
 101918: () => { return window.innerHeight; },  
 101945: () => { if (document.pointerLockElement) return 1; }
};
