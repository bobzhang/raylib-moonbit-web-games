...
var ASM_CONSTS = {
  99872: () => { if (document.fullscreenElement) return 1; },  
 99918: () => { return document.getElementById('canvas').width; },  
 99970: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100038: () => { document.exitFullscreen(); },  
 100065: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100138: () => { if (document.fullscreenElement) return 1; },  
 100184: () => { return document.getElementById('canvas').width; },  
 100236: () => { return screen.width; },  
 100261: () => { document.exitFullscreen(); },  
 100288: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100421: () => { return window.innerWidth; },  
 100447: () => { return window.innerHeight; },  
 100474: () => { if (document.fullscreenElement) return 1; },  
 100520: () => { return document.getElementById('canvas').width; },  
 100572: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100640: () => { if (document.fullscreenElement) return 1; },  
 100686: () => { return document.getElementById('canvas').width; },  
 100738: () => { return screen.width; },  
 100763: () => { return window.innerWidth; },  
 100789: () => { return window.innerHeight; },  
 ...
 100939: () => { document.exitFullscreen(); },  
 100966: () => { if (document.fullscreenElement) return 1; },  
 101012: () => { return document.getElementById('canvas').width; },  
 101064: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101132: () => { document.exitFullscreen(); },  
 101159: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101217: () => { return screen.width; },  
 101242: () => { return screen.height; },  
 101268: () => { return window.screenX; },  
 101295: () => { return window.screenY; },  
 101322: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101375: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101446: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101503: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101759: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101830: () => { if (document.fullscreenElement) return 1; },  
 101876: () => { return window.innerWidth; },  
 101902: () => { return window.innerHeight; },  
 101929: () => { if (document.pointerLockElement) return 1; }
};
