...
var ASM_CONSTS = {
 ...
 99682: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99750: () => { document.exitFullscreen(); },  
 99777: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99850: () => { if (document.fullscreenElement) return 1; },  
 99896: () => { return document.getElementById('canvas').width; },  
 99948: () => { return screen.width; },  
 99973: () => { document.exitFullscreen(); },  
 100000: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100133: () => { return window.innerWidth; },  
 100159: () => { return window.innerHeight; },  
 100186: () => { if (document.fullscreenElement) return 1; },  
 100232: () => { return document.getElementById('canvas').width; },  
 100284: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100651: () => { document.exitFullscreen(); },  
 100678: () => { if (document.fullscreenElement) return 1; },  
 100724: () => { return document.getElementById('canvas').width; },  
 100776: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100844: () => { document.exitFullscreen(); },  
 100871: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100929: () => { return screen.width; },  
 100954: () => { return screen.height; },  
 100980: () => { return window.screenX; },  
 101007: () => { return window.screenY; },  
 101034: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101087: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101158: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101215: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101471: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101542: () => { if (document.fullscreenElement) return 1; },  
 101588: () => { return window.innerWidth; },  
 101614: () => { return window.innerHeight; },  
 101641: () => { if (document.pointerLockElement) return 1; }
};
