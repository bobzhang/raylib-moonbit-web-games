...
var ASM_CONSTS = {
  99712: () => { if (document.fullscreenElement) return 1; },  
 99758: () => { return document.getElementById('canvas').width; },  
 99810: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99878: () => { document.exitFullscreen(); },  
 99905: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99978: () => { if (document.fullscreenElement) return 1; },  
 100024: () => { return document.getElementById('canvas').width; },  
 100076: () => { return screen.width; },  
 100101: () => { document.exitFullscreen(); },  
 100128: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100261: () => { return window.innerWidth; },  
 100287: () => { return window.innerHeight; },  
 100314: () => { if (document.fullscreenElement) return 1; },  
 100360: () => { return document.getElementById('canvas').width; },  
 100412: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100480: () => { if (document.fullscreenElement) return 1; },  
 100526: () => { return document.getElementById('canvas').width; },  
 100578: () => { return screen.width; },  
 100603: () => { return window.innerWidth; },  
 100629: () => { return window.innerHeight; },  
 ...
 100779: () => { document.exitFullscreen(); },  
 100806: () => { if (document.fullscreenElement) return 1; },  
 100852: () => { return document.getElementById('canvas').width; },  
 100904: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100972: () => { document.exitFullscreen(); },  
 100999: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101057: () => { return screen.width; },  
 101082: () => { return screen.height; },  
 101108: () => { return window.screenX; },  
 101135: () => { return window.screenY; },  
 101162: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101215: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101286: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101343: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101599: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101670: () => { if (document.fullscreenElement) return 1; },  
 101716: () => { return window.innerWidth; },  
 101742: () => { return window.innerHeight; },  
 101769: () => { if (document.pointerLockElement) return 1; }
};
