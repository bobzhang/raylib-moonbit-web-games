...
function findWasmBinary() {
  return locateFile('raylib_mahjong_solitaire_pavilion_2026.wasm');
}
...
var ASM_CONSTS = {
  99728: () => { if (document.fullscreenElement) return 1; },  
 99774: () => { return document.getElementById('canvas').width; },  
 99826: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99894: () => { document.exitFullscreen(); },  
 99921: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99994: () => { if (document.fullscreenElement) return 1; },  
 100040: () => { return document.getElementById('canvas').width; },  
 100092: () => { return screen.width; },  
 100117: () => { document.exitFullscreen(); },  
 100144: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100277: () => { return window.innerWidth; },  
 100303: () => { return window.innerHeight; },  
 100330: () => { if (document.fullscreenElement) return 1; },  
 100376: () => { return document.getElementById('canvas').width; },  
 100428: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100496: () => { if (document.fullscreenElement) return 1; },  
 100542: () => { return document.getElementById('canvas').width; },  
 100594: () => { return screen.width; },  
 100619: () => { return window.innerWidth; },  
 100645: () => { return window.innerHeight; },  
 ...
 100795: () => { document.exitFullscreen(); },  
 100822: () => { if (document.fullscreenElement) return 1; },  
 100868: () => { return document.getElementById('canvas').width; },  
 100920: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100988: () => { document.exitFullscreen(); },  
 101015: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101073: () => { return screen.width; },  
 101098: () => { return screen.height; },  
 101124: () => { return window.screenX; },  
 101151: () => { return window.screenY; },  
 101178: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101231: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101302: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101359: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101615: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101686: () => { if (document.fullscreenElement) return 1; },  
 101732: () => { return window.innerWidth; },  
 101758: () => { return window.innerHeight; },  
 101785: () => { if (document.pointerLockElement) return 1; }
};
