...
function findWasmBinary() {
  return locateFile('raylib_raft_rapids_escape_2026.wasm');
}
...
var ASM_CONSTS = {
  107288: () => { if (document.fullscreenElement) return 1; },  
 107334: () => { return document.getElementById('canvas').width; },  
 107386: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107454: () => { document.exitFullscreen(); },  
 107481: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107554: () => { if (document.fullscreenElement) return 1; },  
 107600: () => { return document.getElementById('canvas').width; },  
 107652: () => { return screen.width; },  
 107677: () => { document.exitFullscreen(); },  
 107704: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107837: () => { return window.innerWidth; },  
 107863: () => { return window.innerHeight; },  
 107890: () => { if (document.fullscreenElement) return 1; },  
 107936: () => { return document.getElementById('canvas').width; },  
 107988: () => { return parseInt(document.getElementById('canvas').style.width); },  
