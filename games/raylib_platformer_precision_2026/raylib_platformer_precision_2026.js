...
var ASM_CONSTS = {
  96976: () => { if (document.fullscreenElement) return 1; },  
 97022: () => { return document.getElementById('canvas').width; },  
 97074: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97142: () => { document.exitFullscreen(); },  
 97169: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97242: () => { if (document.fullscreenElement) return 1; },  
 97288: () => { return document.getElementById('canvas').width; },  
 97340: () => { return screen.width; },  
 97365: () => { document.exitFullscreen(); },  
 97392: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97525: () => { return window.innerWidth; },  
 97551: () => { return window.innerHeight; },  
 97578: () => { if (document.fullscreenElement) return 1; },  
 97624: () => { return document.getElementById('canvas').width; },  
 97676: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97744: () => { if (document.fullscreenElement) return 1; },  
 97790: () => { return document.getElementById('canvas').width; },  
 97842: () => { return screen.width; },  
 97867: () => { return window.innerWidth; },  
 97893: () => { return window.innerHeight; },  
 97920: () => { if (document.fullscreenElement) return 1; },  
 97966: () => { return document.getElementById('canvas').width; },  
 98018: () => { return screen.width; },  
 98043: () => { document.exitFullscreen(); },  
 98070: () => { if (document.fullscreenElement) return 1; },  
 98116: () => { return document.getElementById('canvas').width; },  
 98168: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98236: () => { document.exitFullscreen(); },  
 98263: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98321: () => { return screen.width; },  
 98346: () => { return screen.height; },  
 98372: () => { return window.screenX; },  
 98399: () => { return window.screenY; },  
 98426: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98479: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98550: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98607: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98863: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98934: () => { if (document.fullscreenElement) return 1; },  
 98980: () => { return window.innerWidth; },  
 99006: () => { return window.innerHeight; },  
 99033: () => { if (document.pointerLockElement) return 1; }
};
