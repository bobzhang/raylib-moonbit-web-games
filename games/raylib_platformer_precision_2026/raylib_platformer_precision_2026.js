...
var ASM_CONSTS = {
  97136: () => { if (document.fullscreenElement) return 1; },  
 97182: () => { return document.getElementById('canvas').width; },  
 97234: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97302: () => { document.exitFullscreen(); },  
 97329: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97402: () => { if (document.fullscreenElement) return 1; },  
 97448: () => { return document.getElementById('canvas').width; },  
 97500: () => { return screen.width; },  
 97525: () => { document.exitFullscreen(); },  
 97552: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97685: () => { return window.innerWidth; },  
 97711: () => { return window.innerHeight; },  
 97738: () => { if (document.fullscreenElement) return 1; },  
 97784: () => { return document.getElementById('canvas').width; },  
 97836: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97904: () => { if (document.fullscreenElement) return 1; },  
 97950: () => { return document.getElementById('canvas').width; },  
 98002: () => { return screen.width; },  
 98027: () => { return window.innerWidth; },  
 98053: () => { return window.innerHeight; },  
 98080: () => { if (document.fullscreenElement) return 1; },  
 98126: () => { return document.getElementById('canvas').width; },  
 98178: () => { return screen.width; },  
 98203: () => { document.exitFullscreen(); },  
 98230: () => { if (document.fullscreenElement) return 1; },  
 98276: () => { return document.getElementById('canvas').width; },  
 98328: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98396: () => { document.exitFullscreen(); },  
 98423: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98481: () => { return screen.width; },  
 98506: () => { return screen.height; },  
 98532: () => { return window.screenX; },  
 98559: () => { return window.screenY; },  
 98586: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98639: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98710: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98767: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99023: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99094: () => { if (document.fullscreenElement) return 1; },  
 99140: () => { return window.innerWidth; },  
 99166: () => { return window.innerHeight; },  
 99193: () => { if (document.pointerLockElement) return 1; }
};
