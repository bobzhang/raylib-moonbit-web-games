...
function findWasmBinary() {
  return locateFile('raylib_city_crossing_2026.wasm');
}
...
var ASM_CONSTS = {
  97840: () => { if (document.fullscreenElement) return 1; },  
 97886: () => { return document.getElementById('canvas').width; },  
 97938: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98006: () => { document.exitFullscreen(); },  
 98033: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98106: () => { if (document.fullscreenElement) return 1; },  
 98152: () => { return document.getElementById('canvas').width; },  
 98204: () => { return screen.width; },  
 98229: () => { document.exitFullscreen(); },  
 98256: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98389: () => { return window.innerWidth; },  
 98415: () => { return window.innerHeight; },  
 98442: () => { if (document.fullscreenElement) return 1; },  
 98488: () => { return document.getElementById('canvas').width; },  
 98540: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98608: () => { if (document.fullscreenElement) return 1; },  
 98654: () => { return document.getElementById('canvas').width; },  
 98706: () => { return screen.width; },  
 98731: () => { return window.innerWidth; },  
 98757: () => { return window.innerHeight; },  
 98784: () => { if (document.fullscreenElement) return 1; },  
 98830: () => { return document.getElementById('canvas').width; },  
 98882: () => { return screen.width; },  
 98907: () => { document.exitFullscreen(); },  
 98934: () => { if (document.fullscreenElement) return 1; },  
 98980: () => { return document.getElementById('canvas').width; },  
 99032: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99100: () => { document.exitFullscreen(); },  
 99127: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99185: () => { return screen.width; },  
 99210: () => { return screen.height; },  
 99236: () => { return window.screenX; },  
 99263: () => { return window.screenY; },  
 99290: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99343: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99414: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99471: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99727: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99798: () => { if (document.fullscreenElement) return 1; },  
 99844: () => { return window.innerWidth; },  
 99870: () => { return window.innerHeight; },  
 99897: () => { if (document.pointerLockElement) return 1; }
};
