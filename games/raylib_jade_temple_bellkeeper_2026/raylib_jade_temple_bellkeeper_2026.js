...
var ASM_CONSTS = {
  106760: () => { if (document.fullscreenElement) return 1; },  
 106806: () => { return document.getElementById('canvas').width; },  
 106858: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106926: () => { document.exitFullscreen(); },  
 106953: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107026: () => { if (document.fullscreenElement) return 1; },  
 107072: () => { return document.getElementById('canvas').width; },  
 107124: () => { return screen.width; },  
 107149: () => { document.exitFullscreen(); },  
 107176: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107309: () => { return window.innerWidth; },  
 107335: () => { return window.innerHeight; },  
 107362: () => { if (document.fullscreenElement) return 1; },  
 107408: () => { return document.getElementById('canvas').width; },  
 107460: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107528: () => { if (document.fullscreenElement) return 1; },  
 107574: () => { return document.getElementById('canvas').width; },  
 107626: () => { return screen.width; },  
 107651: () => { return window.innerWidth; },  
 107677: () => { return window.innerHeight; },  
 ...
 107827: () => { document.exitFullscreen(); },  
 107854: () => { if (document.fullscreenElement) return 1; },  
 107900: () => { return document.getElementById('canvas').width; },  
 107952: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108020: () => { document.exitFullscreen(); },  
 108047: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 108105: () => { return screen.width; },  
 108130: () => { return screen.height; },  
 108156: () => { return window.screenX; },  
 108183: () => { return window.screenY; },  
 108210: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 108263: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 108334: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 108391: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108647: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108718: () => { if (document.fullscreenElement) return 1; },  
 108764: () => { return window.innerWidth; },  
 108790: () => { return window.innerHeight; },  
 108817: () => { if (document.pointerLockElement) return 1; },  
