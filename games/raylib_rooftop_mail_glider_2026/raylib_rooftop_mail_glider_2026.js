...
function findWasmBinary() {
  return locateFile('raylib_rooftop_mail_glider_2026.wasm');
}
...
var ASM_CONSTS = {
  99200: () => { if (document.fullscreenElement) return 1; },  
 99246: () => { return document.getElementById('canvas').width; },  
 99298: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99366: () => { document.exitFullscreen(); },  
 99393: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99466: () => { if (document.fullscreenElement) return 1; },  
 99512: () => { return document.getElementById('canvas').width; },  
 99564: () => { return screen.width; },  
 99589: () => { document.exitFullscreen(); },  
 99616: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99749: () => { return window.innerWidth; },  
 99775: () => { return window.innerHeight; },  
 99802: () => { if (document.fullscreenElement) return 1; },  
 99848: () => { return document.getElementById('canvas').width; },  
 99900: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99968: () => { if (document.fullscreenElement) return 1; },  
 100014: () => { return document.getElementById('canvas').width; },  
 100066: () => { return screen.width; },  
 100091: () => { return window.innerWidth; },  
 100117: () => { return window.innerHeight; },  
 ...
 100267: () => { document.exitFullscreen(); },  
 100294: () => { if (document.fullscreenElement) return 1; },  
 100340: () => { return document.getElementById('canvas').width; },  
 100392: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100460: () => { document.exitFullscreen(); },  
 100487: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100545: () => { return screen.width; },  
 100570: () => { return screen.height; },  
 100596: () => { return window.screenX; },  
 100623: () => { return window.screenY; },  
 100650: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100703: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100774: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100831: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101087: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101158: () => { if (document.fullscreenElement) return 1; },  
 101204: () => { return window.innerWidth; },  
 101230: () => { return window.innerHeight; },  
 101257: () => { if (document.pointerLockElement) return 1; }
};
