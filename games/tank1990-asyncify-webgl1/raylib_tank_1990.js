...
// include: /tmp/force_webgl1_simple.pre.js
...
Module.preRun.push(function() {
  ...
  const orig = Browser.createContext;
  Browser.createContext = function(canvas, useWebGL, setInModule, attrs) {
    if (useWebGL) {
      const nextAttrs = attrs ? { ...attrs } : {};
      nextAttrs.majorVersion = 1;
      return orig.call(Browser, canvas, useWebGL, setInModule, nextAttrs);
    }
    return orig.call(Browser, canvas, useWebGL, setInModule, attrs);
  };
});
// end include: /tmp/force_webgl1_simple.pre.js
