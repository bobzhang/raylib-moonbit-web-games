...
var ASM_CONSTS = {
  99936: () => { if (document.fullscreenElement) return 1; },  
 99982: () => { return document.getElementById('canvas').width; },  
 100034: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100102: () => { document.exitFullscreen(); },  
 100129: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100202: () => { if (document.fullscreenElement) return 1; },  
 100248: () => { return document.getElementById('canvas').width; },  
 100300: () => { return screen.width; },  
 100325: () => { document.exitFullscreen(); },  
 100352: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100485: () => { return window.innerWidth; },  
 100511: () => { return window.innerHeight; },  
 100538: () => { if (document.fullscreenElement) return 1; },  
 100584: () => { return document.getElementById('canvas').width; },  
 100636: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100704: () => { if (document.fullscreenElement) return 1; },  
 100750: () => { return document.getElementById('canvas').width; },  
 100802: () => { return screen.width; },  
 100827: () => { return window.innerWidth; },  
 100853: () => { return window.innerHeight; },  
 100880: () => { if (document.fullscreenElement) return 1; },  
 100926: () => { return document.getElementById('canvas').width; },  
 100978: () => { return screen.width; },  
 101003: () => { document.exitFullscreen(); },  
 101030: () => { if (document.fullscreenElement) return 1; },  
 101076: () => { return document.getElementById('canvas').width; },  
 101128: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101196: () => { document.exitFullscreen(); },  
 101223: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101281: () => { return screen.width; },  
 101306: () => { return screen.height; },  
 101332: () => { return window.screenX; },  
 101359: () => { return window.screenY; },  
 101386: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101439: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101510: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101567: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101823: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101894: () => { if (document.fullscreenElement) return 1; },  
 101940: () => { return window.innerWidth; },  
 101966: () => { return window.innerHeight; },  
 101993: () => { if (document.pointerLockElement) return 1; }
};
