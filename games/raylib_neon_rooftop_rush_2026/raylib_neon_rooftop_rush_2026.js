...
var ASM_CONSTS = {
  106360: () => { if (document.fullscreenElement) return 1; },  
 106406: () => { return document.getElementById('canvas').width; },  
 106458: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106526: () => { document.exitFullscreen(); },  
 106553: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106626: () => { if (document.fullscreenElement) return 1; },  
 106672: () => { return document.getElementById('canvas').width; },  
 106724: () => { return screen.width; },  
 106749: () => { document.exitFullscreen(); },  
 106776: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 106909: () => { return window.innerWidth; },  
 106935: () => { return window.innerHeight; },  
 106962: () => { if (document.fullscreenElement) return 1; },  
 107008: () => { return document.getElementById('canvas').width; },  
 107060: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 107251: () => { return window.innerWidth; },  
 107277: () => { return window.innerHeight; },  
