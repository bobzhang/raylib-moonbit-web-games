...
function findWasmBinary() {
  return locateFile('raylib_drone_show_director_2026.wasm');
}
...
var ASM_CONSTS = {
  99632: () => { if (document.fullscreenElement) return 1; },  
 99678: () => { return document.getElementById('canvas').width; },  
 99730: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99798: () => { document.exitFullscreen(); },  
 99825: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99898: () => { if (document.fullscreenElement) return 1; },  
 99944: () => { return document.getElementById('canvas').width; },  
 99996: () => { return screen.width; },  
 100021: () => { document.exitFullscreen(); },  
 100048: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100181: () => { return window.innerWidth; },  
 100207: () => { return window.innerHeight; },  
 100234: () => { if (document.fullscreenElement) return 1; },  
 100280: () => { return document.getElementById('canvas').width; },  
 100332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100400: () => { if (document.fullscreenElement) return 1; },  
 100446: () => { return document.getElementById('canvas').width; },  
 100498: () => { return screen.width; },  
 100523: () => { return window.innerWidth; },  
 100549: () => { return window.innerHeight; },  
 100576: () => { if (document.fullscreenElement) return 1; },  
 100622: () => { return document.getElementById('canvas').width; },  
 100674: () => { return screen.width; },  
 100699: () => { document.exitFullscreen(); },  
 100726: () => { if (document.fullscreenElement) return 1; },  
 100772: () => { return document.getElementById('canvas').width; },  
 100824: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100892: () => { document.exitFullscreen(); },  
 100919: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100977: () => { return screen.width; },  
 101002: () => { return screen.height; },  
 101028: () => { return window.screenX; },  
 101055: () => { return window.screenY; },  
 101082: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101135: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101206: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101263: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101519: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101590: () => { if (document.fullscreenElement) return 1; },  
 101636: () => { return window.innerWidth; },  
 101662: () => { return window.innerHeight; },  
 101689: () => { if (document.pointerLockElement) return 1; }
};
