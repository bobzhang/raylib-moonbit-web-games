...
var ASM_CONSTS = {
  145808: () => { if (document.fullscreenElement) return 1; },  
 145854: () => { return document.getElementById('canvas').width; },  
 145906: () => { return parseInt(document.getElementById('canvas').style.width); },  
 145974: () => { document.exitFullscreen(); },  
 146001: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 146074: () => { if (document.fullscreenElement) return 1; },  
 146120: () => { return document.getElementById('canvas').width; },  
 146172: () => { return screen.width; },  
 146197: () => { document.exitFullscreen(); },  
 146224: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 146357: () => { return window.innerWidth; },  
 146383: () => { return window.innerHeight; },  
 146410: () => { if (document.fullscreenElement) return 1; },  
 146456: () => { return document.getElementById('canvas').width; },  
 146508: () => { return parseInt(document.getElementById('canvas').style.width); },  
 146576: () => { if (document.fullscreenElement) return 1; },  
 146622: () => { return document.getElementById('canvas').width; },  
 146674: () => { return screen.width; },  
 146699: () => { return window.innerWidth; },  
 146725: () => { return window.innerHeight; },  
 ...
 146875: () => { document.exitFullscreen(); },  
 146902: () => { if (document.fullscreenElement) return 1; },  
 146948: () => { return document.getElementById('canvas').width; },  
 147000: () => { return parseInt(document.getElementById('canvas').style.width); },  
 147068: () => { document.exitFullscreen(); },  
 147095: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 147153: () => { return screen.width; },  
 147178: () => { return screen.height; },  
 147204: () => { return window.screenX; },  
 147231: () => { return window.screenY; },  
 147258: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 147311: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 147382: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 147439: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 147695: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 147766: () => { if (document.fullscreenElement) return 1; },  
 147812: () => { return window.innerWidth; },  
 147838: () => { return window.innerHeight; },  
 147865: () => { if (document.pointerLockElement) return 1; }
};
