...
var ASM_CONSTS = {
  97392: () => { if (document.fullscreenElement) return 1; },  
 97438: () => { return document.getElementById('canvas').width; },  
 97490: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97558: () => { document.exitFullscreen(); },  
 97585: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97658: () => { if (document.fullscreenElement) return 1; },  
 97704: () => { return document.getElementById('canvas').width; },  
 97756: () => { return screen.width; },  
 97781: () => { document.exitFullscreen(); },  
 97808: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97941: () => { return window.innerWidth; },  
 97967: () => { return window.innerHeight; },  
 97994: () => { if (document.fullscreenElement) return 1; },  
 98040: () => { return document.getElementById('canvas').width; },  
 98092: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98160: () => { if (document.fullscreenElement) return 1; },  
 98206: () => { return document.getElementById('canvas').width; },  
 98258: () => { return screen.width; },  
 98283: () => { return window.innerWidth; },  
 98309: () => { return window.innerHeight; },  
 98336: () => { if (document.fullscreenElement) return 1; },  
 98382: () => { return document.getElementById('canvas').width; },  
 98434: () => { return screen.width; },  
 98459: () => { document.exitFullscreen(); },  
 98486: () => { if (document.fullscreenElement) return 1; },  
 98532: () => { return document.getElementById('canvas').width; },  
 98584: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98652: () => { document.exitFullscreen(); },  
 98679: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98737: () => { return screen.width; },  
 98762: () => { return screen.height; },  
 98788: () => { return window.screenX; },  
 98815: () => { return window.screenY; },  
 98842: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98895: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98966: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99023: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99279: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99350: () => { if (document.fullscreenElement) return 1; },  
 99396: () => { return window.innerWidth; },  
 99422: () => { return window.innerHeight; },  
 99449: () => { if (document.pointerLockElement) return 1; }
};
