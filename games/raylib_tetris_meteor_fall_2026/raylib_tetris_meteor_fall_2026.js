...
function findWasmBinary() {
  return locateFile('raylib_tetris_meteor_fall_2026.wasm');
}
...
var ASM_CONSTS = {
  97232: () => { if (document.fullscreenElement) return 1; },  
 97278: () => { return document.getElementById('canvas').width; },  
 97330: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97398: () => { document.exitFullscreen(); },  
 97425: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97498: () => { if (document.fullscreenElement) return 1; },  
 97544: () => { return document.getElementById('canvas').width; },  
 97596: () => { return screen.width; },  
 97621: () => { document.exitFullscreen(); },  
 97648: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97781: () => { return window.innerWidth; },  
 97807: () => { return window.innerHeight; },  
 97834: () => { if (document.fullscreenElement) return 1; },  
 97880: () => { return document.getElementById('canvas').width; },  
 97932: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98000: () => { if (document.fullscreenElement) return 1; },  
 98046: () => { return document.getElementById('canvas').width; },  
 98098: () => { return screen.width; },  
 98123: () => { return window.innerWidth; },  
 98149: () => { return window.innerHeight; },  
 98176: () => { if (document.fullscreenElement) return 1; },  
 98222: () => { return document.getElementById('canvas').width; },  
 98274: () => { return screen.width; },  
 98299: () => { document.exitFullscreen(); },  
 98326: () => { if (document.fullscreenElement) return 1; },  
 98372: () => { return document.getElementById('canvas').width; },  
 98424: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98492: () => { document.exitFullscreen(); },  
 98519: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98577: () => { return screen.width; },  
 98602: () => { return screen.height; },  
 98628: () => { return window.screenX; },  
 98655: () => { return window.screenY; },  
 98682: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98735: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98806: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98863: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99119: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99190: () => { if (document.fullscreenElement) return 1; },  
 99236: () => { return window.innerWidth; },  
 99262: () => { return window.innerHeight; },  
 99289: () => { if (document.pointerLockElement) return 1; }
};
