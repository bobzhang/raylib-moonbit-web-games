...
function findWasmBinary() {
  return locateFile('raylib_void_anchor_raid_2026.wasm');
}
...
var ASM_CONSTS = {
  98800: () => { if (document.fullscreenElement) return 1; },  
 98846: () => { return document.getElementById('canvas').width; },  
 98898: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98966: () => { document.exitFullscreen(); },  
 98993: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99066: () => { if (document.fullscreenElement) return 1; },  
 99112: () => { return document.getElementById('canvas').width; },  
 99164: () => { return screen.width; },  
 99189: () => { document.exitFullscreen(); },  
 99216: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99349: () => { return window.innerWidth; },  
 99375: () => { return window.innerHeight; },  
 99402: () => { if (document.fullscreenElement) return 1; },  
 99448: () => { return document.getElementById('canvas').width; },  
 99500: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99568: () => { if (document.fullscreenElement) return 1; },  
 99614: () => { return document.getElementById('canvas').width; },  
 99666: () => { return screen.width; },  
 99691: () => { return window.innerWidth; },  
 99717: () => { return window.innerHeight; },  
 99744: () => { if (document.fullscreenElement) return 1; },  
 99790: () => { return document.getElementById('canvas').width; },  
 99842: () => { return screen.width; },  
 99867: () => { document.exitFullscreen(); },  
 99894: () => { if (document.fullscreenElement) return 1; },  
 99940: () => { return document.getElementById('canvas').width; },  
 99992: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100060: () => { document.exitFullscreen(); },  
 100087: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100145: () => { return screen.width; },  
 100170: () => { return screen.height; },  
 100196: () => { return window.screenX; },  
 100223: () => { return window.screenY; },  
 100250: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100303: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100374: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100431: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100687: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100758: () => { if (document.fullscreenElement) return 1; },  
 100804: () => { return window.innerWidth; },  
 100830: () => { return window.innerHeight; },  
 100857: () => { if (document.pointerLockElement) return 1; }
};
