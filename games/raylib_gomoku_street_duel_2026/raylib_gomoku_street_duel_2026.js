...
var ASM_CONSTS = {
 ...
 98370: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98438: () => { document.exitFullscreen(); },  
 98465: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98538: () => { if (document.fullscreenElement) return 1; },  
 98584: () => { return document.getElementById('canvas').width; },  
 98636: () => { return screen.width; },  
 98661: () => { document.exitFullscreen(); },  
 98688: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98821: () => { return window.innerWidth; },  
 98847: () => { return window.innerHeight; },  
 ...
 99163: () => { return window.innerWidth; },  
 99189: () => { return window.innerHeight; },  
 99216: () => { if (document.fullscreenElement) return 1; },  
 99262: () => { return document.getElementById('canvas').width; },  
 99314: () => { return screen.width; },  
 99339: () => { document.exitFullscreen(); },  
 99366: () => { if (document.fullscreenElement) return 1; },  
 99412: () => { return document.getElementById('canvas').width; },  
 99464: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99532: () => { document.exitFullscreen(); },  
 99559: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99617: () => { return screen.width; },  
 99642: () => { return screen.height; },  
 99668: () => { return window.screenX; },  
 99695: () => { return window.screenY; },  
 99722: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99775: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99846: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99903: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100159: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100230: () => { if (document.fullscreenElement) return 1; },  
 100276: () => { return window.innerWidth; },  
 100302: () => { return window.innerHeight; },  
 100329: () => { if (document.pointerLockElement) return 1; }
};
