...
function findWasmBinary() {
  return locateFile('raylib_gomoku_street_duel_2026.wasm');
}
...
var ASM_CONSTS = {
  98304: () => { if (document.fullscreenElement) return 1; },  
 98350: () => { return document.getElementById('canvas').width; },  
 98402: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98470: () => { document.exitFullscreen(); },  
 98497: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98570: () => { if (document.fullscreenElement) return 1; },  
 98616: () => { return document.getElementById('canvas').width; },  
 98668: () => { return screen.width; },  
 98693: () => { document.exitFullscreen(); },  
 98720: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98853: () => { return window.innerWidth; },  
 98879: () => { return window.innerHeight; },  
 98906: () => { if (document.fullscreenElement) return 1; },  
 98952: () => { return document.getElementById('canvas').width; },  
 99004: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99072: () => { if (document.fullscreenElement) return 1; },  
 99118: () => { return document.getElementById('canvas').width; },  
 99170: () => { return screen.width; },  
 99195: () => { return window.innerWidth; },  
 99221: () => { return window.innerHeight; },  
 99248: () => { if (document.fullscreenElement) return 1; },  
 99294: () => { return document.getElementById('canvas').width; },  
 99346: () => { return screen.width; },  
 99371: () => { document.exitFullscreen(); },  
 99398: () => { if (document.fullscreenElement) return 1; },  
 99444: () => { return document.getElementById('canvas').width; },  
 99496: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99564: () => { document.exitFullscreen(); },  
 99591: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99649: () => { return screen.width; },  
 99674: () => { return screen.height; },  
 99700: () => { return window.screenX; },  
 99727: () => { return window.screenY; },  
 99754: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99807: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99878: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99935: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100191: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100262: () => { if (document.fullscreenElement) return 1; },  
 100308: () => { return window.innerWidth; },  
 100334: () => { return window.innerHeight; },  
 100361: () => { if (document.pointerLockElement) return 1; }
};
