...
var ASM_CONSTS = {
  106632: () => { if (document.fullscreenElement) return 1; },  
 106678: () => { return document.getElementById('canvas').width; },  
 106730: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106798: () => { document.exitFullscreen(); },  
 106825: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106898: () => { if (document.fullscreenElement) return 1; },  
 106944: () => { return document.getElementById('canvas').width; },  
 106996: () => { return screen.width; },  
 107021: () => { document.exitFullscreen(); },  
 107048: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107181: () => { return window.innerWidth; },  
 107207: () => { return window.innerHeight; },  
 107234: () => { if (document.fullscreenElement) return 1; },  
 107280: () => { return document.getElementById('canvas').width; },  
 107332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107400: () => { if (document.fullscreenElement) return 1; },  
 107446: () => { return document.getElementById('canvas').width; },  
 107498: () => { return screen.width; },  
 107523: () => { return window.innerWidth; },  
 107549: () => { return window.innerHeight; },  
