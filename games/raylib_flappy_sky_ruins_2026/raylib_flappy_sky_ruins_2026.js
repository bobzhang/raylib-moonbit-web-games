...
var ASM_CONSTS = {
  106648: () => { if (document.fullscreenElement) return 1; },  
 106694: () => { return document.getElementById('canvas').width; },  
 106746: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106814: () => { document.exitFullscreen(); },  
 106841: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106914: () => { if (document.fullscreenElement) return 1; },  
 106960: () => { return document.getElementById('canvas').width; },  
 107012: () => { return screen.width; },  
 107037: () => { document.exitFullscreen(); },  
 107064: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107197: () => { return window.innerWidth; },  
 107223: () => { return window.innerHeight; },  
 107250: () => { if (document.fullscreenElement) return 1; },  
 107296: () => { return document.getElementById('canvas').width; },  
 107348: () => { return parseInt(document.getElementById('canvas').style.width); },  
