...
var ASM_CONSTS = {
 ...
 107722: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107790: () => { document.exitFullscreen(); },  
 107817: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107890: () => { if (document.fullscreenElement) return 1; },  
 107936: () => { return document.getElementById('canvas').width; },  
 107988: () => { return screen.width; },  
 108013: () => { document.exitFullscreen(); },  
 108040: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108173: () => { return window.innerWidth; },  
 108199: () => { return window.innerHeight; },  
 108226: () => { if (document.fullscreenElement) return 1; },  
 108272: () => { return document.getElementById('canvas').width; },  
 108324: () => { return parseInt(document.getElementById('canvas').style.width); },  
