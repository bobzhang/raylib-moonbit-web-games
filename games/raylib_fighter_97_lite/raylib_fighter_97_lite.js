...
var ASM_CONSTS = {
  102544: () => { if (document.fullscreenElement) return 1; },  
 102590: () => { return document.getElementById('canvas').width; },  
 102642: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102710: () => { document.exitFullscreen(); },  
 102737: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 102810: () => { if (document.fullscreenElement) return 1; },  
 102856: () => { return document.getElementById('canvas').width; },  
 102908: () => { return screen.width; },  
 102933: () => { document.exitFullscreen(); },  
 102960: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 103093: () => { return window.innerWidth; },  
 103119: () => { return window.innerHeight; },  
 103146: () => { if (document.fullscreenElement) return 1; },  
 103192: () => { return document.getElementById('canvas').width; },  
 103244: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103312: () => { if (document.fullscreenElement) return 1; },  
 103358: () => { return document.getElementById('canvas').width; },  
 103410: () => { return screen.width; },  
 103435: () => { return window.innerWidth; },  
 103461: () => { return window.innerHeight; },  
 103488: () => { if (document.fullscreenElement) return 1; },  
 103534: () => { return document.getElementById('canvas').width; },  
 103586: () => { return screen.width; },  
 103611: () => { document.exitFullscreen(); },  
 103638: () => { if (document.fullscreenElement) return 1; },  
 103684: () => { return document.getElementById('canvas').width; },  
 103736: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103804: () => { document.exitFullscreen(); },  
 103831: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 103889: () => { return screen.width; },  
 103914: () => { return screen.height; },  
 103940: () => { return window.screenX; },  
 103967: () => { return window.screenY; },  
 103994: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 104047: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 104118: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 104175: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 104431: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 104502: () => { if (document.fullscreenElement) return 1; },  
 104548: () => { return window.innerWidth; },  
 104574: () => { return window.innerHeight; },  
 104601: () => { if (document.pointerLockElement) return 1; }
};
