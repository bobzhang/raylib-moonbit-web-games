...
var ASM_CONSTS = {
 ...
 103873: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103946: () => { if (document.fullscreenElement) return 1; },  
 103992: () => { return document.getElementById('canvas').width; },  
 104044: () => { return screen.width; },  
 104069: () => { document.exitFullscreen(); },  
 104096: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 104229: () => { return window.innerWidth; },  
 104255: () => { return window.innerHeight; },  
 104282: () => { if (document.fullscreenElement) return 1; },  
 104328: () => { return document.getElementById('canvas').width; },  
 104380: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104448: () => { if (document.fullscreenElement) return 1; },  
 104494: () => { return document.getElementById('canvas').width; },  
 104546: () => { return screen.width; },  
 104571: () => { return window.innerWidth; },  
 104597: () => { return window.innerHeight; },  
 104624: () => { if (document.fullscreenElement) return 1; },  
 104670: () => { return document.getElementById('canvas').width; },  
 104722: () => { return screen.width; },  
 104747: () => { document.exitFullscreen(); },  
 104774: () => { if (document.fullscreenElement) return 1; },  
 104820: () => { return document.getElementById('canvas').width; },  
 104872: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104940: () => { document.exitFullscreen(); },  
 104967: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 105025: () => { return screen.width; },  
 105050: () => { return screen.height; },  
 105076: () => { return window.screenX; },  
 105103: () => { return window.screenY; },  
 105130: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 105183: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 105254: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 105311: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 105567: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 105638: () => { if (document.fullscreenElement) return 1; },  
 105684: () => { return window.innerWidth; },  
 105710: () => { return window.innerHeight; },  
 105737: () => { if (document.pointerLockElement) return 1; }
};
