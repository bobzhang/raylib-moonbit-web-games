...
function findWasmBinary() {
  return locateFile('raylib_fighter_97_lite.wasm');
}
...
var ASM_CONSTS = {
  103616: () => { if (document.fullscreenElement) return 1; },  
 103662: () => { return document.getElementById('canvas').width; },  
 103714: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103782: () => { document.exitFullscreen(); },  
 103809: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103882: () => { if (document.fullscreenElement) return 1; },  
 103928: () => { return document.getElementById('canvas').width; },  
 103980: () => { return screen.width; },  
 104005: () => { document.exitFullscreen(); },  
 104032: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 104165: () => { return window.innerWidth; },  
 104191: () => { return window.innerHeight; },  
 104218: () => { if (document.fullscreenElement) return 1; },  
 104264: () => { return document.getElementById('canvas').width; },  
 104316: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104384: () => { if (document.fullscreenElement) return 1; },  
 104430: () => { return document.getElementById('canvas').width; },  
 104482: () => { return screen.width; },  
 104507: () => { return window.innerWidth; },  
 104533: () => { return window.innerHeight; },  
 104560: () => { if (document.fullscreenElement) return 1; },  
 104606: () => { return document.getElementById('canvas').width; },  
 104658: () => { return screen.width; },  
 104683: () => { document.exitFullscreen(); },  
 104710: () => { if (document.fullscreenElement) return 1; },  
 104756: () => { return document.getElementById('canvas').width; },  
 104808: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104876: () => { document.exitFullscreen(); },  
 104903: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 104961: () => { return screen.width; },  
 104986: () => { return screen.height; },  
 105012: () => { return window.screenX; },  
 105039: () => { return window.screenY; },  
 105066: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 105119: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 105190: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 105247: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 105503: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 105574: () => { if (document.fullscreenElement) return 1; },  
 105620: () => { return window.innerWidth; },  
 105646: () => { return window.innerHeight; },  
 105673: () => { if (document.pointerLockElement) return 1; }
};
