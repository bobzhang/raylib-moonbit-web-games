...
var ASM_CONSTS = {
  103664: () => { if (document.fullscreenElement) return 1; },  
 103710: () => { return document.getElementById('canvas').width; },  
 103762: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103830: () => { document.exitFullscreen(); },  
 103857: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103930: () => { if (document.fullscreenElement) return 1; },  
 103976: () => { return document.getElementById('canvas').width; },  
 104028: () => { return screen.width; },  
 104053: () => { document.exitFullscreen(); },  
 104080: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 104213: () => { return window.innerWidth; },  
 104239: () => { return window.innerHeight; },  
 104266: () => { if (document.fullscreenElement) return 1; },  
 104312: () => { return document.getElementById('canvas').width; },  
 104364: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104432: () => { if (document.fullscreenElement) return 1; },  
 104478: () => { return document.getElementById('canvas').width; },  
 104530: () => { return screen.width; },  
 104555: () => { return window.innerWidth; },  
 104581: () => { return window.innerHeight; },  
 104608: () => { if (document.fullscreenElement) return 1; },  
 104654: () => { return document.getElementById('canvas').width; },  
 104706: () => { return screen.width; },  
 104731: () => { document.exitFullscreen(); },  
 104758: () => { if (document.fullscreenElement) return 1; },  
 104804: () => { return document.getElementById('canvas').width; },  
 104856: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104924: () => { document.exitFullscreen(); },  
 104951: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 105009: () => { return screen.width; },  
 105034: () => { return screen.height; },  
 105060: () => { return window.screenX; },  
 105087: () => { return window.screenY; },  
 105114: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 105167: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 105238: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 105295: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 105551: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 105622: () => { if (document.fullscreenElement) return 1; },  
 105668: () => { return window.innerWidth; },  
 105694: () => { return window.innerHeight; },  
 105721: () => { if (document.pointerLockElement) return 1; }
};
