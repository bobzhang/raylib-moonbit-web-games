...
var ASM_CONSTS = {
  99456: () => { if (document.fullscreenElement) return 1; },  
 99502: () => { return document.getElementById('canvas').width; },  
 99554: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99622: () => { document.exitFullscreen(); },  
 99649: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99722: () => { if (document.fullscreenElement) return 1; },  
 99768: () => { return document.getElementById('canvas').width; },  
 99820: () => { return screen.width; },  
 99845: () => { document.exitFullscreen(); },  
 99872: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100005: () => { return window.innerWidth; },  
 100031: () => { return window.innerHeight; },  
 100058: () => { if (document.fullscreenElement) return 1; },  
 100104: () => { return document.getElementById('canvas').width; },  
 100156: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100224: () => { if (document.fullscreenElement) return 1; },  
 100270: () => { return document.getElementById('canvas').width; },  
 100322: () => { return screen.width; },  
 100347: () => { return window.innerWidth; },  
 100373: () => { return window.innerHeight; },  
 ...
 100523: () => { document.exitFullscreen(); },  
 100550: () => { if (document.fullscreenElement) return 1; },  
 100596: () => { return document.getElementById('canvas').width; },  
 100648: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100716: () => { document.exitFullscreen(); },  
 100743: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100801: () => { return screen.width; },  
 100826: () => { return screen.height; },  
 100852: () => { return window.screenX; },  
 100879: () => { return window.screenY; },  
 100906: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100959: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101030: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101087: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101343: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101414: () => { if (document.fullscreenElement) return 1; },  
 101460: () => { return window.innerWidth; },  
 101486: () => { return window.innerHeight; },  
 101513: () => { if (document.pointerLockElement) return 1; }
};
