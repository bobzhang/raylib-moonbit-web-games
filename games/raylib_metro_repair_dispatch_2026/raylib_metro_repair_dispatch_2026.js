...
var ASM_CONSTS = {
  99472: () => { if (document.fullscreenElement) return 1; },  
 99518: () => { return document.getElementById('canvas').width; },  
 99570: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99638: () => { document.exitFullscreen(); },  
 99665: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99738: () => { if (document.fullscreenElement) return 1; },  
 99784: () => { return document.getElementById('canvas').width; },  
 99836: () => { return screen.width; },  
 99861: () => { document.exitFullscreen(); },  
 99888: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100021: () => { return window.innerWidth; },  
 100047: () => { return window.innerHeight; },  
 100074: () => { if (document.fullscreenElement) return 1; },  
 100120: () => { return document.getElementById('canvas').width; },  
 100172: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100363: () => { return window.innerWidth; },  
 100389: () => { return window.innerHeight; },  
 ...
 100612: () => { return document.getElementById('canvas').width; },  
 100664: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100732: () => { document.exitFullscreen(); },  
 100759: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100817: () => { return screen.width; },  
 100842: () => { return screen.height; },  
 100868: () => { return window.screenX; },  
 100895: () => { return window.screenY; },  
 100922: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100975: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101046: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101103: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101359: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101430: () => { if (document.fullscreenElement) return 1; },  
 101476: () => { return window.innerWidth; },  
 101502: () => { return window.innerHeight; },  
 101529: () => { if (document.pointerLockElement) return 1; }
};
