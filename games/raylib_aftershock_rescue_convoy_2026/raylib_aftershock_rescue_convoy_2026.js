...
var ASM_CONSTS = {
  99600: () => { if (document.fullscreenElement) return 1; },  
 99646: () => { return document.getElementById('canvas').width; },  
 99698: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99766: () => { document.exitFullscreen(); },  
 99793: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99866: () => { if (document.fullscreenElement) return 1; },  
 99912: () => { return document.getElementById('canvas').width; },  
 99964: () => { return screen.width; },  
 99989: () => { document.exitFullscreen(); },  
 100016: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100149: () => { return window.innerWidth; },  
 100175: () => { return window.innerHeight; },  
 100202: () => { if (document.fullscreenElement) return 1; },  
 100248: () => { return document.getElementById('canvas').width; },  
 100300: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100368: () => { if (document.fullscreenElement) return 1; },  
 100414: () => { return document.getElementById('canvas').width; },  
 100466: () => { return screen.width; },  
 100491: () => { return window.innerWidth; },  
 100517: () => { return window.innerHeight; },  
 ...
 100667: () => { document.exitFullscreen(); },  
 100694: () => { if (document.fullscreenElement) return 1; },  
 100740: () => { return document.getElementById('canvas').width; },  
 100792: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100860: () => { document.exitFullscreen(); },  
 100887: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100945: () => { return screen.width; },  
 100970: () => { return screen.height; },  
 100996: () => { return window.screenX; },  
 101023: () => { return window.screenY; },  
 101050: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101103: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101174: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101231: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101487: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101558: () => { if (document.fullscreenElement) return 1; },  
 101604: () => { return window.innerWidth; },  
 101630: () => { return window.innerHeight; },  
 101657: () => { if (document.pointerLockElement) return 1; }
};
