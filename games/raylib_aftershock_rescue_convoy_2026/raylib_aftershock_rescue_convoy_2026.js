...
function findWasmBinary() {
  return locateFile('raylib_aftershock_rescue_convoy_2026.wasm');
}
...
var ASM_CONSTS = {
  99776: () => { if (document.fullscreenElement) return 1; },  
 99822: () => { return document.getElementById('canvas').width; },  
 99874: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99942: () => { document.exitFullscreen(); },  
 99969: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100042: () => { if (document.fullscreenElement) return 1; },  
 100088: () => { return document.getElementById('canvas').width; },  
 100140: () => { return screen.width; },  
 100165: () => { document.exitFullscreen(); },  
 100192: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100325: () => { return window.innerWidth; },  
 100351: () => { return window.innerHeight; },  
 100378: () => { if (document.fullscreenElement) return 1; },  
 100424: () => { return document.getElementById('canvas').width; },  
 100476: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100544: () => { if (document.fullscreenElement) return 1; },  
 100590: () => { return document.getElementById('canvas').width; },  
 100642: () => { return screen.width; },  
 100667: () => { return window.innerWidth; },  
 100693: () => { return window.innerHeight; },  
 ...
 100843: () => { document.exitFullscreen(); },  
 100870: () => { if (document.fullscreenElement) return 1; },  
 100916: () => { return document.getElementById('canvas').width; },  
 100968: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101036: () => { document.exitFullscreen(); },  
 101063: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101121: () => { return screen.width; },  
 101146: () => { return screen.height; },  
 101172: () => { return window.screenX; },  
 101199: () => { return window.screenY; },  
 101226: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101279: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101350: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101407: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101663: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101734: () => { if (document.fullscreenElement) return 1; },  
 101780: () => { return window.innerWidth; },  
 101806: () => { return window.innerHeight; },  
 101833: () => { if (document.pointerLockElement) return 1; }
};
