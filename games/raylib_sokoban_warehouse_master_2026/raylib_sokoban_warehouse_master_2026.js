...
var ASM_CONSTS = {
  98912: () => { if (document.fullscreenElement) return 1; },  
 98958: () => { return document.getElementById('canvas').width; },  
 99010: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99078: () => { document.exitFullscreen(); },  
 99105: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99178: () => { if (document.fullscreenElement) return 1; },  
 99224: () => { return document.getElementById('canvas').width; },  
 99276: () => { return screen.width; },  
 99301: () => { document.exitFullscreen(); },  
 99328: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99461: () => { return window.innerWidth; },  
 99487: () => { return window.innerHeight; },  
 99514: () => { if (document.fullscreenElement) return 1; },  
 99560: () => { return document.getElementById('canvas').width; },  
 99612: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99680: () => { if (document.fullscreenElement) return 1; },  
 99726: () => { return document.getElementById('canvas').width; },  
 99778: () => { return screen.width; },  
 99803: () => { return window.innerWidth; },  
 99829: () => { return window.innerHeight; },  
 99856: () => { if (document.fullscreenElement) return 1; },  
 99902: () => { return document.getElementById('canvas').width; },  
 99954: () => { return screen.width; },  
 99979: () => { document.exitFullscreen(); },  
 100006: () => { if (document.fullscreenElement) return 1; },  
 100052: () => { return document.getElementById('canvas').width; },  
 100104: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100172: () => { document.exitFullscreen(); },  
 100199: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100257: () => { return screen.width; },  
 100282: () => { return screen.height; },  
 100308: () => { return window.screenX; },  
 100335: () => { return window.screenY; },  
 100362: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100415: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100486: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100543: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100799: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100870: () => { if (document.fullscreenElement) return 1; },  
 100916: () => { return window.innerWidth; },  
 100942: () => { return window.innerHeight; },  
 100969: () => { if (document.pointerLockElement) return 1; }
};
