...
function findWasmBinary() {
  return locateFile('raylib_sokoban_warehouse_master_2026.wasm');
}
...
var ASM_CONSTS = {
  99024: () => { if (document.fullscreenElement) return 1; },  
 99070: () => { return document.getElementById('canvas').width; },  
 99122: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99190: () => { document.exitFullscreen(); },  
 99217: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99290: () => { if (document.fullscreenElement) return 1; },  
 99336: () => { return document.getElementById('canvas').width; },  
 99388: () => { return screen.width; },  
 99413: () => { document.exitFullscreen(); },  
 99440: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99573: () => { return window.innerWidth; },  
 99599: () => { return window.innerHeight; },  
 99626: () => { if (document.fullscreenElement) return 1; },  
 99672: () => { return document.getElementById('canvas').width; },  
 99724: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99792: () => { if (document.fullscreenElement) return 1; },  
 99838: () => { return document.getElementById('canvas').width; },  
 99890: () => { return screen.width; },  
 99915: () => { return window.innerWidth; },  
 99941: () => { return window.innerHeight; },  
 99968: () => { if (document.fullscreenElement) return 1; },  
 100014: () => { return document.getElementById('canvas').width; },  
 100066: () => { return screen.width; },  
 100091: () => { document.exitFullscreen(); },  
 100118: () => { if (document.fullscreenElement) return 1; },  
 100164: () => { return document.getElementById('canvas').width; },  
 100216: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100284: () => { document.exitFullscreen(); },  
 100311: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100369: () => { return screen.width; },  
 100394: () => { return screen.height; },  
 100420: () => { return window.screenX; },  
 100447: () => { return window.screenY; },  
 100474: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100527: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100598: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100655: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100911: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100982: () => { if (document.fullscreenElement) return 1; },  
 101028: () => { return window.innerWidth; },  
 101054: () => { return window.innerHeight; },  
 101081: () => { if (document.pointerLockElement) return 1; }
};
