...
function findWasmBinary() {
  return locateFile('raylib_ftl_2012_lite.wasm');
}
...
var ASM_CONSTS = {
  2382352: () => { if (document.fullscreenElement) return 1; },  
 2382398: () => { return document.getElementById('canvas').width; },  
 2382450: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2382518: () => { document.exitFullscreen(); },  
 2382545: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 2382618: () => { if (document.fullscreenElement) return 1; },  
 2382664: () => { return document.getElementById('canvas').width; },  
 2382716: () => { return screen.width; },  
 2382741: () => { document.exitFullscreen(); },  
 2382768: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2382901: () => { return window.innerWidth; },  
 2382927: () => { return window.innerHeight; },  
 2382954: () => { if (document.fullscreenElement) return 1; },  
 2383000: () => { return document.getElementById('canvas').width; },  
 2383052: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2383120: () => { if (document.fullscreenElement) return 1; },  
 2383166: () => { return document.getElementById('canvas').width; },  
 2383218: () => { return screen.width; },  
 2383243: () => { return window.innerWidth; },  
 2383269: () => { return window.innerHeight; },  
 2383296: () => { if (document.fullscreenElement) return 1; },  
 2383342: () => { return document.getElementById('canvas').width; },  
 2383394: () => { return screen.width; },  
 2383419: () => { document.exitFullscreen(); },  
 2383446: () => { if (document.fullscreenElement) return 1; },  
 2383492: () => { return document.getElementById('canvas').width; },  
 2383544: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2383612: () => { document.exitFullscreen(); },  
 2383639: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 2383697: () => { return screen.width; },  
 2383722: () => { return screen.height; },  
 2383748: () => { return window.screenX; },  
 2383775: () => { return window.screenY; },  
 2383802: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2383855: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 2383926: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 2383983: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2384239: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 2384310: () => { if (document.fullscreenElement) return 1; },  
 2384356: () => { return window.innerWidth; },  
 2384382: () => { return window.innerHeight; },  
 2384409: () => { if (document.pointerLockElement) return 1; }
};
