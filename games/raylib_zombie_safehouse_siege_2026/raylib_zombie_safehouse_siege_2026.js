...
var ASM_CONSTS = {
  98624: () => { if (document.fullscreenElement) return 1; },  
 98670: () => { return document.getElementById('canvas').width; },  
 98722: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98790: () => { document.exitFullscreen(); },  
 98817: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98890: () => { if (document.fullscreenElement) return 1; },  
 98936: () => { return document.getElementById('canvas').width; },  
 98988: () => { return screen.width; },  
 99013: () => { document.exitFullscreen(); },  
 99040: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99173: () => { return window.innerWidth; },  
 99199: () => { return window.innerHeight; },  
 99226: () => { if (document.fullscreenElement) return 1; },  
 99272: () => { return document.getElementById('canvas').width; },  
 99324: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99392: () => { if (document.fullscreenElement) return 1; },  
 99438: () => { return document.getElementById('canvas').width; },  
 99490: () => { return screen.width; },  
 99515: () => { return window.innerWidth; },  
 99541: () => { return window.innerHeight; },  
 99568: () => { if (document.fullscreenElement) return 1; },  
 99614: () => { return document.getElementById('canvas').width; },  
 99666: () => { return screen.width; },  
 99691: () => { document.exitFullscreen(); },  
 99718: () => { if (document.fullscreenElement) return 1; },  
 99764: () => { return document.getElementById('canvas').width; },  
 99816: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99884: () => { document.exitFullscreen(); },  
 99911: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99969: () => { return screen.width; },  
 99994: () => { return screen.height; },  
 100020: () => { return window.screenX; },  
 100047: () => { return window.screenY; },  
 100074: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100127: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100198: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100255: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100511: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100582: () => { if (document.fullscreenElement) return 1; },  
 100628: () => { return window.innerWidth; },  
 100654: () => { return window.innerHeight; },  
 100681: () => { if (document.pointerLockElement) return 1; }
};
