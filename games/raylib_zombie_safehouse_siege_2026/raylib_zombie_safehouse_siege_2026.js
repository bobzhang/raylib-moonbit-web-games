...
var ASM_CONSTS = {
 ...
 98562: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98630: () => { document.exitFullscreen(); },  
 98657: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98730: () => { if (document.fullscreenElement) return 1; },  
 98776: () => { return document.getElementById('canvas').width; },  
 98828: () => { return screen.width; },  
 98853: () => { document.exitFullscreen(); },  
 98880: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99013: () => { return window.innerWidth; },  
 99039: () => { return window.innerHeight; },  
 99066: () => { if (document.fullscreenElement) return 1; },  
 99112: () => { return document.getElementById('canvas').width; },  
 99164: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99232: () => { if (document.fullscreenElement) return 1; },  
 99278: () => { return document.getElementById('canvas').width; },  
 99330: () => { return screen.width; },  
 99355: () => { return window.innerWidth; },  
 99381: () => { return window.innerHeight; },  
 99408: () => { if (document.fullscreenElement) return 1; },  
 99454: () => { return document.getElementById('canvas').width; },  
 99506: () => { return screen.width; },  
 99531: () => { document.exitFullscreen(); },  
 99558: () => { if (document.fullscreenElement) return 1; },  
 99604: () => { return document.getElementById('canvas').width; },  
 99656: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99724: () => { document.exitFullscreen(); },  
 99751: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99809: () => { return screen.width; },  
 99834: () => { return screen.height; },  
 99860: () => { return window.screenX; },  
 99887: () => { return window.screenY; },  
 99914: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99967: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100038: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100095: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100351: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100422: () => { if (document.fullscreenElement) return 1; },  
 100468: () => { return window.innerWidth; },  
 100494: () => { return window.innerHeight; },  
 100521: () => { if (document.pointerLockElement) return 1; }
};
