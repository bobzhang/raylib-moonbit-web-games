...
function findWasmBinary() {
  return locateFile('raylib_hollow_knight_2017_lite.wasm');
}
...
var ASM_CONSTS = {
  417040: () => { if (document.fullscreenElement) return 1; },  
 417086: () => { return document.getElementById('canvas').width; },  
 417138: () => { return parseInt(document.getElementById('canvas').style.width); },  
 417206: () => { document.exitFullscreen(); },  
 417233: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 417306: () => { if (document.fullscreenElement) return 1; },  
 417352: () => { return document.getElementById('canvas').width; },  
 417404: () => { return screen.width; },  
 417429: () => { document.exitFullscreen(); },  
 417456: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 417589: () => { return window.innerWidth; },  
 417615: () => { return window.innerHeight; },  
 417642: () => { if (document.fullscreenElement) return 1; },  
 417688: () => { return document.getElementById('canvas').width; },  
 417740: () => { return parseInt(document.getElementById('canvas').style.width); },  
 417808: () => { if (document.fullscreenElement) return 1; },  
 417854: () => { return document.getElementById('canvas').width; },  
 417906: () => { return screen.width; },  
 417931: () => { return window.innerWidth; },  
 417957: () => { return window.innerHeight; },  
 417984: () => { if (document.fullscreenElement) return 1; },  
 418030: () => { return document.getElementById('canvas').width; },  
 418082: () => { return screen.width; },  
 418107: () => { document.exitFullscreen(); },  
 418134: () => { if (document.fullscreenElement) return 1; },  
 418180: () => { return document.getElementById('canvas').width; },  
 418232: () => { return parseInt(document.getElementById('canvas').style.width); },  
 418300: () => { document.exitFullscreen(); },  
 418327: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 418385: () => { return screen.width; },  
 418410: () => { return screen.height; },  
 418436: () => { return window.screenX; },  
 418463: () => { return window.screenY; },  
 418490: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 418543: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 418614: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 418671: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 418927: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 418998: () => { if (document.fullscreenElement) return 1; },  
 419044: () => { return window.innerWidth; },  
 419070: () => { return window.innerHeight; },  
 419097: () => { if (document.pointerLockElement) return 1; }
};
