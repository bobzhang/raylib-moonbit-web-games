...
var ASM_CONSTS = {
  97104: () => { if (document.fullscreenElement) return 1; },  
 97150: () => { return document.getElementById('canvas').width; },  
 97202: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97270: () => { document.exitFullscreen(); },  
 97297: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97370: () => { if (document.fullscreenElement) return 1; },  
 97416: () => { return document.getElementById('canvas').width; },  
 97468: () => { return screen.width; },  
 97493: () => { document.exitFullscreen(); },  
 97520: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97653: () => { return window.innerWidth; },  
 97679: () => { return window.innerHeight; },  
 97706: () => { if (document.fullscreenElement) return 1; },  
 97752: () => { return document.getElementById('canvas').width; },  
 97804: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97872: () => { if (document.fullscreenElement) return 1; },  
 97918: () => { return document.getElementById('canvas').width; },  
 97970: () => { return screen.width; },  
 97995: () => { return window.innerWidth; },  
 98021: () => { return window.innerHeight; },  
 98048: () => { if (document.fullscreenElement) return 1; },  
 98094: () => { return document.getElementById('canvas').width; },  
 98146: () => { return screen.width; },  
 98171: () => { document.exitFullscreen(); },  
 98198: () => { if (document.fullscreenElement) return 1; },  
 98244: () => { return document.getElementById('canvas').width; },  
 98296: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98364: () => { document.exitFullscreen(); },  
 98391: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98449: () => { return screen.width; },  
 98474: () => { return screen.height; },  
 98500: () => { return window.screenX; },  
 98527: () => { return window.screenY; },  
 98554: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98607: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98678: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98735: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98991: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99062: () => { if (document.fullscreenElement) return 1; },  
 99108: () => { return window.innerWidth; },  
 99134: () => { return window.innerHeight; },  
 99161: () => { if (document.pointerLockElement) return 1; }
};
