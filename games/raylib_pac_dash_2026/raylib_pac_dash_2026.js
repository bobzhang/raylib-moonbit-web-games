...
var ASM_CONSTS = {
  97264: () => { if (document.fullscreenElement) return 1; },  
 97310: () => { return document.getElementById('canvas').width; },  
 97362: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97430: () => { document.exitFullscreen(); },  
 97457: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97530: () => { if (document.fullscreenElement) return 1; },  
 97576: () => { return document.getElementById('canvas').width; },  
 97628: () => { return screen.width; },  
 97653: () => { document.exitFullscreen(); },  
 97680: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97813: () => { return window.innerWidth; },  
 97839: () => { return window.innerHeight; },  
 97866: () => { if (document.fullscreenElement) return 1; },  
 97912: () => { return document.getElementById('canvas').width; },  
 97964: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98032: () => { if (document.fullscreenElement) return 1; },  
 98078: () => { return document.getElementById('canvas').width; },  
 98130: () => { return screen.width; },  
 98155: () => { return window.innerWidth; },  
 98181: () => { return window.innerHeight; },  
 98208: () => { if (document.fullscreenElement) return 1; },  
 98254: () => { return document.getElementById('canvas').width; },  
 98306: () => { return screen.width; },  
 98331: () => { document.exitFullscreen(); },  
 98358: () => { if (document.fullscreenElement) return 1; },  
 98404: () => { return document.getElementById('canvas').width; },  
 98456: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98524: () => { document.exitFullscreen(); },  
 98551: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98609: () => { return screen.width; },  
 98634: () => { return screen.height; },  
 98660: () => { return window.screenX; },  
 98687: () => { return window.screenY; },  
 98714: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98767: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98838: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98895: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99151: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99222: () => { if (document.fullscreenElement) return 1; },  
 99268: () => { return window.innerWidth; },  
 99294: () => { return window.innerHeight; },  
 99321: () => { if (document.pointerLockElement) return 1; }
};
