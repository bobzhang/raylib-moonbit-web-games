...
function findWasmBinary() {
  return locateFile('raylib_pac_dash_2026.wasm');
}
...
var ASM_CONSTS = {
  97280: () => { if (document.fullscreenElement) return 1; },  
 97326: () => { return document.getElementById('canvas').width; },  
 97378: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97446: () => { document.exitFullscreen(); },  
 97473: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97546: () => { if (document.fullscreenElement) return 1; },  
 97592: () => { return document.getElementById('canvas').width; },  
 97644: () => { return screen.width; },  
 97669: () => { document.exitFullscreen(); },  
 97696: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97829: () => { return window.innerWidth; },  
 97855: () => { return window.innerHeight; },  
 97882: () => { if (document.fullscreenElement) return 1; },  
 97928: () => { return document.getElementById('canvas').width; },  
 97980: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98048: () => { if (document.fullscreenElement) return 1; },  
 98094: () => { return document.getElementById('canvas').width; },  
 98146: () => { return screen.width; },  
 98171: () => { return window.innerWidth; },  
 98197: () => { return window.innerHeight; },  
 98224: () => { if (document.fullscreenElement) return 1; },  
 98270: () => { return document.getElementById('canvas').width; },  
 98322: () => { return screen.width; },  
 98347: () => { document.exitFullscreen(); },  
 98374: () => { if (document.fullscreenElement) return 1; },  
 98420: () => { return document.getElementById('canvas').width; },  
 98472: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98540: () => { document.exitFullscreen(); },  
 98567: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98625: () => { return screen.width; },  
 98650: () => { return screen.height; },  
 98676: () => { return window.screenX; },  
 98703: () => { return window.screenY; },  
 98730: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98783: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98854: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98911: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99167: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99238: () => { if (document.fullscreenElement) return 1; },  
 99284: () => { return window.innerWidth; },  
 99310: () => { return window.innerHeight; },  
 99337: () => { if (document.pointerLockElement) return 1; }
};
