...
function findWasmBinary() {
  return locateFile('raylib_dungeon_courier_escape_2026.wasm');
}
...
var ASM_CONSTS = {
  99296: () => { if (document.fullscreenElement) return 1; },  
 99342: () => { return document.getElementById('canvas').width; },  
 99394: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99462: () => { document.exitFullscreen(); },  
 99489: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99562: () => { if (document.fullscreenElement) return 1; },  
 99608: () => { return document.getElementById('canvas').width; },  
 99660: () => { return screen.width; },  
 99685: () => { document.exitFullscreen(); },  
 99712: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99845: () => { return window.innerWidth; },  
 99871: () => { return window.innerHeight; },  
 99898: () => { if (document.fullscreenElement) return 1; },  
 99944: () => { return document.getElementById('canvas').width; },  
 99996: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100064: () => { if (document.fullscreenElement) return 1; },  
 100110: () => { return document.getElementById('canvas').width; },  
 100162: () => { return screen.width; },  
 100187: () => { return window.innerWidth; },  
 100213: () => { return window.innerHeight; },  
 100240: () => { if (document.fullscreenElement) return 1; },  
 100286: () => { return document.getElementById('canvas').width; },  
 100338: () => { return screen.width; },  
 100363: () => { document.exitFullscreen(); },  
 100390: () => { if (document.fullscreenElement) return 1; },  
 100436: () => { return document.getElementById('canvas').width; },  
 100488: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100556: () => { document.exitFullscreen(); },  
 100583: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100641: () => { return screen.width; },  
 100666: () => { return screen.height; },  
 100692: () => { return window.screenX; },  
 100719: () => { return window.screenY; },  
 100746: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100799: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100870: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100927: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101183: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101254: () => { if (document.fullscreenElement) return 1; },  
 101300: () => { return window.innerWidth; },  
 101326: () => { return window.innerHeight; },  
 101353: () => { if (document.pointerLockElement) return 1; }
};
