...
var ASM_CONSTS = {
  97632: () => { if (document.fullscreenElement) return 1; },  
 97678: () => { return document.getElementById('canvas').width; },  
 97730: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97798: () => { document.exitFullscreen(); },  
 97825: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97898: () => { if (document.fullscreenElement) return 1; },  
 97944: () => { return document.getElementById('canvas').width; },  
 97996: () => { return screen.width; },  
 98021: () => { document.exitFullscreen(); },  
 98048: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98181: () => { return window.innerWidth; },  
 98207: () => { return window.innerHeight; },  
 98234: () => { if (document.fullscreenElement) return 1; },  
 98280: () => { return document.getElementById('canvas').width; },  
 98332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98400: () => { if (document.fullscreenElement) return 1; },  
 98446: () => { return document.getElementById('canvas').width; },  
 98498: () => { return screen.width; },  
 98523: () => { return window.innerWidth; },  
 98549: () => { return window.innerHeight; },  
 98576: () => { if (document.fullscreenElement) return 1; },  
 98622: () => { return document.getElementById('canvas').width; },  
 98674: () => { return screen.width; },  
 98699: () => { document.exitFullscreen(); },  
 98726: () => { if (document.fullscreenElement) return 1; },  
 98772: () => { return document.getElementById('canvas').width; },  
 98824: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98892: () => { document.exitFullscreen(); },  
 98919: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98977: () => { return screen.width; },  
 99002: () => { return screen.height; },  
 99028: () => { return window.screenX; },  
 99055: () => { return window.screenY; },  
 99082: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99135: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99206: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99263: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99519: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99590: () => { if (document.fullscreenElement) return 1; },  
 99636: () => { return window.innerWidth; },  
 99662: () => { return window.innerHeight; },  
 99689: () => { if (document.pointerLockElement) return 1; }
};
