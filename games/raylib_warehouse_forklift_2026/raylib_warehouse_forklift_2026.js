...
function findWasmBinary() {
  return locateFile('raylib_warehouse_forklift_2026.wasm');
}
...
var ASM_CONSTS = {
  97456: () => { if (document.fullscreenElement) return 1; },  
 97502: () => { return document.getElementById('canvas').width; },  
 97554: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97622: () => { document.exitFullscreen(); },  
 97649: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97722: () => { if (document.fullscreenElement) return 1; },  
 97768: () => { return document.getElementById('canvas').width; },  
 97820: () => { return screen.width; },  
 97845: () => { document.exitFullscreen(); },  
 97872: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98005: () => { return window.innerWidth; },  
 98031: () => { return window.innerHeight; },  
 98058: () => { if (document.fullscreenElement) return 1; },  
 98104: () => { return document.getElementById('canvas').width; },  
 98156: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98224: () => { if (document.fullscreenElement) return 1; },  
 98270: () => { return document.getElementById('canvas').width; },  
 98322: () => { return screen.width; },  
 98347: () => { return window.innerWidth; },  
 98373: () => { return window.innerHeight; },  
 98400: () => { if (document.fullscreenElement) return 1; },  
 98446: () => { return document.getElementById('canvas').width; },  
 98498: () => { return screen.width; },  
 98523: () => { document.exitFullscreen(); },  
 98550: () => { if (document.fullscreenElement) return 1; },  
 98596: () => { return document.getElementById('canvas').width; },  
 98648: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98716: () => { document.exitFullscreen(); },  
 98743: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98801: () => { return screen.width; },  
 98826: () => { return screen.height; },  
 98852: () => { return window.screenX; },  
 98879: () => { return window.screenY; },  
 98906: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98959: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99030: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99087: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99343: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99414: () => { if (document.fullscreenElement) return 1; },  
 99460: () => { return window.innerWidth; },  
 99486: () => { return window.innerHeight; },  
 99513: () => { if (document.pointerLockElement) return 1; }
};
