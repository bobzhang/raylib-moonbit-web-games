...
var ASM_CONSTS = {
  99568: () => { if (document.fullscreenElement) return 1; },  
 99614: () => { return document.getElementById('canvas').width; },  
 99666: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99734: () => { document.exitFullscreen(); },  
 99761: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99834: () => { if (document.fullscreenElement) return 1; },  
 99880: () => { return document.getElementById('canvas').width; },  
 99932: () => { return screen.width; },  
 99957: () => { document.exitFullscreen(); },  
 99984: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100117: () => { return window.innerWidth; },  
 100143: () => { return window.innerHeight; },  
 100170: () => { if (document.fullscreenElement) return 1; },  
 100216: () => { return document.getElementById('canvas').width; },  
 100268: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100336: () => { if (document.fullscreenElement) return 1; },  
 100382: () => { return document.getElementById('canvas').width; },  
 100434: () => { return screen.width; },  
 100459: () => { return window.innerWidth; },  
 100485: () => { return window.innerHeight; },  
 ...
 100635: () => { document.exitFullscreen(); },  
 100662: () => { if (document.fullscreenElement) return 1; },  
 100708: () => { return document.getElementById('canvas').width; },  
 100760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100828: () => { document.exitFullscreen(); },  
 100855: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100913: () => { return screen.width; },  
 100938: () => { return screen.height; },  
 100964: () => { return window.screenX; },  
 100991: () => { return window.screenY; },  
 101018: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101071: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101142: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101199: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101455: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101526: () => { if (document.fullscreenElement) return 1; },  
 101572: () => { return window.innerWidth; },  
 101598: () => { return window.innerHeight; },  
 101625: () => { if (document.pointerLockElement) return 1; }
};
