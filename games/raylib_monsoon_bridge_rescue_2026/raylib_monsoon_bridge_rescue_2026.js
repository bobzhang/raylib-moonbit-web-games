...
function findWasmBinary() {
  return locateFile('raylib_monsoon_bridge_rescue_2026.wasm');
}
...
var ASM_CONSTS = {
  99744: () => { if (document.fullscreenElement) return 1; },  
 99790: () => { return document.getElementById('canvas').width; },  
 99842: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99910: () => { document.exitFullscreen(); },  
 99937: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100010: () => { if (document.fullscreenElement) return 1; },  
 100056: () => { return document.getElementById('canvas').width; },  
 100108: () => { return screen.width; },  
 100133: () => { document.exitFullscreen(); },  
 100160: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100293: () => { return window.innerWidth; },  
 100319: () => { return window.innerHeight; },  
 100346: () => { if (document.fullscreenElement) return 1; },  
 100392: () => { return document.getElementById('canvas').width; },  
 100444: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100512: () => { if (document.fullscreenElement) return 1; },  
 100558: () => { return document.getElementById('canvas').width; },  
 100610: () => { return screen.width; },  
 100635: () => { return window.innerWidth; },  
 100661: () => { return window.innerHeight; },  
 ...
 100811: () => { document.exitFullscreen(); },  
 100838: () => { if (document.fullscreenElement) return 1; },  
 100884: () => { return document.getElementById('canvas').width; },  
 100936: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101004: () => { document.exitFullscreen(); },  
 101031: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101089: () => { return screen.width; },  
 101114: () => { return screen.height; },  
 101140: () => { return window.screenX; },  
 101167: () => { return window.screenY; },  
 101194: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101247: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101318: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101375: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101631: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101702: () => { if (document.fullscreenElement) return 1; },  
 101748: () => { return window.innerWidth; },  
 101774: () => { return window.innerHeight; },  
 101801: () => { if (document.pointerLockElement) return 1; }
};
