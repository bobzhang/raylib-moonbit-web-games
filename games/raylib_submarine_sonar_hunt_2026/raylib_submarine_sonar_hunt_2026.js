...
var ASM_CONSTS = {
  98976: () => { if (document.fullscreenElement) return 1; },  
 99022: () => { return document.getElementById('canvas').width; },  
 99074: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99142: () => { document.exitFullscreen(); },  
 99169: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99242: () => { if (document.fullscreenElement) return 1; },  
 99288: () => { return document.getElementById('canvas').width; },  
 99340: () => { return screen.width; },  
 99365: () => { document.exitFullscreen(); },  
 99392: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99525: () => { return window.innerWidth; },  
 99551: () => { return window.innerHeight; },  
 99578: () => { if (document.fullscreenElement) return 1; },  
 99624: () => { return document.getElementById('canvas').width; },  
 99676: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99744: () => { if (document.fullscreenElement) return 1; },  
 99790: () => { return document.getElementById('canvas').width; },  
 99842: () => { return screen.width; },  
 99867: () => { return window.innerWidth; },  
 99893: () => { return window.innerHeight; },  
 99920: () => { if (document.fullscreenElement) return 1; },  
 99966: () => { return document.getElementById('canvas').width; },  
 100018: () => { return screen.width; },  
 100043: () => { document.exitFullscreen(); },  
 100070: () => { if (document.fullscreenElement) return 1; },  
 100116: () => { return document.getElementById('canvas').width; },  
 100168: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100236: () => { document.exitFullscreen(); },  
 100263: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100321: () => { return screen.width; },  
 100346: () => { return screen.height; },  
 100372: () => { return window.screenX; },  
 100399: () => { return window.screenY; },  
 100426: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100479: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100550: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100607: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100863: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100934: () => { if (document.fullscreenElement) return 1; },  
 100980: () => { return window.innerWidth; },  
 101006: () => { return window.innerHeight; },  
 101033: () => { if (document.pointerLockElement) return 1; }
};
