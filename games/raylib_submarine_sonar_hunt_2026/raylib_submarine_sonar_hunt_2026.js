...
var ASM_CONSTS = {
 ...
 98946: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99014: () => { document.exitFullscreen(); },  
 99041: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99114: () => { if (document.fullscreenElement) return 1; },  
 99160: () => { return document.getElementById('canvas').width; },  
 99212: () => { return screen.width; },  
 99237: () => { document.exitFullscreen(); },  
 99264: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99397: () => { return window.innerWidth; },  
 99423: () => { return window.innerHeight; },  
 99450: () => { if (document.fullscreenElement) return 1; },  
 99496: () => { return document.getElementById('canvas').width; },  
 99548: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99616: () => { if (document.fullscreenElement) return 1; },  
 99662: () => { return document.getElementById('canvas').width; },  
 99714: () => { return screen.width; },  
 99739: () => { return window.innerWidth; },  
 99765: () => { return window.innerHeight; },  
 99792: () => { if (document.fullscreenElement) return 1; },  
 99838: () => { return document.getElementById('canvas').width; },  
 99890: () => { return screen.width; },  
 99915: () => { document.exitFullscreen(); },  
 99942: () => { if (document.fullscreenElement) return 1; },  
 99988: () => { return document.getElementById('canvas').width; },  
 100040: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100108: () => { document.exitFullscreen(); },  
 100135: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100193: () => { return screen.width; },  
 100218: () => { return screen.height; },  
 100244: () => { return window.screenX; },  
 100271: () => { return window.screenY; },  
 100298: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100351: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100422: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100479: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100735: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100806: () => { if (document.fullscreenElement) return 1; },  
 100852: () => { return window.innerWidth; },  
 100878: () => { return window.innerHeight; },  
 100905: () => { if (document.pointerLockElement) return 1; }
};
