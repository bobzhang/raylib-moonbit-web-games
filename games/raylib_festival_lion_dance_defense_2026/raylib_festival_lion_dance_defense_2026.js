...
var ASM_CONSTS = {
 ...
 99858: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99926: () => { document.exitFullscreen(); },  
 99953: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100026: () => { if (document.fullscreenElement) return 1; },  
 100072: () => { return document.getElementById('canvas').width; },  
 100124: () => { return screen.width; },  
 100149: () => { document.exitFullscreen(); },  
 100176: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100309: () => { return window.innerWidth; },  
 100335: () => { return window.innerHeight; },  
 100362: () => { if (document.fullscreenElement) return 1; },  
 100408: () => { return document.getElementById('canvas').width; },  
 100460: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100528: () => { if (document.fullscreenElement) return 1; },  
 100574: () => { return document.getElementById('canvas').width; },  
 100626: () => { return screen.width; },  
 100651: () => { return window.innerWidth; },  
 100677: () => { return window.innerHeight; },  
 ...
 100827: () => { document.exitFullscreen(); },  
 100854: () => { if (document.fullscreenElement) return 1; },  
 100900: () => { return document.getElementById('canvas').width; },  
 100952: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101020: () => { document.exitFullscreen(); },  
 101047: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101105: () => { return screen.width; },  
 101130: () => { return screen.height; },  
 101156: () => { return window.screenX; },  
 101183: () => { return window.screenY; },  
 101210: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101263: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101334: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101391: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101647: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101718: () => { if (document.fullscreenElement) return 1; },  
 101764: () => { return window.innerWidth; },  
 101790: () => { return window.innerHeight; },  
 101817: () => { if (document.pointerLockElement) return 1; }
};
