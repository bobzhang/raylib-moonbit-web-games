...
var ASM_CONSTS = {
  99904: () => { if (document.fullscreenElement) return 1; },  
 99950: () => { return document.getElementById('canvas').width; },  
 100002: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100070: () => { document.exitFullscreen(); },  
 100097: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100170: () => { if (document.fullscreenElement) return 1; },  
 100216: () => { return document.getElementById('canvas').width; },  
 100268: () => { return screen.width; },  
 100293: () => { document.exitFullscreen(); },  
 100320: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100453: () => { return window.innerWidth; },  
 100479: () => { return window.innerHeight; },  
 100506: () => { if (document.fullscreenElement) return 1; },  
 100552: () => { return document.getElementById('canvas').width; },  
 100604: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100672: () => { if (document.fullscreenElement) return 1; },  
 100718: () => { return document.getElementById('canvas').width; },  
 100770: () => { return screen.width; },  
 100795: () => { return window.innerWidth; },  
 100821: () => { return window.innerHeight; },  
 100848: () => { if (document.fullscreenElement) return 1; },  
 100894: () => { return document.getElementById('canvas').width; },  
 100946: () => { return screen.width; },  
 100971: () => { document.exitFullscreen(); },  
 100998: () => { if (document.fullscreenElement) return 1; },  
 101044: () => { return document.getElementById('canvas').width; },  
 101096: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101164: () => { document.exitFullscreen(); },  
 101191: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101249: () => { return screen.width; },  
 101274: () => { return screen.height; },  
 101300: () => { return window.screenX; },  
 101327: () => { return window.screenY; },  
 101354: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101407: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101478: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101535: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101791: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101862: () => { if (document.fullscreenElement) return 1; },  
 101908: () => { return window.innerWidth; },  
 101934: () => { return window.innerHeight; },  
 101961: () => { if (document.pointerLockElement) return 1; }
};
