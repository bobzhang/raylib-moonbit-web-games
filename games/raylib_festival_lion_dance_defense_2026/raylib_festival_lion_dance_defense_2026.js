...
function findWasmBinary() {
  return locateFile('raylib_festival_lion_dance_defense_2026.wasm');
}
...
var ASM_CONSTS = {
  99920: () => { if (document.fullscreenElement) return 1; },  
 99966: () => { return document.getElementById('canvas').width; },  
 100018: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100086: () => { document.exitFullscreen(); },  
 100113: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100186: () => { if (document.fullscreenElement) return 1; },  
 100232: () => { return document.getElementById('canvas').width; },  
 100284: () => { return screen.width; },  
 100309: () => { document.exitFullscreen(); },  
 100336: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100469: () => { return window.innerWidth; },  
 100495: () => { return window.innerHeight; },  
 100522: () => { if (document.fullscreenElement) return 1; },  
 100568: () => { return document.getElementById('canvas').width; },  
 100620: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100688: () => { if (document.fullscreenElement) return 1; },  
 100734: () => { return document.getElementById('canvas').width; },  
 100786: () => { return screen.width; },  
 100811: () => { return window.innerWidth; },  
 100837: () => { return window.innerHeight; },  
 100864: () => { if (document.fullscreenElement) return 1; },  
 100910: () => { return document.getElementById('canvas').width; },  
 100962: () => { return screen.width; },  
 100987: () => { document.exitFullscreen(); },  
 101014: () => { if (document.fullscreenElement) return 1; },  
 101060: () => { return document.getElementById('canvas').width; },  
 101112: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101180: () => { document.exitFullscreen(); },  
 101207: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101265: () => { return screen.width; },  
 101290: () => { return screen.height; },  
 101316: () => { return window.screenX; },  
 101343: () => { return window.screenY; },  
 101370: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101423: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101494: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101551: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101807: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101878: () => { if (document.fullscreenElement) return 1; },  
 101924: () => { return window.innerWidth; },  
 101950: () => { return window.innerHeight; },  
 101977: () => { if (document.pointerLockElement) return 1; }
};
