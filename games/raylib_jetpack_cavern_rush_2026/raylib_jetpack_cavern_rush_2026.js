...
function findWasmBinary() {
  return locateFile('raylib_jetpack_cavern_rush_2026.wasm');
}
...
var ASM_CONSTS = {
  98144: () => { if (document.fullscreenElement) return 1; },  
 98190: () => { return document.getElementById('canvas').width; },  
 98242: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98310: () => { document.exitFullscreen(); },  
 98337: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98410: () => { if (document.fullscreenElement) return 1; },  
 98456: () => { return document.getElementById('canvas').width; },  
 98508: () => { return screen.width; },  
 98533: () => { document.exitFullscreen(); },  
 98560: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98693: () => { return window.innerWidth; },  
 98719: () => { return window.innerHeight; },  
 98746: () => { if (document.fullscreenElement) return 1; },  
 98792: () => { return document.getElementById('canvas').width; },  
 98844: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98912: () => { if (document.fullscreenElement) return 1; },  
 98958: () => { return document.getElementById('canvas').width; },  
 99010: () => { return screen.width; },  
 99035: () => { return window.innerWidth; },  
 99061: () => { return window.innerHeight; },  
 99088: () => { if (document.fullscreenElement) return 1; },  
 99134: () => { return document.getElementById('canvas').width; },  
 99186: () => { return screen.width; },  
 99211: () => { document.exitFullscreen(); },  
 99238: () => { if (document.fullscreenElement) return 1; },  
 99284: () => { return document.getElementById('canvas').width; },  
 99336: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99404: () => { document.exitFullscreen(); },  
 99431: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99489: () => { return screen.width; },  
 99514: () => { return screen.height; },  
 99540: () => { return window.screenX; },  
 99567: () => { return window.screenY; },  
 99594: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99647: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99718: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99775: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100031: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100102: () => { if (document.fullscreenElement) return 1; },  
 100148: () => { return window.innerWidth; },  
 100174: () => { return window.innerHeight; },  
 100201: () => { if (document.pointerLockElement) return 1; }
};
