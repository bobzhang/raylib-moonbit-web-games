...
var ASM_CONSTS = {
 ...
 98066: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98134: () => { document.exitFullscreen(); },  
 98161: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98234: () => { if (document.fullscreenElement) return 1; },  
 98280: () => { return document.getElementById('canvas').width; },  
 98332: () => { return screen.width; },  
 98357: () => { document.exitFullscreen(); },  
 98384: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98517: () => { return window.innerWidth; },  
 98543: () => { return window.innerHeight; },  
 98570: () => { if (document.fullscreenElement) return 1; },  
 98616: () => { return document.getElementById('canvas').width; },  
 98668: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98736: () => { if (document.fullscreenElement) return 1; },  
 98782: () => { return document.getElementById('canvas').width; },  
 98834: () => { return screen.width; },  
 98859: () => { return window.innerWidth; },  
 98885: () => { return window.innerHeight; },  
 98912: () => { if (document.fullscreenElement) return 1; },  
 98958: () => { return document.getElementById('canvas').width; },  
 99010: () => { return screen.width; },  
 99035: () => { document.exitFullscreen(); },  
 99062: () => { if (document.fullscreenElement) return 1; },  
 99108: () => { return document.getElementById('canvas').width; },  
 99160: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99228: () => { document.exitFullscreen(); },  
 99255: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99313: () => { return screen.width; },  
 99338: () => { return screen.height; },  
 99364: () => { return window.screenX; },  
 99391: () => { return window.screenY; },  
 99418: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99471: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99542: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99599: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99855: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99926: () => { if (document.fullscreenElement) return 1; },  
 99972: () => { return window.innerWidth; },  
 99998: () => { return window.innerHeight; },  
 100025: () => { if (document.pointerLockElement) return 1; }
};
